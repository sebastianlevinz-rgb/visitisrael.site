...
<AffiliateCard
  partner="booking"
  destination="Eilat"
  label="Compare Eilat hotels on Booking.com"
/>
...
<AffiliateCard
  partner="civitatis"
  destination="Eilat"
  label="Coral Beach reef snorkel + glass-boat tour"
/>
...
<AffiliateCard
  ...
  destination="Eilat"
  label="Dolphin Reef interactive experience + beach access"
/>
...
<AffiliateCard
  partner="viator"
  destination="Eilat"
  label="Timna Park half-day tour with Solomon's Pillars"
/>
...
<AffiliateCard
  partner="viator"
  destination="Eilat"
  label="Petra from Eilat day tour (border crossing included)"
/>
...
<TransportInfo
  airport={{ code: 'ETM', name: 'Ramon Airport (Eilat)' }}
  transportOptions={[
    {
      mode: 'Domestic flight from TLV to ETM',
      description:
        'Israir + Arkia run hourly. 50 minutes flight + 25 min shuttle from ETM to central Eilat.',
      durationMinutes: 75,
    },
    {
      mode: 'Rental car from TLV via Highway 90',
      description:
        'Scenic Dead Sea route, 4.5 hours. Combine with Masada or Ein Gedi stops.',
      durationMinutes: 270,
    },
    {
      mode: 'Egged bus from Tel Aviv',
      description: 'Direct service, around 5 hours. Cheapest option.',
      durationMinutes: 300,
    },
  ]}
/>
...
<AffiliateCard
  partner="skyscanner"
  destination="ETM"
  label="Find flights to Ramon Airport (Eilat ETM)"
/>
...
<AffiliateCard
  partner="rentalcars"
  destination="Eilat"
  label="Rent a car at Ramon Airport (Eilat)"
/>

<AffiliateCard
  partner="discoverCars"
  destination="Eilat"
  label="Compare Eilat rental car prices (365-day cookie)"
/>
...
<AffiliateCard
  partner="safetyWing"
  destination="Israel"
  label="Diving + travel insurance for Israel"
/>
