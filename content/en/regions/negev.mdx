...
<AffiliateCard
  ...
  label="Compare Mitzpe Ramon hotel prices on Booking.com"
/>
...
<AffiliateCard
  ...
  destination="Negev"
  label="Bedouin desert hospitality experience"
/>
...
<AffiliateCard
  partner="viator"
  destination="Negev"
  label="Negev + Mitzpe Ramon day tour"
/>
...
<TransportInfo
  ...
  transportOptions={[
    {
      mode: 'Rental car (Tel Aviv to Mitzpe Ramon)',
      description:
        'About 2 hours via Route 40 / Route 25. The practical default for a Negev trip — public transport reaches the towns but not the smaller attractions.',
    },
    {
      mode: 'Egged bus from Beersheba',
      description:
        'Routes 60 / 64 to Mitzpe Ramon and Sde Boker; connecting buses to Avdat and Ein Avdat trailheads are infrequent.',
    },
    {
      mode: 'Ramon Airport (Eilat) regional flights',
      description:
        'Smaller domestic airport south of Mitzpe Ramon — useful for visitors entering via Eilat or combining a Red Sea segment with the desert.',
    },
  ]}
/>
...
<AffiliateCard
  ...
  label="Rent a car for the Negev road trip"
/>
...
<AffiliateCard
  partner="safetyWing"
  destination="Israel"
  label="Travel insurance for Israel"
/>
