...
<AffiliateCard
  ...
  label="Compare Tiberias and Sea of Galilee hotels on Booking.com"
/>
...
<AffiliateCard
  partner="viator"
  destination="Galilee"
  label="Sea of Galilee Christian sites guided tour"
/>

<AffiliateCard
  partner="getYourGuide"
  destination="Galilee"
  label="Capernaum + Mount of Beatitudes half-day from Tiberias"
/>
...
<AffiliateCard
  partner="viator"
  destination="Galilee"
  label="Day trips from the Galilee (Golan, Nazareth, Akko)"
/>
  ...
  transportOptions={[
    {
      ...
      description:
        'Strongly recommended for the Galilee pilgrim circuit + Mount Arbel + Golan day-trip combinations.',
      durationMinutes: 130,
    },
    {
      mode: 'Egged direct bus to Tiberias',
      description:
        'TLV Central Bus Station to Tiberias central bus station, around 2.5 hours.',
      durationMinutes: 150,
    },
    {
      mode: 'Organised day tour',
      description:
        'Hotel pickup in Tel Aviv; covers Capernaum, Mount of Beatitudes, Yardenit, Tiberias in a long single day.',
    },
  ]}
/>
...
<AffiliateCard
  ...
  label="Rent a car at Ben Gurion for the Galilee road trip"
/>
