/**
 * `/about` (HE) and `/en/about` — About page.
 *
 * Phase 2 plan 05 Wave 0 — UTILITY profile legal page.
 *
 * Reads `content/{en,he}/legal/about.mdx` from the Velite Legal collection
 * by `lang === locale && page === 'about'`. Renders WebPage + BreadcrumbList
 * schema, the MDX body as prose. No affiliate placements (UTILITY profile).
 */
