/**
 * `/affiliate-disclosure` (HE) and `/en/affiliate-disclosure` — FTC-compliant
 * affiliate-marketing disclosure.
 *
 * Phase 2 plan 05 Wave 0 — UTILITY profile legal page.
 *
 * Cross-links to inline `<AffiliateDisclosure>` component pattern used on
 * monetized pages. Lists the 11 partner programmes (9 real + 2 stubs).
 */
...
const PAGE_SLUG = 'affiliate-disclosure';
...
export async function generateMetadata({
  ...
  if (!e) return { title: 'Affiliate Disclosure' };
