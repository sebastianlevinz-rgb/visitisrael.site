# COMPETITOR INTELLIGENCE (research mode appends; de-dupe before adding to BACKLOG)

Seed from `.audit/06-competitor-gap-analysis.md`. Competitors tracked:
Tourist Israel, goisrael, Lonely Planet, Rough Guides, GetYourGuide, Viator, TripAdvisor (forum),
Bein Harim, Abraham Tours, Times of Israel travel, Wikivoyage; format refs: The Points Guy, Nomadic Matt.

## Known strengths to beat / patterns worth copying
- Tourist Israel: deep money-page verticals (tours by theme), BUT **zero interactive tools** — our tooling is the moat. Keep widening it.
- goisrael: official authority + trip-planning tools locked in an app — replicate the useful ones on the open web (we have build-your-trip, map, calculators).
- OTAs (GetYourGuide/Viator): comparison + reviews + price-from. We can't fake reviews; compete with honest comparison tables + "is it worth it" verdicts + better editorial context, deep-linking to them as affiliates.
- Format patterns proven to win SERP: comparison tables, at-a-glance fact boxes, FAQ schema, "X vs Y" pages, month-by-month seasonal pages, transport "A to B" pages.

## Already-captured gaps (now DONE) — do not re-add
Masada/Dead Sea, Petra-from-Israel, Christian Galilee, Jerusalem+Bethlehem, Shabbat-by-city,
TLV→Jerusalem, family, LGBTQ, hiking, food, dress-code, diving, wine; budget calculator,
currency/tipping, packing list, region quiz, interactive map, trip builder.

## New findings (append below, dated)

### 2026-06-22 · iter 5 · Tourist Israel + head-term SERP scan
Researched touristisrael.com taxonomy + the "best things to do / bucket list", "entry
requirements 2026" and "what to pack" SERPs (TripAdvisor, Viator, Bein Harim, Broke Backpacker).

- **ETA-IL is the biggest gap.** Since 1 Jan 2025 visa-exempt travellers MUST get an Israel
  Electronic Travel Authorization (ETA-IL) before boarding — ~₪25/$7, apply ≥72h ahead, passport
  valid 6+ months. Tourist Israel ranks a dedicated "Israel Entry Guidelines / ETA" page. Our
  visa-information.md only vaguely says "electronic pre-authorisation… rolling out" — names neither
  ETA-IL, the fee, the 72h rule, nor who needs it. Huge evergreen high-intent ("do I need a visa
  for Israel", "Israel ETA", "Israel entry requirements 2026"). → BACKLOG (seo-content, P1).
  NOTE for implementer: verify current official details (iaa.gov.il / apply portal) before authoring;
  link the official source; do not assert volatile specifics.
- **"Best things to do in Israel" / Israel bucket list** is a head term EVERY competitor owns
  (Tourist Israel, TripAdvisor, Viator, Bein Harim, Broke Backpacker, Thrillophilia). We have
  region + 63 attraction pages but no single aggregating hub. → BACKLOG (seo-content, P1) as a
  top-of-funnel internal-link hub.
- **Best Holy Land / Christian pilgrimage TOURS** money page — Tourist Israel ranks "Best Holy Land
  Tours". We have an editorial christian-pilgrimage guide but no tours-focused money page. → BACKLOG
  (monetization, P1).
- **Beaches** — competitors rank "best beaches in Israel/Tel Aviv" (Banana, Gordon-Frishman, Hilton,
  Alma; Eilat Red Sea; Herzliya). We have TLV food/nightlife but no beaches guide. → BACKLOG
  (seo-content, P2).
- **Practical micro-queries** — Type H plug / 230V / adapters, "is tap water safe in Israel" (yes).
  Cheap long-tail we don't target. → BACKLOG (seo-content, P3, fold into a practical-info FAQ).
- **Trip-length intent** — every competitor pushes "spend a week / 10 days+". We have the
  israel-5-vs-7-vs-10-days guide but no interactive recommender. → BACKLOG (tools, P2).

CAUTION (honesty): safety/entry SERPs surface volatile real-time conditions (advisories, airport
status). Keep loop content EVERGREEN — frame safety/entry neutrally and link official advisories;
never assert current real-time status. Out-of-scope reminder holds: Hebron excluded.

### 2026-06-22 · iter 10 · itinerary long-tail + ticket intent + tips-listicle scan
Mined DIFFERENT angles than iter5 (itinerary SERPs, attraction-ticket intent, tips/mistakes
listicles). Backlog already full → added only 3 curated, de-duped, high-ROI items.

- **City & short itineraries** are a big gap. SERPs heavily rank "3 days in Jerusalem", "2 days in
  Tel Aviv", "3 days in Israel", "1 day in <city>" (NextLevel, Family Voyage, psimonmyway, TourRadar,
  Wonderplan). We have only 5/7/10-day *whole-country* itineraries — no city-specific or short ones.
  Natural extension of our itinerary system, high-intent, dense internal-link potential. → BACKLOG
  (seo-content, P1).
- **Attraction-ticket / "skip-the-line" intent** — e.g. "Masada cable car tickets" (≈₪80 all-in /
  ₪31 entry / ₪46 cable car at time of scan), Western Wall tunnels, Bahá'í Gardens. Our 63 attraction
  pages don't carry a "how to get tickets / skip the line" block with a Tiqets/GetYourGuide CTA.
  Monetization on existing high-traffic pages. → BACKLOG (monetization, P2). HONESTY: prices drift —
  use ranges + "check live price", link live booking; never hard-code exact prices.
- **"Things to know before visiting Israel" / mistakes-to-avoid listicle** — classic high-engagement
  top-of-funnel format competitors rank (NextLevel "26 things", Walk My World "12 mistakes",
  travelnotesandbeyond "20 tips"). We have first-time-in-israel (overview) but not the dedicated
  tips/mistakes format. Aggregates practical points we already cover (dress, don't overpack, Shabbat,
  Passover crowds, Temple Mount access times, rental-car West Bank restriction, tap water, ETA) with
  dense internal links + FAQ schema. Evergreen. → BACKLOG (seo-content, P2).

Also noted (not added — verify-coverage task, low priority): SERPs repeatedly cite Yad Vashem and
the Israel Museum as top Jerusalem sights — confirm both exist as attraction pages; if missing, add.
Honesty caution from iter5 still applies (evergreen safety/entry framing; Hebron excluded).

### 2026-06-23 · iter 20 · traveler-segment + budget scan (backlog already full → minimal add)
Mined traveler segments + budget/cost intent. Backlog is full (~20 ready items) so added only 2
curated, de-duped, net-new items.

- **Budget / "is Israel expensive" / backpacking** is a big high-intent cluster (Broke Backpacker,
  Heart My Backpack "$20/day", Budget Your Trip, israeltraveladvisor). BUT our israel-cost-budget
  guide ALREADY covers it well: daily budget tiers (backpacker/mid/luxury), where-money-goes, a
  sample one-week budget, and money-saving tips. → DO NOT re-add a budget page (would duplicate).
  If anything, only a light refresh of israel-cost-budget later.
- **Solo travel in Israel** — net-new traveler segment we lack (we have with-kids + LGBTQ). Evergreen
  demand ("solo travel Israel", "is Israel safe for solo travellers"), safety/social/logistics angle,
  dense internal links. → BACKLOG (seo-content, P3).
- **Israel honeymoon / romantic getaway** — net-new, good COMMERCIAL intent (luxury stays, couples
  experiences, spa/Dead Sea, wine) → affiliate revenue; we have no couples-focused page. → BACKLOG
  (seo-content, P3).
- Accessible/wheelchair + digital-nomad segments: thin SERP signal + nicher; skipped for now.
...
## iter140 · 2026-06-28 · RESEARCH — Golan Heights destination, City of David, 14-day itinerary, Nabataean Incense Route, VAT refund

**14-day itinerary gap confirmed (P1 priority)** — "14 day Israel itinerary" and "2 weeks in Israel" are top-5 Israel travel queries by volume. travelingisrael.com, globalhighlights.com, Frommers, Bein Harim, The Ordinary Adventurer, and TripAdvisor all have dedicated 14-day Israel pages ranking on page 1. We have /itineraries/5-days, /7-days, and /10-days but nothing at 14 days — the biggest search-volume gap in our itinerary coverage. Format is day-by-day with Booking.com multi-city CTAs and discovercars.com for the self-drive segments. Promoted to P1 because it directly drives multi-night accommodation bookings across TLV + Tiberias + Jerusalem + Dead Sea in one visit.

**Golan Heights destination guide confirmed gap (P2, M)** — touristisrael.com/golan-heights, backpackisrael.com/golan-heights, lonelyplanet.com/israel/golan-heights, TripAdvisor ("15 Best Things to Do in Golan Heights"), and Expedia all rank for "things to do Golan Heights" and "Golan Heights day trip guide". We have golan.md (region hub with brief overview) + golan-heights-wineries in BACKLOG (wine-specific) + golan-druze-villages.md (Druze culture) — but NO comprehensive destination guide covering the major attraction circuit: Gamla Nature Reserve (Masada of the North + largest Griffon vulture colony globally + Israel's tallest waterfall), Nimrod Fortress, Banias, Katzrin, Yehudiya Forest pools. Competitor touristisrael.com structures the Golan as a 2-day self-drive destination and gets strong traffic from "Golan day trip" queries. Car-essential angle pairs naturally with discovercars.com affiliate.

**City of David confirmed major gap (P2, S)** — cityofdavid.org.il, US News Travel, TripAdvisor, iTravelJerusalem, Bein Harim, and Lonely Planet all rank for "City of David Jerusalem guide" and "Hezekiah's Tunnel visit". 1M+ visitors/year to the site. We mention Hezekiah's Tunnel in passing across various Jerusalem content but have zero standalone guide. The wet-tunnel vs dry-tunnel comparison + Pool of Siloam + Gihon Spring + 5-minute walk from Western Wall is a compelling package. GYG lists multiple 5-star "City of David + Hezekiah's Tunnel" tour products — natural affiliate anchor. Context note: Elad Foundation management + Silwan neighbourhood context should be acknowledged factually.

**Negev Incense Route / Nabataean cities confirmed gap (P2, M)** — UNESCO WHS #1107 (2005); myisraeliguide.com, israel-in-photos.com, and biblewalks.com rank for Avdat, Mamshit, Shivta, Haluza individually. Our BACKLOG has israel-unesco-sites hub (which gives the Incense Route a brief multi-line mention as one of 9 UNESCO sites) and south-israel-itinerary (Avdat as 2-sentence stop). Neither is a dedicated full visitor guide to all 4 Nabataean cities. The opportunity: no competitor has a single high-quality guide covering all 4 cities with honest per-site infrastructure expectations (Avdat = developed + easy; Haluza = for enthusiasts only). Frankincense trade narrative + desert agriculture innovation = compelling content that earns links from history + archaeology communities.

**Israel VAT refund confirmed gap (P3, S)** — iaa.gov.il (IAA official), touristisrael.com, israelwelcome.com, ottoisrael.com, and eazyvat.com all rank for "Israel VAT refund tourists". We have zero coverage. 17% VAT refund process is bureaucratic and unfamiliar to most tourists; clear step-by-step guide + Eilat exception note fills a real planning gap for shopping-focused visitors. Low search volume but high purchase intent (people searching are spending ₪1,000+ on goods).
...
### 2026-06-28 · iter150 · RESEARCH — Yoga retreats, Gluten-free/celiac, Post-Birthright, Summer heat, Art gallery circuit, Cultural context guide

Searches: bookretreats.com/israel-spiritual-retreats, bookyogaretreats.com/israel, sixsenses.com/shaharut, theisraelbites.com/gluten-free, theglutenfreetravelbliss.com/gluten-free-tel-aviv, pomegranate-travel.com/gluten-free-israel, authenticisrael.com/israel-revisited, postbirthright.weebly.com, myguesttlv.com/summer, israelwitharky.com/summer-israel, aardvarkisrael.com/heat, beinharimtours.com/summer, timeout.com/israel-art-galleries, gordonallenby.co.il, rosenfeld-gallery.com, sommer.co.il, ricksteves.com/israel.

**Yoga, meditation & spiritual retreat gap confirmed (P2, M)** — bookretreats.com, bookyogaretreats.com, health.travel, theculturetrip.com, your-friends-in-israel.com/best-wellness-retreats all rank for "spiritual retreats Israel." Key centers not covered on site: Six Senses Shaharut (Arava desert, luxury yoga + Ayurveda, ~$700–$1,200/night), Desert Ashram (Negev, Osho-lineage meditation commune + festival hub), Moa Oasis (ancient Nabataean incense route, eco-resort + workshops), Mitzpe Alummot (lower Galilee, raw-food retreat overlooking Sea of Galilee), Or HaLev (Jewish spirituality/meditation, Galilee), Lev Hamidbar Center (Arava), Ne'ot Semadar (eco-oasis + yoga). DISTINCT from wellness/spa BACKLOG item (which covers Dead Sea spa hotels + hot springs + hammam only, not retreat centers). High affiliate revenue: retreat bookings via bookretreats.com partner programme.

**Gluten-free & celiac travel gap confirmed (P2, S)** — theisraelbites.com positions itself as "Israel's only English GF/celiac guide." Also ranking: theglutenfreetravelbliss.com/gluten-free-tel-aviv, touristisrael.com/gluten-free-in-tel-aviv, pomegranate-travel.com/gluten-free-israel, celiactravel.com, dannythedigger.com/gluten-free-israel. ZERO gluten-free/celiac content on site. High-intent niche (celiacs must research before traveling; legal/medical dietary need). Israeli food infrastructure has strong natural GF alignment (hummus, shakshuka, sabich, falafel — but verify each: tahini from shared equipment may be cross-contaminated; shakshuka toppings like pita = not GF; labelling laws differ from EU). Distinct from vegan guide and kosher guide.

**Post-Birthright independent return gap confirmed (P2, M)** — authenticisrael.com/israel-revisited, postbirthright.weebly.com (old, low-quality) are the only competitor pages targeting Birthright alumni. 1M+ alumni who took free 10-day trip; returning as paying independent travelers; average age 22–35; higher spending power for second trip. Content angle: "Been on Birthright? Here's what you missed and where to go next." Deeper experiences: Negev glamping, Golan wine tour, kibbutz hotels, local food scene, startup tech tour, volunteer programs, West Bank context tourism (note: treat sensitively). Booking.com + GYG + Viator affiliate CTAs. Zero equivalent editorial on competitor travel sites beyond thin affiliate pages.

**Israel summer heat guide gap confirmed (P2, S)** — myguesttlv.com "Tel Aviv Summer Travel Guide," israelwitharky.com "Ultimate Guide to Visiting Israel in the Summer," aardvarkisrael.com "Beating the Heat," Bein Harim "Escaping the Heat in Israel" all maintain dedicated summer survival content. Families must travel July–August for school schedules; "Israel in summer" queries peak June–August. Our site has best-time-to-visit-israel.md which recommends spring/fall; no page addresses "must travel in summer — here's how to maximize it." Distinct content angle: early-morning sightseeing strategy, midday indoor refuges (museums, indoor markets, Sarona, AC restaurants), coast-over-inland rotation, Dead Sea at dawn only, Masada Snake Path heat closure (10am–3pm Jul–Aug), beach rotation (Mediterranean coast cooling breezes), budget tricks (early July vs peak August pricing).

**Contemporary art gallery circuit gap confirmed (P3, S)** — timeout.com/israel, TripAdvisor, Abraham.travel all include gallery circuits. Key galleries: Gordon Gallery + Rosenfeld Gallery + Sommer Contemporary in TLV; Ilana Goor Museum in Jaffa; Tel Aviv Museum of Art (world-class collection). Our site has tel-aviv-white-city.md (architecture) and jerusalem-museums BACKLOG (historical/science/tech); no contemporary art gallery circuit guide exists. Serves architecture-design-art tourist segment; lower monetization than P2 items.

**Rick Steves-style cultural context guide gap confirmed (P3, M)** — Rick Steves' Israel content (TV special + books) attracts a distinctive "thoughtful traveler" seeking cultural context and balanced perspective. Our site has first-time-in-israel.md (practical logistics) and jewish-heritage-israel.md (specific religious community guide) but nothing targeting the NPR-listener / culturally-curious demographic wanting historical depth, contemporary culture, Israeli-Palestinian context, and travel philosophy. No competitor travel site has an equivalent editorial positioning piece (most are logistical); this is a differentiated angle.
...
### 2026-07-05 · iter 320 · Nationality/niche segment gap scan
Sources: cwgc.org, australian-war-memorial.gov.au, alltrails.com, hike-israel.com, thebrokebackpacker.com, timeout.co.il, lonelyplanet.com/israel, roughguides.com/israel, blacktravelerscollective.com, archaeologytravel.com, armenian-patriarchate.org, gaytlvguide.com.

- **cwgc.org + australian-war-memorial.gov.au** — CWGC Israel cemetery pages (Beersheba, Haifa, Ramla) get a measurable portion of search traffic from Australian/NZ travelers planning heritage pilgrimages, but no Israel travel editorial site has a dedicated guide for the ANZAC heritage trail in the Holy Land. The Beersheba Charge (31 October 1917) is iconic in Australian national memory — the charge by the Australian Light Horse is one of the last successful cavalry charges in military history; the Australian War Memorial calls it a decisive turning point in the Middle East campaign. Neither touristisrael.com, lonelyplanet.com, nor any competitor offers a dedicated "ANZAC trail Israel" editorial. Gap: `/israel-anzac-heritage` (P2, S) → added to BACKLOG.

- **alltrails.com + hike-israel.com** — AllTrails is the #1 global hiking app; their Israel collection has 500+ trails with 200,000+ user reviews. Their "Best Hikes near Israel" editorial pages rank for "best hikes Israel", "easy hikes Israel", "top trails Israel" and convert into AllTrails Pro subscriptions. We have hiking-in-israel.md (general overview) and water-hiking-israel.md (nahal swim hikes) but NO curated "best hikes" ranked editorial list that competes with AllTrails' editorial format. hike-israel.com has a detailed trail database but no narrative editorial. Gap: `/israel-best-hikes` (P2, M) → added to BACKLOG.

- **archaeologytravel.com + roughguides.com** — "Top 10 archaeological sites in Israel" editorial pages on archaeologytravel.com, roughguides.com/israel/history-culture, and lonelyplanet.com/israel/history all rank for "ancient ruins Israel", "archaeology sites Israel", "best archaeological sites Holy Land". We have individual site guides (caesarea-guide, herodion-guide, megiddo-jezreel-valley-guide, qumran-guide) but no editorial hub page that aggregates and ranks Israel's top archaeological sites. Gap: `/israel-top-archaeological-sites` (P2, M) → added to BACKLOG.

- **armenian-patriarchate.org + timeout.co.il/jerusalem** — The Armenian Quarter is the smallest of Jerusalem's 4 Old City quarters (0.13 km²) and historically the least covered in English travel editorial. The Armenian Patriarchate of Jerusalem (founded 638 CE) maintains a rich museum, a 12th-century St. James Cathedral (open 6:30–7:30am and 3:00–3:30pm only), and a genocide memorial. touristisrael.com covers the Armenian Quarter in a 2-paragraph sidebar within their Jerusalem Old City article; timeout.co.il published a standalone Armenian Quarter feature in 2023; lonelyplanet.com has a short entry. Our jerusalem-neighborhoods-guide.md covers all 8 areas of Jerusalem but the Armenian Quarter gets ~150 words as one of 8 sections. Gap: `/jerusalem-armenian-quarter` (P2, S) → added to BACKLOG.

- **blacktravelerscollective.com + thebrokebackpacker.com** — Black and African diaspora travel communities (Black Travel Movement, BlackTravelersCo, Nomadness Travel Tribe) surface Israel content primarily around two unique draws: (a) the Beta Israel (Ethiopian Jewish) community — 160,000+ Israeli citizens of Ethiopian origin; Gondar Synagogue in Jerusalem, Beta Israel community centres in Rehovot + Or Yehuda + Kiryat Malakhi; (b) the Black Hebrew Israelite community in Dimona — the "Village of Peace" founded 1969 by Ben Ammi Ben-Israel; ~3,000 African American residents; entirely self-sufficient community with own agriculture, crafts, and vegan cuisine; open to respectful visitors. Neither touristisrael.com nor any major competitor has editorial for this audience segment. Google Trends shows "Israel for Black travelers" rising search volume. Gap: `/israel-for-black-travelers` (P2, M) → added to BACKLOG.

- **gaytlvguide.com + mfa.gov.il + wikipedia (LGBT rights in Israel)** — Israel's LGBTQ+ acceptance trajectory is a remarkable and underreported story: decriminalization 1988, IDF open service and first Pride Parade 1993, same-sex couples receive full pension rights 1994, Supreme Court same-sex adoption 1994 (internationally pioneering), partner housing benefits for IDF 1998, Tel Aviv ranked #1 gay-friendly city (TimeOut 2011, 2013), official "Tel Aviv Gay Tourism" branding by IMOT. Our lgbtq-travel-israel.md covers practical guide (where to stay, Pride dates, safety). Zero competitor has a standalone historical-context/timeline guide explaining HOW Israel got here — making it a unique evergreen article for LGBTQ travelers wanting cultural depth. Gap: `/israel-lgbtq-history` (P3, S) → added to BACKLOG.
...
## iter355 findings (2026-07-07)

**Research method:** Python3 regex cross-checks of BACKLOG.md + DONE.md + guides/ directory against ~25 candidate topics; targeted grep of all 238 P-tagged backlog items; manual verification of 7 confirmed new gaps.

**Key competitor observations:**
- **elijahtours.com** — maintains a "Complete Jericho Guide 2026" that ranks well for "Jericho Israel" queries; covers all 5 major Jericho sites in depth; clear SEO win opportunity for the standalone Jericho destination guide (/jericho-guide).
- **dark-tourism.com** — has a dedicated Israel section covering Atlit Detainee Camp, Ghetto Fighters' House, and Ammunition Hill; ranks for "dark tourism Israel" with no competition from visitisrael.site.
- **touristisrael.com** — comprehensive coverage of Ashkelon, Circassian villages (Kfar Kama), and Cremisan Winery that we currently lack entirely; their Ashkelon page ranks for "Ashkelon national park" and "Ashkelon guide".
- **salesian-cremisan.com** — official Cremisan Winery site; has English tour info; our opportunity is the destination guide framing (combine Beit Jala + wine tourism + Jerusalem views) that the official site doesn't provide.
- **thesamaritanupdate.com** — Samaritan community's own publication; key source for Passover ceremony date (varies annually) — always link as the authoritative source in the Samaritan guide.
- **parks.org.il/tel-afek** — Tel Afek is an INPA park with minimal English SEO presence; no competitor has a standalone English Tel Afek guide; the Acts 23:31 Pauline route connection + Ottoman fort combination is unique content.
- **Backlog saturation note:** At 238 P-tagged items + 175 shipped guides (~413 total), the visitisrael.site content corpus is now extremely comprehensive for mainstream Israel travel. Future RESEARCH iterations should focus on: (a) very niche cultural minorities (Samaritans, Circassians, Druze food vs. villages already done); (b) cross-border tourism (Cremisan, Jericho, specific Aqaba/Jordan day trips); (c) specific INPA parks with no English guide coverage (Tel Afek; check parks.org.il for remaining unguided parks); (d) thematic hub guides (dark tourism, medical tourism, agritourism sub-themes); (e) i18n Phase 4 remaining attractions (20+ EN attraction pages still without FR+DE).

**Rejected this iteration (de-duped):** Yarkon Park (in DONE cycling cross-ref), Coral World Eilat (in diving guide as cross-ref; needs standalone attraction page decision), Nazareth Village museum (in DONE cross-ref), Beit She'arim necropolis (already P-tagged in backlog), Jaffa orange heritage (thin content; better as jaffa-travel-guide expansion), all previously-identified Israel wine harvest / Tel Aviv museums / Nazareth food items (all confirmed in backlog from prior research iters).

## iter360 (2026-07-07) — INPA nature parks cluster + unique art destination research

**hike-israel.com/red-canyon-israel** — Most comprehensive standalone Red Canyon Eilat guide on any Israel travel site; full trail description with 3 waypoints + flash flood warning + bus 392 schedule; ranks top 3 for "Red Canyon Eilat" queries. Demonstrates that a standalone short guide (<1,200w) for a free, single-trail site can rank well when competitors (eilat.city, backpackisrael.com, walkmyworld.com) all have their own versions. Key SEO pattern: "Red Canyon" query = zero site authority needed — content depth wins.

**laidbacktrip.com/red-canyon-eilat-guide** and **walkmyworld.com/red-canyon-eilat** — Two English-language travel blogger guides for Red Canyon Eilat ranking alongside hike-israel.com; neither site has broader Israel authority but both outrank eilat-travel-guide.md (SHIPPED) for this specific query. Confirms that a standalone focused page >> a one-line bullet in a city guide for this type of attraction.

**israel-in-photos.com/nimrod-fortress** — Dedicated Nimrod Fortress guide with full INPA spec (22 NIS entry, hours by season, trail map description); ranks for "Nimrod Fortress visitor guide". The site israel-in-photos.com has standalone guides for nearly every INPA park — it is the dominant EN competitor for INPA park content. Pattern: for each INPA park with competitor standalone guides but zero visitisrael.site coverage, a P2/P3 standalone guide is justified.

**igoogledisrael.com/nimrod-fortress** — Shorter guide (800w) but ranks alongside israel-in-photos.com; confirms the "multiple competitors" signal for Nimrod. Key differentiator for our guide: correct the widespread misattribution of Nimrod Fortress to Crusaders (it was Ayyubid Muslim construction 1229 CE). The Crusader correction is unique editorial value vs. all competitors who get this wrong.

**nativa.co.il/hay-bar-yotvata-nature-reserve-guide** — Comprehensive Hai Bar Yotvata guide in English from an Israeli nature tour operator; covers self-drive format + nocturnal predator section + species list. Ranks top 5 for "Hai Bar Yotvata". Key content note: the nocturnal predator viewing tour (sand cat, caracal, striped hyena) is a separate booking from the open-range self-drive — both sections require separate mention.

**eilattickets.com/hai-bar-yotvata** — Sells tickets directly for both the open-range self-drive and the nocturnal tour; confirms ticket pricing structure (separate fees for each section). Opportunity: link to eilattickets.com as the booking source (no direct GYG/Viator product confirmed for Hai Bar).

**nativa.co.il/achziv-national-park-guide** — Achziv National Park guide from a nature specialist site; covers sea lagoons + snorkelling + camping + Phoenician archaeology + sea turtle nesting. Ranks alongside israel-in-photos.com for "Achziv National Park Israel". Both confirm the camping angle is important (capacity-limited INPA camping = advance booking essential = useful evergreen warning content).
...
**timesofisrael.com (Nov 2024)** — Covered the November 25, 2024 designation of Yam Caesarea (Sea of Caesarea) as Israel's first marine national park. 267 acres west of Caesarea Antiquities National Park. INPA and Nature and Parks Authority designated the site to protect the submerged Herodian harbor (20 BCE) alongside ecological habitats: coral reef communities, seagrass meadows, rocky shorelines. INPA developing visitor access (diving trails, snorkeling routes, swimming zones). No English-language Israel travel site currently has a standalone visitor guide for Yam Caesarea Marine NP. The "Israel's first marine national park" PR hook is unguided on the web beyond news articles.

**parks.org.il/caesarea** — Caesarea national park page does not yet have dedicated Yam Caesarea Marine NP visitor content; marine NP angle entirely absent from the existing Caesarea NP pages as of July 2026.

**caesarea-diving.com** — Old Caesarea Diving Center (sole INPA-permitted operator for the underwater park); their site covers booking logistics for the existing underwater archaeology park but does not reference the 2024 marine NP designation; opportunity to position our guide as the first comprehensive standalone visitor resource.
...
### 2026-07-19 · iter 630 · RESEARCH pass #128

**Focus:** Bahrain/UAE Abraham Accords inbound travelers; Tel Aviv Museum of Art post-renovation status; new Q2-Q3 2026 resort/attraction openings; India e-visa market dynamics

**Kassland Resort & Spa (kassland.co.il)**
New June 2026 mega-resort in Ma'ale Adumim (Area C, West Bank settlement). ₪220M investment. 220 rooms; Atlantis Spa (4,500 sqm, 20+ pools: thermal, hammam, snow room, Turkish bath); Kass Splash (largest indoor water park in Middle East); Magic Kass amusement park (largest in Israel); bowling. 15 min from Jerusalem via Route 1. Appearing on Booking.com; TripAdvisor early reviews; Ynet + Israel Hayom feature coverage. No competitor has editorial guide yet. EDITORIAL CAUTION: Ma'ale Adumim is an Israeli settlement in the West Bank — requires human editorial review per project policy before covering. Sources: ynetnews.com/travel/article/skbpbaqjzg; israelhayom.com/2026/06/17/kassland-a-new-israeli-resort-for-the-entire-family.

**UAE-Israel air travel surge: Q1 2026**
170,000+ passengers flew between UAE and Israel in Q1 2026 (+30% YoY per Etihad route analysis). Etihad operates daily AUH→TLV; flydubai also active. Only ~1,600 Emirati citizens have visited Israel despite 500,000+ Israelis visiting UAE — massive asymmetry. Our /israel-for-gulf-travelers backlog item (iter230) addresses this. Competitors: businesstraveller.com, touristisrael.com, goisrael.com all have outbound (Israel→UAE) content but NO comprehensive inbound guide for Emirati visitors. Sources: businesstraveller.com/features/how-israel-and-the-uae-are-growing-their-tourism-links; travelandtourworld.com/news/article/jzpjdjmk02ii; pbs.org/newshour/world/israels-hopes-for-united-arab-emirates-tourism-fall-short.

**Israel Tourism Ministry Seoul seminar (2025)**
Israel Tourism Ministry held dedicated marketing seminar in Seoul (Lotte Hotel, 2025) targeting South Korean pilgrimage tourism. ~200 attendees: Korean church leaders, airlines, travel agents. South Korea has ~14M Christians (~29% of population); organized Holy Land pilgrimage is core evangelical practice. Our /israel-for-korean-travelers backlog item (iter455) already covers this market; new seminar data confirms active IGTO outreach. Arkia TLV-TYO (Tokyo Narita) direct service launching October 2026 may also increase Korean interest via Tokyo hub connection. Sources: itn.co.il/top-stories/israel-strengthens-ties-with-south-korea; travelandtourworld.com/news/article/israel-enhances-travel-ties-with-south-korea.

**Indian e-visa for tourists: July 2025 launch**
Israel launched eVisa-B2 specifically for Indian (and Sri Lankan) tourists July 1 2025. Multiple major Indian travel sites (btwvisas.com, unimoni.in, travelbooksfood.com) actively rank for "Israel visa for Indians 2026" / "Israel e-visa India". 70,000+ Indian tourists visited 2023 pre-e-visa; removal of embassy-visit friction will accelerate growth. This justifies upgrading /israel-for-indian-travelers from P3→P2 in BACKLOG. No competitor has a comprehensive India-specific Israel travel guide targeting this new e-visa query cluster. Sources: btwvisas.com/visa-guide/israel-tourist-visa; unimoni.in/blog/israel-introduces-e-visa-system-for-indian-travelers; travelbooksfood.com/israeli-visa-indians.

**Tel Aviv Museum of Art 2026-2027: CONFIRMED FALSE LEAD**
No 2026-2027 expansion or major reopening project exists. Last significant change: 2023 renaming of Helena Rubinstein Pavilion → Eyal Ofer Pavilion following standard renovation. No Tel Aviv Museum expansion announced via press releases, museum site, or cultural media. Verified by research agent (30+ web searches). Previous STATE.md note "Tel Aviv Museum post-renovation status" is now closed as a false lead.

### Competitive landscape at pass #128

Saturation: ~94%+. 1 net-new BLOCKED item from ~40 candidates — lowest yield pass in the research series. This confirms the backlog is extremely well-populated. The primary remaining gaps are: (1) editorial items dependent on political/settlement policy decisions (Kassland); (2) items already in BACKLOG but at P3 waiting for BUILD turn (Korean, Indian, Gulf, Moroccan, Malaysian, Singaporean nationality guides; ANU Museum; Birthright; canyoning; military heritage; etc.); (3) content freshness updates (cheap-flights routes, Purple Line correction, Tower of David 2027 exhibition). Abraham Accords nationality guides (UAE, Bahrain) are fully covered by the existing combined /israel-for-gulf-travelers backlog entry — no separate per-country guides needed. Next research pass should focus on: any confirmed 2027 major attraction openings not yet captured; Israeli startup/tech tourism niche (is this covered?); potential freshness audit of pre-2025 content for fact-checking.

---

### 2026-07-19 · iter 635 · RESEARCH pass #129

**Focus:** El Al airline expansion (Manila route); Etihad Abu Dhabi-TLV capacity; Tel Aviv luxury hotel openings 2026; Tower of David exhibition status; Tel Aviv Museum of Art (false lead closure)

**El Al TLV→MNL direct: October 2026**
El Al launching first-ever non-stop Tel Aviv→Manila (Philippines) service October 2026. All previous MNL-TLV routes required connections via Middle East (AUH/DOH/DXB) or Asia hubs (BKK/SIN), typically 16–19h; non-stop will cut journey time significantly. Philippines is world's 3rd-largest Catholic country (~92M Catholics, ~80% of 115M population); organized Catholic and evangelical/charismatic pilgrimage to the Holy Land is a major and growing travel segment; ~30,000 Filipino OFWs (Overseas Filipino Workers) in Israel's caregiving sector add family-visit demand. El Al's commercial route decision confirms significant existing traffic between the two countries. COMPETITOR CONTEXT: No competitor editorial brand (Tourist Israel, Lonely Planet, Rough Guides, Bein Harim) has yet updated their Filipino-specific content to reflect the direct route. Early-mover coverage advantage. BACKLOG ACTION: israel-for-filipino-travelers upgraded P3→P2.

**Etihad Abu Dhabi–Tel Aviv: 6x daily from June 15 2026**
Etihad expanded AUH→TLV to 6x daily flights from June 15, 2026, making this one of the highest-frequency Gulf-Israel routes. Combined with flydubai Dubai→TLV service, Gulf-Israel air connectivity is at historically high levels. Q1 2026 UAE-Israel air: 170K+ passengers +30% YoY (Etihad data). Despite Abraham Accords normalization (Sep 2020), only ~1,600 Emirati citizens have visited Israel — massive asymmetry suggesting outbound Emirati travel to Israel is growing from a very low base. COMPETITOR CONTEXT: businesstraveller.com has outbound (Israel→UAE) content; no competitor has comprehensive inbound Emirati visitor guide. This data supplements the existing /israel-for-gulf-travelers BACKLOG item (iter230, P2). CONTENT FRESHNESS NOTE: cheap-flights-to-israel.md Gulf section should reference Etihad 6x daily frequency when next refreshed; /israel-for-gulf-travelers guide when built should lead with current frequency + affordability data.

**Six Senses Tel Aviv + Nobu Hotel Tel Aviv: 2026 luxury openings**
Two marquee luxury hotel brands entering Tel Aviv in 2026: (1) **Six Senses Tel Aviv** — ultra-luxury wellness brand; rooftop spa + holistic programming; Old North neighbourhood; targets international wellness tourism and ultra-high-end leisure travellers. (2) **Nobu Hotel Tel Aviv** — Robert De Niro/Nobu Matsuhisa brand debut in Israel; lifestyle-luxury tier; strong Japanese-fusion restaurant draw that would attract dining-destination guests. Both openings post-date SHIPPED /best-hotels-tel-aviv guide (iter243, SHA e75fa0b). COMPETITOR CONTEXT: No competitor editorial brand currently has updated coverage of Six Senses TLV or Nobu TLV with practical visitor information. CONTENT FRESHNESS NOTE: If /best-hotels-tel-aviv is scheduled for a periodic refresh, add Six Senses (Luxury tier, wellness angle) and Nobu (Luxury-lifestyle tier, restaurant destination angle) to the Luxury section. No separate BACKLOG item needed — existing guide covers this category; this is a refresh rather than a new page.

**Tower of David "Eyes on the Wall" April 2027 confirmed on track**
Tower of David Museum (tod.org.il) launched a public crowdsourcing campaign in June 2026 calling for historical photographs of the Western Wall from the public — in advance of "Eyes on the Wall" permanent exhibition opening April 2027, marking the 60th anniversary of Jerusalem's reunification in the 1967 Six-Day War. Crowdsourcing campaign covered by Times of Israel and JTA. This confirms: (a) the April 2027 exhibition opening is on schedule; (b) the crowdsourcing campaign adds a new content hook ("contribute your Western Wall photos to the Tower of David Museum's landmark 2027 exhibition") not in the original iter625 BACKLOG item. COMPETITOR CONTEXT: No competitor has updated tower-of-david content to reference the 2027 exhibition. The existing iter625 BACKLOG item correctly captures the core update ("Tower of David 'Eyes on the Wall' 2027 exhibition — add to /tower-of-david-guide.md"); no changes to that item needed. Crowdsourcing campaign angle is a content bonus if the guide update is implemented before the campaign concludes.

**Tel Aviv Museum of Art: CONFIRMED FALSE LEAD (2nd + final confirmation)**
No 2026-2027 expansion, major renovation, or new exhibition hall announced. The only recent institutional change: 2023 donor renaming of Helena Rubinstein Pavilion → Eyal Ofer Pavilion following standard maintenance renovation. Verified across museum's official site, Israeli cultural press (Haaretz, Times of Israel), and international arts media. Previous research pass #128 reached the same conclusion. This lead is permanently closed — future research passes should dismiss "Tel Aviv Museum of Art expansion" claims without investigation.

### Competitive landscape at pass #129

Saturation: ~94%. 0 net-new BACKLOG items; 1 priority upgrade (israel-for-filipino-travelers P3→P2). Research passes are now predominantly confirmatory — closing false leads and adding freshness context rather than surfacing genuinely new content gaps. Remaining high-value BUILD queue: nationality guides (Filipino P2, Indian P2, Gulf P2); experience guides (canyoning, Birthright, ANU dedicated); content freshness batch (Tower of David 2027 exhibition, cheap-flights airline corrections). Next research pass should focus on: Israeli tech tourism / startup visitor niche (any gap?); 2027 confirmed attraction openings beyond Tower of David (Dead Sea minerals museum? Negev museum expansion?); potential freshness audit of pre-2024 guides (visa-information, ben-gurion-airport-guide, cheap-flights-to-israel) for factual accuracy against current operations.

---

### 2026-07-19 · iter 640 · RESEARCH pass #130

**Focus:** El Al Asia/South America expansion; travel advisory updates; Nova memorial site traffic; startup tourism; is-israel-safe freshness; Korean/Argentine market upgrades

**El Al TLV→ICN (Seoul Incheon) direct: March 27, 2027**
El Al launching first-ever Israeli-operated direct Tel Aviv–Seoul service starting March 27, 2027, operating 3x/week (Mon/Wed/Sat) on Boeing 787-9 Dreamliner. Route restores direct Israel-Korea connectivity after Korean Air suspended its TLV service post-Oct 7 2023. South Korea has ~14M Christians (~29% of 51M population); organized evangelical Holy Land pilgrimage is a core practice; the direct route significantly reduces journey time from the previous 14–18h connection routing. IGTO held dedicated Seoul marketing seminar in 2025 (~200 attendees: church leaders, airlines, travel agents). Israel tourism from Korea has been recovering; El Al's route commitment signals commercial confidence in the market. BACKLOG ACTION: israel-for-korean-travelers upgraded P3→P2; flight section updated.

**El Al TLV→EZE (Buenos Aires Ezeiza) direct: November 29, 2026**
El Al launching direct Tel Aviv–Buenos Aires service starting November 29, 2026, operating 2x/week (Sun/Tue). Alongside the TLV→ICN route, El Al is executing a major long-haul expansion using Boeing 787-9 aircraft. Buenos Aires–TLV is one of the world's longest-operated Latin America–Israel air corridors but has historically depended on Aerolíneas Argentinas seasonal service (often suspended). El Al's entry adds regular, reliable direct connectivity. Argentina has world's 5th largest Jewish community (~180K practicing; larger heritage-identification group); AMIA bombing (1994) means Argentine Jews have deep emotional connection to Yad Vashem; Catholic pilgrimage market via Buenos Aires Archdiocese. BACKLOG ACTION: israel-for-argentinian-travelers upgraded P3→P2; flight section updated.

**Nova Music Festival Memorial: 250,000+ visitors H1 2026**
Forbes reported the Nova Festival Memorial Site at Re'im now attracts 250,000+ visitors in first four months of 2026, making it one of Israel's most-visited sites. Bein Harim Tours, Tourist Israel, Exclusive Israel Tours, and World Jewish Travel all have dedicated memorial tour content. Our site has zero content for this topic; the existing october-7-memorial-sites BACKLOG entry remains BLOCKED (requires human editorial review) — the volume data confirms high demand but does NOT change the honesty constraint. Sites: Nova Festival Memorial (Re'im forest, between Kibbutz Be'eri and Kibbutz Re'im; permanent art installations + victims' photos + sculptural red anemones + butterfly paintings for kidnapped; organized tours only — no public transport to site; car cemetery at Tekuma; Sderot visitors center with resilience tours. IDF safety guidelines for guided access. Kibbutz Kfar Aza: restricted military zone — verify access status before any content mentions. COMPETITOR NOTES: beinharimtours.com/nova-music-festival-memorial-site; exclusiveisraeltours.com/the-nova-festival-site-tour; touristisrael.com/tours/gaza-border-nova-festival-small-oct-7-memorial.

**Travel Advisory Material Improvement (June–July 2026)**
Major shift: UK FCDO removed Israel from "advise against all travel" list (first time since June 2025 Iran war; source: jpost.com/international/article-898300); EU EASA downgraded Israel aviation risk from Conflict Zone Bulletin to Information Note effective July 8, 2026; Canada, France, Germany, Australia, Japan simultaneously downgraded advisories for Israel in June 2026 as part of broader Middle East de-escalation tied to US-Iran talks. Most of Israel now categorized at "exercise normal/increased caution" vs "do not travel" for UK and other major economies. Remaining restrictions (all countries): Gaza + 500m border, Golan Heights, northern West Bank. US State Dept remains Level 2 (Exercise Increased Caution). This is a significant SEO content freshness opportunity — is-israel-safe.md content may still reference the higher-risk advisory language from peak-conflict 2024-2025 period. BACKLOG ACTION: new P2 technical freshness item added (is-israel-safe advisory update).

**Startup/Tech Tourism (Tourist Israel has content; we do not)**
Tourist Israel (touristisrael.com/visiting-tel-aviv-startups) has a dedicated "Visiting Tel Aviv Startups" guide covering: Taglit-Birthright Innovation Center (TLV Stock Exchange, interactive displays), startup company tour visits. MyIsraelGuide has "Start-Up Nation Tour" content. Timeout Israel has Touring the Tech District article. No equivalent on visitisrael.site. However, this is a thin audience (corporate/tech professional niche; not mass tourist). Estimated search volume < 500/month. At 94% saturation, this is a P4/borderline content item — not a priority addition given the many higher-value P2 items in BACKLOG.
...
## iter680 research pass #138 (2026-07-21) — Bahá'í pilgrimage, National Bike Trail, freshness audits

**Sources consulted**: bahai.org/pilgrimage, ibt.org.il/en/route, ynetnews.com (Lag BaOmer 2026 bonfire ban), meron.co.il, bikepacking.com/routes/israel-bike-trail, bikemap.net, outdoorisrael.com, israir.com/flights/tlv-jfk, elal.com (TLV-SFO seasonal), timeout.com/israel/haifa/bahai-gardens, touristisrael.com/haifa/attractions, haaretz.com (May 2026 bonfire ban), iaa.gov.il (Purple Line construction update).

**New net-new gaps found (2)**:
- `/bahai-pilgrimage-haifa` (P3/S): The Bahá'í World Centre in Haifa is a UNESCO World Heritage site (Shrine of Báb + Terraced Gardens) AND one of only two active Bahá'í pilgrimage destinations on earth (the other being Acre/Akko). The global Bahá'í community numbers 5–8M adherents, many of whom aspire to the 9-day formal pilgrimage (bahai.org; invitation-only; 3-year waiting list). No mainstream travel site (Lonely Planet, TripAdvisor, Timeout Israel, TouristIsrael) covers the pilgrim vs. tourist distinction: visiting hours for non-pilgrims (gardens free daily 09:00–12:00; Shrine of Báb modest dress); 9-day formal pilgrim program (accommodation provided by Bahá'í institutions; open to registered community members); Shrine of Bahá'u'lláh in Akko (formal pilgrim site); Bahá'í calendar dates (Naw-Rúz ~March 21; Ridván April–May). haifa-guide.md briefly mentions the terraced gardens without pilgrim context; no standalone dual-angle guide exists.
- `/israel-national-bike-trail` (P3/M): The Israel Bike Trail (IBT / שביל האופניים הישראלי; ibt.org.il) is a 1,200km dedicated off-road cycling route from Kibbutz Dan (north) to Eilat, analogous to the INT for hikers. ~400km northern section fully waymarked as of mid-2026; southern desert sections still in development. cycling-in-israel.md (SHIPPED) covers urban cycling (Tel-O-Fun bike share, Jerusalem bike paths, Haifa Carmelit, Golan loops) — DISTINCT from IBT as a dedicated thru-ride or multi-day adventure. Confirmed competitor coverage: bikemap.net, bikepacking.com/routes/israel-bike-trail, outdoorisrael.com all have IBT route content; no mainstream editorial guide targets the segment-riding tourist.

**2026 freshness intelligence (not net-new content, context for existing BACKLOG/pages)**:
- Lag BaOmer 2026: Israeli government imposed a nationwide bonfire ban for Lag BaOmer 2026 (Knesset vote following post-Oct 2023 emergency fire-risk assessment); Meron pilgrimage limited to ~600 registered worshippers (vs. historical ~100,000+) via Ministry of Religious Services lottery. BACKLOG item lag-baomer-israel (P3/S, iter265) must address this when built.
- Haifa cruise terminal (May 2026 opening): Bay Cruise Terminal handles two mega-ships simultaneously; target 1M passengers/year. haifa-shore-excursions (P3/S in BACKLOG) upgraded to P2/S — terminal opening materially increases 2026+ search volume.
- cheap-flights-to-israel.md freshness: Israir TLV–JFK operational (US DOT confirmed May 2026; first nonstop in years); El Al TLV–SFO seasonal nonstop (summer 2026 added); transport-in-israel.md Purple Line section needs deferral note (opening deferred to 2027-2028 per municipal construction delays).

**False leads eliminated (18)**:
haifa-shore-excursions (ALREADY IN BACKLOG P3/S — priority upgrade to P2/S noted above), lag-baomer-israel (ALREADY IN BACKLOG P3/S iter265 — freshness note added, not new item), cycling-in-israel (EXISTS SHIPPED — IBT angle genuinely distinct → new P3/M added), bahai-gardens-haifa (haifa-guide.md brief mention only → pilgrim angle genuinely distinct → new P3/S added), lumagica-tel-aviv (ALREADY IN BACKLOG P3/S iter380; 2026/27 dates not yet publicly confirmed — hold), florentin-standalone (ALREADY IN BACKLOG P3/S iter570), israel-for-czech-travelers (ALREADY IN BACKLOG iter660), israel-for-hungarian-travelers (ALREADY IN BACKLOG iter660), israel-rock-climbing (possible file exists — needs verify before adding), israel-cooking-classes (galilee-culinary-institute-gonen.md EXISTS; tel-aviv-food-tours.md EXISTS; no gap confirmed), israel-accessible-tourism (BACKLOG P3/M iter435), israel-for-belgian-travelers (BACKLOG P3/S iter515), israel-for-italian-travelers (BACKLOG P3/S iter445), israel-for-dutch-travelers (BACKLOG P3/S iter450), israel-for-polish-travelers (BACKLOG P3/S iter450), israel-for-nordic-travelers (BACKLOG P3/S iter450), israel-for-brazilian-travelers (BACKLOG P3/S iter450), israel-mice-incentive-travel (BACKLOG P3/M iter670).

**Saturation: ~95%.** Pass #138 yield of 2 net-new items from 20 candidates is consistent with extreme saturation. Remaining highest-value unshipped: nationality guides (Portuguese P2/S, Vietnamese P3/S, Chilean P3/S, Peruvian P3/S, Serbian P3/S from iter675 batch); dark-tourism (P2/S); coastal-trail (P2/M); evangelical-pilgrimage (P2/M); yoga-retreats (P2/M).

## iter685 research pass #139 (2026-07-21) — Freshness audit + paragliding gap

**Sources consulted**: jns.org (BGS Terminal 1 reopening), delta.com (route schedule via research agent), allisraelnews.com (Lag BaOmer 2026), touristisrael.com, adventure-israel.com, getyourguide.com (paragliding Israel search), israel-travel-2026.md + cheap-flights-to-israel.md (internal file comparison), smartraveller.gov.au (Australian advisory).

**New net-new gaps found (3)**:
- `ben-gurion-airport-guide Terminal 1 freshness` (P2/S/technical): guide's Terminal overview says "domestic + some low-cost European carriers" without noting July 1 2026 international reopening after war-era closure. israel-travel-2026.md correctly notes reopening; airport guide does not. iter638 batch fixed american-travelers.md only; airport guide is the primary authority page.
- `Delta/United conflict` (P2/S/technical): cheap-flights-to-israel.md says "suspended until at least September 2026"; israel-travel-2026.md says "Delta reinstating from October 2026." Pages conflict. Verify at delta.com and reconcile before next BUILD involving either page.
- `/israel-paragliding-guide` (P3/S/seo-content): confirmed triple-zero gap across backlog + DONE + guide files. Israel's year-round paragliding (Carmel coast, Galilee ridge, Ramon Crater) served by Adventure-Israel.com + Paragliding-Israel.com + 3+ GYG products. Low-competition high-intent queries.

**Competitor intel (context only)**:
- TouristIsrael.com continues producing monthly "things to do in Israel in [month]" pages (12 pages for 2026) — format gap already captured in BACKLOG iter670 as P2/L.
- No competitor (TouristIsrael, Lonely Planet, Rough Guides, TripAdvisor) has a paragliding guide for Israel — a genuine editorial whitespace.
- Ben Gurion Airport's Terminal 1 reopening is covered in Israeli press (JNS, Ynet) but no major English travel guide has yet updated its airport-guide content to reflect it.
...
## iter885 — 2026-07-31 — 179th research pass

### 2026-07-31 · iter 885 · Tourist Israel + Bein Harim + freshness scan
...
**Tourist Israel (touristisrael.com) — fresh check:**
No new EN structural gaps vs our 397 guides. Content remains shallower (no affiliate CTA integration, no FAQ depth, no structured data). Their Purim dedicated pages (touristisrael.com/purim-in-tel-aviv/5336, /purim-in-jerusalem/9625, /purim-street-party-tel-aviv/12808) remain unchallenged by us — Purim standalone guide remains P3/S BACKLOG (iter785). No net-new structural gap discovered this pass.

**Bein Harim (beinharim.com) — fresh check:**
Guided-tour aggregator model (sells tours, no deep editorial). Covers Egypt-Jordan-Israel multi-day tours, Galilee circuits, and day-trip packages. Our approach (organic editorial depth + GYG/TourRadar affiliate CTAs) correctly differentiated from their transactional model. No net-new editorial gap.

**Freshness findings:**
- **Israir India routes (DEL + BOM from April 2026)**: NOT currently operating post-Operation Rising Lion (Iran conflict June 2026). DGCA approval for foreign carriers into India unconfirmed. Israir's current capacity committed to A330 NY/Miami August 2026 widebody launch. BACKLOG item "israir-india-routes-freshness" (iter880 P2/S) → DEFERRED. Do not update flight guides until confirmed operating. Re-check Q4 2026.
- **Israir A330 NY/Miami August 2026**: Israir targeting JFK + MIA A330 widebody service August 2026 as flagship expansion. If launch confirmed, cheap-flights-to-israel.md + airlines-flying-israel-2026.md need Israir US widebody row. P2/S verify-first item queued.
- **El Al TOP Platinum Lounge BGA (Q2 2026)**: New dedicated lounge for TOP Platinum elite members confirmed open at Terminal 3. Current ben-gurion-airport-guide.md mentions lounge access generically. P3/S freshness item queued.
- **Brown Hotels BGA airport hotel (2031)**: Brown Hotels Group acquired land adjacent to BGA terminal; 2031 target. Too far out for current guide treatment. Awareness item in BACKLOG.

**i18n gap analysis (all confirmed MISSING via comm -23, 2026-07-31):**
- ES: 100/397. ES-20 next phase: hiking-in-israel, eilat-snorkeling-guide, ein-kerem-jerusalem-guide, golan-heights-tours-compared, haifa-cruise-terminal-guide.
- FR: 137/397 (post-FR-10; pre-FR-11). FR-12 (after FR-11 ships → 142): digital-nomad-israel, eilat-snorkeling-guide, best-hotels-nazareth, galilee-food-guide, golan-heights-tours-compared.
