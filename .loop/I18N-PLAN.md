...
- Current phase: **Phase 6 DONE (iter408, SHA 0d19743)**: Sitemap hreflang enabled via @astrojs/sitemap i18n option. All trilingual pages now emit <xhtml:link rel="alternate"> in sitemap-0.xml. Smoke tests added: sitemap hreflang presence (xmlns:xhtml + xhtml:link count), /fr/jerusalem region hreflang, 5 missing EN routes. 922/922 e2e pass. Phase 6 COMPLETE. **i18n epic phases 0–6 all COMPLETE.**
- Previous phase: **Phase 5 DONE (iter403, SHA cf983a2)**: 12 translated itinerary pages (6 FR + 6 DE): 2-days-in-tel-aviv, 3-days-in-jerusalem, 5-days-in-israel, 7-days-in-israel, 10-days-in-israel, 14-days-in-israel. 2 locale index pages (/fr/itineraries, /de/itineraries). content.config.ts glob **/*.md. hreflang on all locale templates. Locale-aware header nav. YAML fix (Be\'er→Be''er in de/14-days). Smoke +14, a11y +2. 657 pages. 915/915 e2e pass. FR+DE itineraries 6/6 COMPLETE. fr pages: ~155/~165. de pages: ~155/~165. Tools-island UI strings deferred to Phase 5b or Phase 6. Next: Phase 6 — QA sweep (sitemap hreflang, missing-translation fallbacks, per-locale a11y+dead-link sweep).
- Previous phase: **Phase 4 BATCH 12 DONE (iter398, SHA 4d6d5c3)**: 5 Negev attractions × FR+DE (10 locale pages): negev/avdat, negev/bedouin-hospitality, negev/ein-avdat, negev/mitzpe-ramon, negev/sde-boker. YAML German-quote bug fixed in 2 DE files. smoke.spec.ts + a11y.spec.ts +10 routes. 641 pages. 895/895 e2e pass. FR+DE Negev attractions 5/5 COMPLETE. Phase 4 COMPLETE. Remaining deferred: jerusalem/holy-sepulchre + jerusalem/temple-mount (religious/contested). fr pages: ~142/~158. de pages: ~142/~158.
- Previous phase: **Phase 4 BATCH 11 DONE (iter393, SHA 2dadb40)**: 4 Nazareth attractions × FR+DE (8 locale pages): nazareth/basilica-of-the-annunciation (religiousSiteId preserved FR+DE), nazareth/marys-well (religiousSiteId preserved FR+DE), nazareth/mount-of-precipice, nazareth/old-city. smoke.spec.ts + a11y.spec.ts +8 routes. 629 pages. 872/872 e2e pass. FR+DE Nazareth attractions 4/4 COMPLETE. fr pages: ~132/~158. de pages: ~132/~158.
