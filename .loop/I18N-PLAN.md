...
- Current phase: **Phase 4 BATCH 4 DONE (iter352, SHA e1a65c0)**: 6 Galilee attractions × FR+DE (12 locale pages): galilee/capernaum, galilee/magdala, galilee/mount-of-beatitudes, galilee/mount-arbel, galilee/tiberias, galilee/yardenit. religiousSiteId preserved on capernaum/mount-of-beatitudes/yardenit (FR+DE). YAML typographic-quote bug fixed in de/galilee-magdala + de/galilee-mount-of-beatitudes (U+201E „…" closings must use U+201C not ASCII U+0022). smoke.spec.ts + a11y.spec.ts +12 routes. 549 pages. 726/726 e2e pass. Next: Phase 4 Batch 5 — remaining EN attractions not yet in FR+DE. Survey src/content/attractions/en/ vs fr/ to find next batch. Defer holy-sepulchre + temple-mount to dedicated paired-naming iteration.
