...
- Current phase: **Phase 4 BATCH 6 DONE (iter368, SHA 523dea6)**: 5 Golan attractions × FR+DE (10 locale pages): golan/banias, golan/druze-villages, golan/mount-bental, golan/mount-hermon, golan/nimrod-fortress. Also: EN golan-nimrod-fortress.md Rule 1 fix (Crusader→Ayyubid). smoke.spec.ts + a11y.spec.ts +10 routes. 577 pages. 772/772 e2e pass. FR+DE Golan attractions 5/5 COMPLETE. Next: Phase 4 Batch 7 — survey remaining ~26 EN attractions not yet in FR+DE; defer holy-sepulchre + temple-mount; likely start with Dead Sea or Negev region cluster.
