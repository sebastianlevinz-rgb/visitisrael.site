...
- Current phase: **Phase 2 BATCH 3 DONE (iter 52, SHA 989f751)**: day-trips-from-jerusalem + day-trips-from-tel-aviv + is-israel-safe shipped in fr+de. Locale-correct cross-links: fr/de day-trips pages link to each other; is-israel-safe links to fr/de first-time-in-israel. Hreflang alternates on all 3 new EN guides (auto-computed by [...slug].astro). fr 10/147, de 10/147 (home + plan-your-trip + 8 guides each). CI in_progress run 28095871662 at state-write time. Next batch: shabbat-guide, best-tours-in-israel, border-crossings, or car-rental-israel (TBD by next i18n BUILD slot — may skip 1-2 BUILD iters per rotation balance).
