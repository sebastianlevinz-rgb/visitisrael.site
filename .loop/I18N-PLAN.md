...
- Current phase: **Phase 2 BATCH 10 DONE (iter 128, SHA 367c608)**: christian-pilgrimage-holy-land + israel-national-parks-pass + driving-in-israel shipped in fr+de (6 new locale pages). Honesty framing for Qasr al-Yahud ("traditionnellement identifié comme" / "traditionell als Taufstätte geltende Ort"); paired naming for Holy Sepulchre/Western Wall/Temple Mount in all locales. Affiliate CTAs (discovercars/rentalcars) translated in driving guide. fr 30/~147, de 30/~147 (home + plan-your-trip + 28 guides each). 254 pages built. Next batch candidates: jordan-river-baptism fr/de, ben-gurion-airport-guide fr/de, solo-female-travel-israel fr/de, israel-for-seniors fr/de, kosher-food-guide fr/de (already done earlier batches — check), water-hiking-israel fr/de.
