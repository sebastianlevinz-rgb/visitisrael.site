...
- Current phase: **Phase 4 BATCH 7 DONE (iter373, SHA c212fa5)**: 5 Akko attractions × FR+DE (10 locale pages): akko/bahai-mansion (religiousSiteId preserved), akko/hospitaller-knights, akko/khan-al-umdan (DE YAML quote bug fixed — FAQ reworded), akko/old-city, akko/templar-tunnel. smoke.spec.ts + a11y.spec.ts +10 routes. 589 pages. 796/796 e2e pass. FR+DE Akko attractions 5/5 COMPLETE. fr pages: ~100/~158. de pages: ~100/~158. Next: Phase 4 Batch 8 — remaining 21 EN attractions: Caesarea (4), Dead Sea (3 remaining: ein-gedi/mineral-beach/qumran), Eilat (5), Nazareth (4), Negev (5) + 2 deferred (holy-sepulchre/temple-mount). Likely start with Caesarea (4) as natural cluster.
