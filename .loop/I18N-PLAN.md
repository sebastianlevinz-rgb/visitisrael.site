...
- Current phase: **Phase 2 BATCH 18 IN PROGRESS (iter 177, SHA c7674a6)**: tiberias-guide + masada-tours-compared + galilee-tours-compared + jerusalem-tours-compared (iter166) + jerusalem-food-guide + day-trips-from-haifa (iter167) + petra-from-israel + dead-sea-israel-vs-jordan + tel-aviv-to-jerusalem (iter168) + ben-gurion-airport-transfers + rav-kav-israel + israel-esim + tel-aviv-light-rail (iter172) + eilat-tours-compared + tel-aviv-tours-compared + eilat-diving-snorkeling (iter177) shipped in fr+de (32 locale pages total batch 18). smoke.spec.ts +6 routes (iter177). fr 72/~147, de 72/~147 (home + plan-your-trip + 70 guides each). 353 pages built. Remaining batch 18 (10 EN guides untranslated): cruise-shore-excursions-israel, israel-base-city-guide, israel-evening-activities, israel-tour-packages, israel-travel-apps, israel-wine-wineries, israel-zimmer-guide, petra-from-eilat-vs-amman, petra-tours-compared, private-tours-israel. Also new: 1-day-jerusalem-itinerary (iter176) needs FR+DE. Next pick: 3-4 guides from remaining list.
...
- fr pages shipped: 69 / ~147 (home + plan-your-trip + 67 guides) · de pages shipped: 69 / ~147 (same)
