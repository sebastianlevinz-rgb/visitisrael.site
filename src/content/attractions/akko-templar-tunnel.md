---
lang: en
title: 'Templar Tunnel Akko: 12th-Century Secret Crusader Passage'
description: "Walk Akko's 350-metre Templar Tunnel — the rediscovered 12th-century underground passage from the Templar citadel to the harbour, lit and open to visitors."
slug: akko-templar-tunnel
region: akko
parentRegion: akko
heroImage: /images/sub-destinations/akko/templar-tunnel.jpg
primaryKeyword: templar tunnel akko
secondaryKeywords:
  - templar tunnel acre
  - knights templar akko
  - crusader tunnel akko
  - akko underground passage
  - templar citadel acre
latitude: 32.9215
longitude: 35.0689
...
faqs:
  ...
  - question: How long does the tunnel walk take?
    answer: The tunnel is 350 metres end-to-end. Walking the full length on the wooden walkway with periodic informational stops takes about 15 minutes one-way, 25 minutes if you take time to read the panels and let your eyes adjust to the lighting. The walkway is single-direction at peak times to keep visitor flow moving; you exit at the harbour-side end and return via the surface streets.
  - question: Who were the Knights Templar?
    answer: The Knights Templar — formally the Poor Fellow-Soldiers of Christ and of the Temple of Solomon — were a medieval Christian military order founded around 1119 in Jerusalem on the Temple Mount / Haram al-Sharif. They became one of the two great Crusader military orders (alongside the Hospitallers) and were the militant, banking and elite military specialists; their Akko citadel at the western seaward extremity was a fortified compound separate from the Hospitaller infirmary halls beneath the modern Old City. The Templar Order was suppressed in 1312 by Pope Clement V under pressure from King Philip IV of France; the suppression dramatically shaped European medieval politics.
  - question: How was the tunnel rediscovered in 1994?
    answer: A routine sewage-system survey for the modern Old City accidentally broke through into a previously unmapped underground space. Israel Antiquities Authority excavation through 1995-1999 cleared the full 350-metre length, established that the tunnel was a Templar Order construction connecting their citadel to the harbour, and built the wooden walkway for safe visitor access. The 1994 discovery date is why the Templar Tunnel is the most recent UNESCO 2001 inscription element — it wasn't even known to exist when the original Akko Old City inscription nomination was being drafted.
  - question: Is the tunnel claustrophobic?
    answer: The tunnel is approximately 2.5 metres high and 2 metres wide throughout most of its length, with periodic widening at curved sections. Lighting is warm directional LED along the wooden walkway. Air circulation is good (the harbour-side opening provides natural draft). Most visitors find the walk atmospheric rather than claustrophobic. Visitors with severe claustrophobia should consider the Hospitaller Halls visit instead, which has open vaulted spaces.
---
