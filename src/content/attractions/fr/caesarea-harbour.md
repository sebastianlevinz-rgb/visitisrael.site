...
faqs:
  - question: "Qu'est-ce que le port de Césarée Maritima ?"
    answer: "Le port de Césarée Maritima était le port artificiel en eaux profondes construit par Hérode le Grand entre 22 et 10 av. J.-C. Appelé Sébaste dans l'Antiquité (latin pour « Auguste »), c'était le plus grand port de la Méditerranée orientale pendant plusieurs siècles et le point d'exportation des expéditions de grain vers Rome."
  - question: "Pourquoi le port est-il partiellement submergé aujourd'hui ?"
    answer: "Le niveau de la mer a légèrement monté sur deux millénaires, mais le facteur dominant est la subsidence sismique — des séismes aux IIe et VIe siècles apr. J.-C. ont fait s'enfoncer les brise-lames de plusieurs mètres dans le fond marin. Le port n'était plus utilisable au VIIIe siècle. La plupart des structures submergées se trouvent à 1 à 4 mètres de profondeur et sont visibles depuis la surface."
  - question: "Peut-on plonger avec masque dans les ruines sous-marines ?"
    answer: "Oui, de manière saisonnière. Le parc archéologique sous-marin fonctionne en été et début d'automne lorsque les conditions marines le permettent. Réservez au centre d'accueil le jour même ; apportez votre propre masque et palmes si possible. Les structures submergées (blocs de brise-lames, fondations du mur du port, pierres d'ancrage) se trouvent dans des eaux peu profondes accessibles à des plongeurs débutants."
  - question: "En quoi consiste le spectacle multimédia Time Trek ?"
    answer: "Le Time Trek est une promenade de 20 minutes à l'intérieur de la section du port ceinte de murs croisés — la projection sur les murs restitue l'aspect du port à l'époque hérodienne, byzantine et croisée sur le même espace archéologique. Inclus dans le billet combiné du Parc national (~₪50 adulte)."
  - question: "Comment Hérode a-t-il construit le port sans cale sèche ?"
    answer: "Les ingénieurs d'Hérode (qui travaillèrent entre 22 et 10 av. J.-C.) utilisèrent une formulation de béton hydraulique romain contenant des cendres volcaniques importées de la baie de Naples — la pouzzolane — qui durcit sous l'eau. Ils construisirent des caissons en bois flottés en position, y coulèrent le béton et le laissèrent prendre sur le fond marin. La même technique fut utilisée à Pouzzoles (Naples) et à Ostie, le port de Rome."
---
