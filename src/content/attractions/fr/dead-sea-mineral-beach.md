...
faqs:
  - question: "La Mineral Beach est-elle encore ouverte ?"
    answer: "La concession originale de Mineral Beach a fermé en 2015 après des dommages causés par des effondrements de terrain qui ont nécessité une longue rénovation. Le concept — une plage journée payante avec des stations de boue et des douches d'eau douce — est désormais proposé sur plusieurs sites alternatifs le long de la rive occidentale, notamment la plage de Kalia (nord), la plage publique d'Ein Bokek (sud) et la plage publique d'Ein Gedi."
  - question: "Combien coûte une journée à la plage minérale ?"
    answer: "L'entrée journée dans les plages publiques actives est généralement de 60 à 100 NIS par adulte et comprend le parking, les douches, les stations d'application de boue, la surveillance des maîtres-nageurs et l'accès à un espace ombragé. Les serviettes et les casiers sont habituellement en supplément. Les plages des hôtels d'Ein Bokek sont gratuites pour les clients mais facturent un forfait journée aux visiteurs extérieurs."
  - question: "Quelle est la meilleure plage pour un premier bain flottant ?"
    answer: "La plage publique d'Ein Bokek est l'option la plus aménagée — entrée dans l'eau plane et large, maîtres-nageurs, stations de boue et accès à pied depuis les hôtels d'Ein Bokek. La plage de Kalia (rive nord, gérée par le kibboutz Kalia) a une atmosphère plus naturelle avec une boutique Ahava et un accès facile à la boue. Les deux conviennent très bien pour une première visite."
  - question: "L'eau est-elle sans danger pour les non-nageurs ?"
    answer: "Oui. La densité de sel rend le naufrage impossible — le lac est l'une des expériences de baignade en eaux libres les plus sûres pour les non-nageurs. Les principales précautions sont la protection des yeux (la haute teneur en minéraux pique au contact) et ne pas mettre la tête sous l'eau."
  - question: "Quand les plages publiques sont-elles ouvertes ?"
    answer: "La plupart des plages publiques ouvrent vers 8 h et ferment au coucher du soleil. Les maîtres-nageurs sont de service pendant les horaires affichés (généralement de 9 h à 17 h en été, moins en hiver). La baignade en dehors des heures surveillées est déconseillée car le sel complique les opérations de secours en cas de glissade."
---
