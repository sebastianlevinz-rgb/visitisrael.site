...
ticketInfo:
  priceRange: "~₪60 / ~16 $ adulte (visite de jour) ; Night Spectacular ~₪60–70 séparé"
  bookingRequired: true
  tipText: "Le spectacle nocturne Night Spectacular affiche régulièrement complet — réservez à l'avance sur le site de la Tour de David. Les billets combinés jour + soirée offrent une légère économie. L'entrée de jour est accessible sans réservation préalable, mais réserver en ligne évite la queue à la Porte de Jaffa."
  tiqetsQuery: "Tower of David Jerusalem"
  gygTicketsQuery: "Tower of David Museum Jerusalem"
faqs:
  - question: "Qu'est-ce que la Tour de David ?"
    answer: "La Tour de David est une citadelle médiévale située juste à l'intérieur de la Porte de Jaffa, construite et reconstruite au fil de deux millénaires sur des fortifications remontant aux périodes hasmonéenne et hérodienne. Malgré son nom, elle n'a aucun lien direct avec le roi David ; elle abrite aujourd'hui le Musée de la Tour de David, qui retrace l'histoire de Jérusalem sur 4 000 ans."
  - question: "Quel est le prix d'entrée de la Tour de David ?"
    answer: "Un billet adulte pour la visite de jour est d'environ ₪60 (soit environ 16 $), avec des tarifs réduits pour les enfants, étudiants et seniors. Le spectacle nocturne (Night Spectacular) est facturé séparément, environ ₪60–70, et les billets combinés jour + soirée permettent une légère économie. La réservation en ligne est recommandée, car le spectacle nocturne affiche souvent complet."
  - question: "La Tour de David Museum vaut-elle la visite ?"
    answer: "Oui, surtout comme point d'orientation en début de séjour à Jérusalem. Le musée rénové présente l'histoire de la ville de manière claire, la cour archéologique est atmosphérique, et le chemin de ronde offre certaines des meilleures vues panoramiques sur les villes ancienne et moderne. Comptez environ deux heures."
  - question: "En quoi consiste le spectacle nocturne de la Tour de David ?"
    answer: "Le Night Spectacular est un spectacle son et lumière qui projette l'histoire de Jérusalem sur les anciennes murailles de la citadelle après la tombée de la nuit. Il dure environ 45 minutes, se déroule certains soirs (le plus souvent du lundi au jeudi et le samedi, selon les conditions météorologiques), et est facturé séparément de l'entrée de jour ; réservez à l'avance, car les représentations affichent complet."
---
...
- **Les galeries d'histoire** — un voyage chronologique à travers 4 000 ans de Jérusalem, de la ville cananéenne à l'ère moderne, illustré par des maquettes, des artefacts et des dispositifs multimédias immersifs. Un excellent préambule avant d'explorer le reste de la [Vieille Ville](/jerusalem/old-city).
...
- **Le chemin de ronde** — grimpez les tours et les remparts pour des **panoramas à 360°** : les toits de la Vieille Ville, le [Dôme du Rocher](/jerusalem/temple-mount) doré, le mont des Oliviers et, dans l'autre sens, la Jérusalem-Ouest moderne. C'est le point fort photographique.
...
- **Combinez avec la Porte de Jaffa**, le [Quartier chrétien](/jerusalem/holy-sepulchre) et le début de la [Via Dolorosa](/jerusalem/via-dolorosa) — tout est à quelques pas — et terminez la journée avec le spectacle nocturne.
