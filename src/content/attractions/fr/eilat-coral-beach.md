...
faqs:
  - question: "Où se trouve la réserve naturelle de Coral Beach à Eilat ?"
    answer: "Coral Beach est située sur le littoral sud d'Eilat, à environ 6 km au sud du centre-ville. Suivez la route 90 jusqu'au carrefour de Coral Beach, ou prenez le bus local (ligne 15) depuis le centre d'Eilat. Un parking payant est disponible à l'entrée de la réserve."
  - question: "Quel est le tarif d'entrée à la réserve de Coral Beach ?"
    answer: "L'entrée coûte environ 35 ILS pour les adultes et 21 ILS pour les enfants (tarifs 2026) ; le pass annuel des parcs nationaux d'Israël donne accès gratuitement. La location de matériel de snorkeling à l'entrée est d'environ 25 ILS (masque, tuba et palmes). La réserve est ouverte tous les jours, y compris le shabbat."
  - question: "Le snorkeling à Coral Beach convient-il aux débutants ?"
    answer: "Oui. La réserve dispose d'un couloir de nage balisé qui mène directement depuis la jetée en bois vers le plateau récifal. L'eau est généralement calme ; le parcours est court (200 à 400 mètres le long de l'itinéraire balisé). Des maîtres-nageurs surveillent la zone d'entrée pendant les heures d'ouverture."
  - question: "Quelle est la règle concernant la crème solaire sans danger pour les récifs ?"
    answer: "La réserve naturelle de Coral Beach impose l'utilisation de crèmes solaires sans danger pour les récifs afin de protéger les coraux de l'oxybenzone, de l'octinoxate et des filtres UV chimiques similaires. Les rangers vérifient à l'entrée et vendent des crèmes solaires conformes si vous arrivez avec un produit non autorisé."
  - question: "Peut-on plonger à Coral Beach ?"
    answer: "Oui. La réserve autorise la plongée sous-marine avec un brevet Open Water en cours de validité ; des centres de plongée sont installés juste à côté de l'entrée. Les deux principaux sites de plongée dans la réserve sont les récifs nord et sud ; des sites avancés, dont les Jardins Japonais, se trouvent un peu plus au sud."
---
