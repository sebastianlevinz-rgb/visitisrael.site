---
lang: en
title: 'Avdat: Nabataean UNESCO Spice Route Site in the Negev'
description: 'Visit Avdat — the UNESCO Nabataean archaeological city on the Incense Route in the Negev; acropolis, Byzantine churches, terraced agriculture and tour bookings.'
slug: negev-avdat
region: negev
parentRegion: negev
heroImage: /images/sub-destinations/negev/avdat.jpg
primaryKeyword: avdat
secondaryKeywords:
  - avdat national park
  - nabataean spice route
  - negev unesco
  - avdat archaeological site
latitude: 30.7942
longitude: 34.7728
...
faqs:
  ...
  - question: Why is Avdat a UNESCO World Heritage Site?
    answer: Avdat is one of four sites in the Incense Route — Desert Cities of the Negev inscription added to the UNESCO World Heritage List in 2005. The Nabataeans pioneered runoff-water agriculture in the Negev's arid landscape — terraced check-dams, cisterns and irrigation channels — that supported substantial urban populations along the trading network. Avdat is the best preserved of the four.
  - question: How long does a visit to Avdat take?
    answer: Allow about one and a half to two hours for the main loop. The acropolis and the two Byzantine churches sit on a low plateau accessed by a paved road; the residential areas, baths and necropolis extend below. The interpretive material covers the Nabataean trade network and the agricultural innovation that made desert urban life possible.
  - question: Are there tours of Avdat from Tel Aviv?
    answer: Yes — Avdat is included in most Negev day tours from Tel Aviv (typically combined with Sde Boker and Mitzpe Ramon). Some operators run dedicated Nabataean-Incense-Route itineraries that include Avdat alongside the other Negev UNESCO sites (Mamshit, Shivta and Haluza). Self-drive visitors can park at the visitor centre and walk the marked loop unaided.
---
