...
faqs:
  - question: "Was ist Avdat?"
    answer: "Avdat ist eine nabatäische Archäologiestadt im zentralen Negev, ursprünglich um das zweite Jahrhundert v. Chr. als Karawanenhaltepunkt an der Weihrauchstraße zwischen der Arabischen Halbinsel und den Mittelmeerhäfen erbaut. Sie entwickelte sich später zu einem bedeutenden römisch-byzantinischen Stadtzentrum mit Terrassenlandwirtschaft, einer Akropolis und zwei Kirchen. Die Stätte wird als archäologischer Komplex präsentiert, nicht als aktive Kultstätte."
  - question: "Warum ist Avdat UNESCO-Welterbe?"
    answer: "Avdat ist eine von vier Stätten der 2005 in die UNESCO-Welterbeliste aufgenommenen Weihrauchstraße — Wüstenstädte im Negev. Die Nabatäer entwickelten im Negev eine Ablaufwasserlandwirtschaft — Terrassendämme, Zisternen und Bewässerungskanäle — die beträchtliche Stadtbevölkerungen entlang des Handelsnetzes in einer Landschaft mit weniger als hundert Millimeter Jahresniederschlag versorgte. Avdat ist die besterhaltene der vier Stätten."
  - question: "Wie lange dauert ein Besuch in Avdat?"
    answer: "Planen Sie etwa eineinhalb bis zwei Stunden für die Hauptrundstrecke ein. Eine asphaltierte Straße führt zum Parkplatz der Akropolis hinauf; der markierte Weg führt an den beiden byzantinischen Kirchen, dem römischen Viertel vorbei und hinunter durch das Wohnviertel zu den Bädern und der Weinpresse. Ein separater Pfad führt zu den Landwirtschaftsterrassen im Zin-Tal darunter."
  - question: "Gibt es Touren nach Avdat von Tel Aviv?"
    answer: "Ja — Avdat ist in den meisten Negev-Tagestouren von Tel Aviv enthalten (typischerweise kombiniert mit Sde Boker und Mitzpe Ramon). Einige Veranstalter bieten spezielle Nabatäisch-Weihrauchstraßen-Routen an, die Avdat zusammen mit den anderen Negev-UNESCO-Stätten (Mamshit, Shivta und Haluza) umfassen. Selbstfahrer können am Besucherzentrum parken und die markierte Runde eigenständig absolvieren."
---
