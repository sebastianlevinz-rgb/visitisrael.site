...
faqs:
  - question: "Was bedeutet der Name Khan al-Umdan?"
    answer: "Das Wort Khan ist das arabische und osmanisch-türkische Wort für eine Karawanserei — ein Gasthaus und Handelsposten, der landgebundene Handelskarawanen beherbergte. Al-Umdan bedeutet der Säulen auf Arabisch. Khan al-Umdan ist daher wörtlich die Herberge der Säulen — benannt nach den vierzig Granitsäulen, die die Galerien des oberen Hofes tragen. Viele dieser Granitsäulen wurden aus den römischen Ruinen in Caesarea (45 Minuten südlich von Akko) geborgen, als der Khan 1785 erbaut wurde."
  - question: "Wer hat Khan al-Umdan gebaut und wann?"
    answer: "Khan al-Umdan wurde 1785 von Ahmed Pascha al-Dschazzar — bekannt als Ahmed dem Schlächter — erbaut, dem osmanischen Gouverneur der Provinz Sidon Eyalet, der Akko zu seiner Hauptstadt machte. Al-Dschazzars Wiederaufbauprogramm rekonstruierte die Altstadtmauern (was Napoleons Belagerung von 1799 abwehrte) und etablierte Akko als bedeutendes osmanisches Handels- und Verwaltungszentrum der Galilää-Region. Der Khan war der kommerzielle Anker dieses Programms — Karawanen aus Damaskus kamen auf dem Landweg an, handelten ihre Waren und reisten zur nächsten Etappe weiter."
  - question: "Warum gibt es einen Uhrturm beim Khan?"
    answer: "Der Uhrturm wurde 1906 von Sultan Abdul Hamid II. des Osmanischen Reiches im Rahmen seines Programms zur Errichtung modernisierender Uhrtürme in osmanischen Städten hinzugefügt. Mehrere ähnliche Abdul-Hamid-Uhrtürme stehen in anderen orientalischen Städten der Osmanenzeit (Istanbul, Damaskus, Kairo). Der Akko-Uhrturm ist als Teil der UNESCO-Inschrift von 2001 erhalten und ist das fotogenste einzelne Altstadtdenkmal, wenn es vom zentralen Hof aus gesehen wird."
  - question: "Kann man den Khan al-Umdan betreten?"
    answer: "Der Erdgeschoss-Innenhof ist kostenlos begehbar — Sie können zwischen den Säulen schlendern und das Ausmaß der Handelsfläche aufnehmen. Die oberen Galerien beherbergen gelegentlich Ausstellungen (Volkskunst, Archäologie, osmanisches Erbe) und sind zugänglich, wenn eine Ausstellung läuft. Am Khan wird laufend restauriert; einige Galerieabschnitte im Obergeschoss können geschlossen sein."
  - question: "Welchen Zusammenhang hat der Khan mit dem Hamam al-Pasha?"
    answer: "Khan al-Umdan und Hamam al-Pasha (Türkisches Bad) sind zwei Teile desselben städtischen Programms von Ahmed Pascha al-Dschazzar ab 1785. Der Khan war das kommerzielle Handelshaus; der Hamam war die öffentliche Badeanlage für Bewohner und durchreisende Kaufleute. Die beiden liegen 50 Meter voneinander entfernt in der Altstadt, und das Standard-Kombiticket deckt den Hamam-Museumsbesuch neben den Hospitaliter-Sälen und dem Templergang."
---
