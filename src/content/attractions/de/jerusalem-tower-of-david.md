...
ticketInfo:
  priceRange: "~₪60 / ~16 $ Erwachsene (Tageskarte); Night Spectacular ~₪60–70 separat"
  bookingRequired: true
  tipText: "Das Night Spectacular ist regelmäßig ausverkauft — im Voraus auf der Website des Davidsturms buchen. Kombinierte Tages- und Abendtickets bieten eine kleine Ersparnis. Der Tageseinlass ist ohne Vorausbuchung möglich, aber Online-Buchung spart das Warten am Jaffator."
  tiqetsQuery: "Tower of David Jerusalem"
  gygTicketsQuery: "Tower of David Museum Jerusalem"
faqs:
  - question: "Was ist der Davidsturm?"
    answer: "Der Davidsturm ist eine mittelalterliche Zitadelle direkt innerhalb des Jaffattors, die über zwei Jahrtausende auf Befestigungen aus der hasmonäischen und herodianischen Zeit errichtet und immer wieder umgebaut wurde. Trotz des Namens besteht kein direkter Bezug zu König David; heute beherbergt die Anlage das Davidsturm-Museum, das die Geschichte Jerusalems über 4.000 Jahre darstellt."
  - question: "Was kostet der Eintritt in den Davidsturm?"
    answer: "Eine Tageskarte für Erwachsene kostet ca. ₪60 (etwa 16 $), mit ermäßigten Preisen für Kinder, Studierende und Senioren. Das abendliche Licht-und-Ton-Spektakel (Night Spectacular) wird separat zu ca. ₪60–70 berechnet; kombinierte Tages- und Abendtickets bieten eine kleine Ersparnis. Online-Buchung wird empfohlen, da das Nachtprogramm oft ausverkauft ist."
  - question: "Lohnt sich ein Besuch des Davidsturm-Museums?"
    answer: "Ja, besonders als Orientierung zu Beginn eines Jerusalemaufenthalts. Das renovierte Museum vermittelt die Stadtgeschichte klar und anschaulich, der archäologische Hof ist atmosphärisch, und der Wehrgang bietet einige der besten Panoramablicke über die Alt- und Neustadt. Zwei Stunden einplanen."
  - question: "Was ist das Night Spectacular?"
    answer: "Das Night Spectacular ist ein Licht-und-Ton-Spektakel, das die Geschichte Jerusalems nach Einbruch der Dunkelheit auf die Mauern der antiken Zitadelle projiziert. Es dauert etwa 45 Minuten, findet an ausgewählten Abenden statt (meistens Montag bis Donnerstag und Samstag, wetterabhängig) und wird separat von der Tageskarte abgerechnet; frühzeitig buchen, da die Vorstellungen ausverkaufen."
---
...
- **Die Geschichtsgalerien** — eine chronologische Reise durch 4.000 Jahre Jerusalem, von der kanaanäischen Stadt bis in die Moderne, dargestellt mit Modellen, Artefakten und immersiven Multimedia-Installationen. Eine hervorragende Einführung vor der Erkundung der [Altstadt](/jerusalem/old-city).
...
- **Der Wehrgang** — besteigen Sie die Türme und Mauern für **360-Grad-Panoramen**: die Altstadt-Dächer, die goldene [Felsendom](/jerusalem/temple-mount), den Ölberg und in die andere Richtung das moderne West-Jerusalem. Dies ist das fotografische Highlight.
...
- **Mit dem Jaffator kombinieren**, dem [Christlichen Viertel](/jerusalem/holy-sepulchre) und dem Beginn der [Via Dolorosa](/jerusalem/via-dolorosa) — alles nur wenige Gehminuten entfernt — und den Tag mit dem Nachtspektakel abschließen.
