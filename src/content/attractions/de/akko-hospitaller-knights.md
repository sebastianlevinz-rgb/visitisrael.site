...
faqs:
  - question: "Wer waren die Ritter Hospitaliter?"
    answer: "Die Ritter Hospitaliter — offiziell die Ritter des Ordens des Heiligen Johannes von Jerusalem — waren ein mittelalterlicher christlicher Militär-Medizin-Orden, der um 1099 in Jerusalem gegründet wurde, um kranke und verletzte Pilger zu pflegen. Sie wurden zu einem der zwei großen Kreuzfahrer-Militärorden (neben den Templern) und waren die medizinischen Spezialisten; ihre Krankenstation in Akko konnte etwa zweitausend Patienten aufnehmen — das größte Krankenhaus im mittelalterlichen Mittelmeer. Als Jerusalem 1187 an Saladin fiel, verlegten sie ihr Hauptquartier nach Akko und hielten die Stadt bis zur Mamlukenzerstörung 1291."
  - question: "Wie lange dauert der Besuch der Hospitaliter-Säle?"
    answer: "Ein selbstgeführter Audiostreckenrundgang dauert 90 Minuten; eine Führung mit einem israelischen Lizenzführer fügt 30 Minuten historischen Kontext hinzu. Die Säle sind verbunden — Refektorium, Säulenkrypta, gewölbte Krankenstation-Säle, Gefängniszellen, Innenhof und Multimedia-Projektionsraum — und die Route ist eine einzige Schleife ohne Umkehren. Die meisten Besucher sind in zwei Stunden einschließlich des Audioführers fertig."
  - question: "Wie wurden die Säle erhalten?"
    answer: "Die Mamlukenzerstörung von 1291 war auf Straßenniveau gründlich, versiegelte aber die unterirdischen Säle intakt. Die Osmanen bauten ihre Stadt des 18. Jahrhunderts direkt auf den Trümmern, und die Kreuzfahrer-Säle wurden vier Jahrhunderte vergessen. Die Untersuchung der israelischen Altertumsbehörde aus den 1950er Jahren entdeckte die Krankenstation wieder; die ernsthafte Restaurierung beschleunigte sich in den 1990er Jahren, als die Multimedia-Projektionsanlagen hinzugefügt wurden. Die Säle bleiben eine aktive archäologische Stätte — die meisten Oberflächen sind original aus dem 12. Jahrhundert, mit deutlich gekennzeichneten Restaurierungsmarkierungen."
  - question: "Sind die Säle für Besucher mit eingeschränkter Mobilität zugänglich?"
    answer: "Das untere Niveau (Refektorium und Säulenkrypta) hat einen teilweise barrierefreien Weg. Die oberen Krankenstation-Säle und Gefängniszellen erfordern das Navigieren von zwei mittelalterlichen Treppen. Wenden Sie sich vor Ihrem Besuch an das Besucherzentrum der Altstadt Akko für aktuelle Barrierefreiheitsinformationen."
  - question: "Kann ich in den Sälen fotografieren?"
    answer: "Ja, persönliche Fotografie ist überall in den Sälen erlaubt. Stative sind auf den größeren Strecken erlaubt, aber nicht in den engen Treppenpassagen oder den Gefängniszellen. Blitzfotografie ist erlaubt, aber selten nötig — die Multimedia-Projektionsanlagen umfassen warmes Richtungslicht, das Handhaltefotografie bei moderatem ISO gut ermöglicht. Kommerzielle Fotografie erfordert eine Vorabgenehmigung der israelischen Altertumsbehörde."
---
