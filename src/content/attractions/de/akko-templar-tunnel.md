...
| | |
|---|---|
| **Eintritt** | Eintrittspflichtig; im **Altstadtkombiticket** enthalten (Hospitaliter-Säle + Templergang + Hamam al-Pasha + Unterirdisches Gefängnismuseum + Stadtmauern). Aktuelle Preise auf der offiziellen Website prüfen. |
...
| **Anreise** | In der Altstadt Akko; Eingang am hafenseitigen Ende (Süden), über eine einzelne Treppe vom Straßenniveau erreichbar. Akko ist ~30 Min. von Haifa. |
| **Beste Zeit** | Der Tunnel bleibt ~18°C ganzjährig — eine kühle Route in der Sommerhitze. |
| **Barrierefreiheit** | Über Treppen vom Straßenniveau erreichbar; der Holzsteg ist ansonsten eben. Gang ~2,5 m hoch und ~2 m breit. Nicht stufenfrei; Personen mit starker Klaustrophobie bevorzugen möglicherweise die offenen Hospitaliter-Säle. |
...
- **Diskrete Logistik** — Vorräte, militärische Mittel und Personal konnten sich zwischen der Burg und den Hafenschiffen unbeobachtet von potentiellen Beobachtern bewegen.
- **Notfall-Evakuierung** — wenn die Burg direkt belagert wurde, bot der Tunnel einen Rückzugsweg zu Schiffen im Hafen.
- **Handelsgeheimhaltung** — die Templer betrieben ein erhebliches Bankgeschäft; wertvolle Frachtbewegungen (Goldreserven, versiegelte Dokumente) konnten ohne öffentliche Beobachtung durchgeführt werden.
- **Klima** — der Tunnel bleibt ganzjährig etwa 18 Grad; das machte ihn unabhängig von Geheimhaltung zur natürlichen Route in der Sommerhitze.
