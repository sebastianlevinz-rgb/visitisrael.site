...
faqs:
  - question: Is one week enough for Israel?
    answer: 'Yes — seven days is the classic first-visit length. It comfortably covers Jerusalem, the Dead Sea and Tel Aviv, with a full day for the Galilee or the coast. To add Eilat and the Negev in the south, stretch to ten days. Mid-range travellers should budget roughly $1,200–2,100 per person for the week excluding airfare.'
  - question: Should I base myself in one place or move around?
    answer: 'For this route, split your stay — three nights in Jerusalem and three nights in Tel Aviv, with day trips from each. The two cities are only about 45 minutes apart by train, so you don''t need many bases. You can do the whole week without a rental car if you take guided day trips for the Dead Sea and the north.'
  - question: Do I need a rental car for a 7-day Israel trip?
    answer: 'No. Trains link the airport, Jerusalem and Tel Aviv, and guided tours cover the Dead Sea and the Galilee/coast days where public transport is weak. If you prefer to self-drive the Day 6 northern loop, a one-day rental runs about ₪180–280 ($50–80) plus fuel and tolls; otherwise a guided day tour is $70–120.'
...
**Airport transfers.** The **Yitzhak Navon high-speed train** runs Ben Gurion → Jerusalem in ~30 min (**₪18 / ~$5**), and Ben Gurion → Tel Aviv in ~20 min (₪18), roughly every 30 minutes Sunday–Thursday, pausing for Shabbat. Buy a **Rav-Kav** card (₪5) or tap with the Hopon/Moovit app. During Shabbat, a *sherut* or private taxi runs ₪250–320 ($70–90).

**Where to stay.** **Jerusalem:** Mamilla or the city centre for walkability to the Old City. **Tel Aviv:** the beach strip for sea access, or Rothschild/Florentin for food and nightlife. Mid-range hotels run ₪450–800 ($130–220) a night; hostel dorms ₪110–160 ($30–45). Book early around Jewish and Christian holidays.

**Getting around in week.** Within cities, walk, ride the Jerusalem light rail (₪6/ride) or Tel Aviv buses, or use Gett/Yango (₪25–45 short hops). For the Dead Sea and northern days, take a guided tour or self-drive a one-day rental.
...
**Morning.** A final beach swim or a market breakfast.

**Midday.** Train from Tel Aviv back to **Ben Gurion** (20–25 min, ₪18). Be at the airport **three hours** before an international departure for security. **Stay:** Departure.

## What This 7-Day Trip Costs

Per person, excluding international airfare:

| Item | Budget | Mid-range |
| --- | --- | --- |
| Accommodation (6 nights) | $180–270 | $780–1,320 |
| Food (7 days) | $125–195 | $245–385 |
| Local transport (incl. airport) | $35–55 | $55–95 |
| Masada & Dead Sea tour | $95–120 | $95–120 |
| Galilee/coast day (tour or car) | $70–110 | $90–150 |
...
The FAQ entries above answer the most common questions about a one-week Israel trip — whether seven days is enough, whether to split bases, whether you need a car, and what it costs. The schema-driven FAQ block at the bottom of this page surfaces these to search engines so travellers find them directly from a Google result.
