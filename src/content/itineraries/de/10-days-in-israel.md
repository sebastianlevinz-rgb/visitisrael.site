...
faqs:
  - question: 'Reichen 10 Tage, um Israel zu sehen?'
    answer: 'Zehn Tage sind die ideale Dauer für einen gründlichen Erstbesuch. Das deckt Tel Aviv, die Nordküste, das Galiläa und den Golan, Jerusalem, das Tote Meer und den Süden — einschließlich Eilat und einem Petra-Tagesausflug — bequem ab, ohne sich gehetzt zu fühlen. Erwarten Sie rund 900–1.400 $ (kleines Budget) oder 2.000–3.400 $ (Mittelklasse) pro Person ohne internationales Flugticket.'
  - question: 'Brauche ich ein Auto für eine 10-tägige Israelreise?'
    answer: 'Ein Auto wird für die nördlichen Tage (Galiläa und Golan, wo die Sehenswürdigkeiten verstreut und der Busverkehr spärlich ist) dringend empfohlen, danach optional in den Städten. Viele Reisende mieten für die Tage 3 bis 5 (etwa ₪200–320 / 55–90 $ pro Tag plus Kraftstoff und Highway-6-Maut), geben es vor Jerusalem zurück und nutzen anderswo Züge und Touren.'
  - question: 'Wie kommt man von Jerusalem nach Eilat?'
    answer: 'Die schnellste Option ist ein Inlandsflug von Tel Aviv nach Eilat (Flughafen Ramon, ca. 1 Stunde, 50–110 $ einfache Fahrt) oder der Egged-Bus 444 von Jerusalem (ca. 4,5 Stunden, ₪70 / 20 $). Viele Reisende fliegen, um die lange Fahrt zu sparen, und nutzen Eilat dann als Basis für den Petra-Tagesausflug.'
...
**Auto für den Norden.** Holen Sie in Tel Aviv einen Mietwagen für die Tage 3–5 ab (₪200–320 / 55–90 $ pro Tag; im Voraus buchen). Sie benötigen ihn für das verstreute Galiläa und den Golan; vor Jerusalem zurückgeben, wo Parken ein Alptraum ist und die Straßenbahn das Zentrum abdeckt.
...
## Was dieser 10-Tage-Trip kostet

Pro Person, ohne internationales Flugticket:

| Posten | Kleines Budget | Mittelklasse |
| --- | --- | --- |
| Unterkunft (9 Nächte) | 270–405 $ | 1.170–1.980 $ |
| Mahlzeiten (10 Tage) | 180–280 $ | 350–560 $ |
| Lokaler Transport + Flughafen | 50–80 $ | 90–150 $ |
| Automiete 3 Tage (Norden) | 165–270 $ | 165–270 $ |
| Inlandsflug nach Eilat | 50–110 $ | 50–110 $ |
| Masada/Totes Meer Tour | 95–120 $ | 95–120 $ |
| Petra-Tagesausflug (1 Tag) | 200 $+ | 200 $+ |
| Führungen + Eintritte | 50–80 $ | 120–200 $ |
| **Gesamt** | **~1.060–1.345 $** | **~2.240–3.390 $** |

## Häufig gestellte Fragen

Die Antworten auf die häufigsten Fragen zu einer zehntägigen Israelreise finden Sie in den FAQs oben — ob zehn Tage ausreichen, ob ein Auto nötig ist, wie man nach Eilat kommt und welches Budget einzuplanen ist.
