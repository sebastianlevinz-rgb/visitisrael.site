...
verdictName: 'a Northern Golan Heights day tour including Nimrod Fortress'
verdictQuery: 'Nimrod Fortress Golan Heights tour Israel'
ctaHeading: 'Book Golan Heights tours and car hire'
affiliateCtas:
  - partner: getyourguide
    title: 'Golan Heights Day Tours from Tel Aviv & Tiberias'
    description: 'Guided Golan day tours from Tel Aviv and Tiberias typically combine Nimrod Fortress with Banias waterfall, Mount Bental, and a Druze village lunch. A good option if you prefer not to self-drive the Golan plateau.'
    image: /images/regions/golan/nimrod-fortress.jpg
    query: Golan Heights day tour Nimrod Fortress Banias Israel
    cta: Browse Golan day tours
  - partner: discovercars
    title: 'Rent a Car for the Golan Heights'
    description: 'There is no reliable public transport to Nimrod Fortress. A rental car picked up in Tiberias, Haifa, or Tel Aviv gives full flexibility to combine Nimrod, Banias, Tel Dan, and the Druze villages in one Golan circuit.'
    image: /images/regions/golan/hero.jpg
    query: car rental Israel Golan Heights northern Israel
    cta: Compare car hire
faqs:
  - question: Was Nimrod Fortress built by the Crusaders?
    answer: 'No — this is a common misconception that many tour sites perpetuate. Nimrod Fortress was built by the Ayyubid ruler Al-Aziz Muhammad in 1229 CE. The Ayyubids were the Muslim dynasty founded by Saladin that controlled the Levant after the Crusaders. The Crusaders built other fortresses in the region, but not this one. The castle was subsequently expanded and reinforced by the Mamluk sultan Baibars after 1260 CE — his Arabic inscription from 1275 CE is still visible near the western gate. The name "Nimrod" is a later popular appellation (derived from the biblical hunter Nimrod, son of Cush) and is not a historical name for the fortress.'
  - question: How do I get to Nimrod Fortress from Tiberias or Tel Aviv?
    answer: 'By car: from Tiberias, drive north on Highway 90 to Kiryat Shmona, then take Highway 99 east through Banias toward the Hermon foothills — the fortress is signposted off Route 989, roughly 55 km from Tiberias (about 1 hour). From Tel Aviv, allow 2.5–3 hours via Highways 2 and 90. There is no practical public transport to the fortress itself — local buses run to Kiryat Shmona but do not serve the Nimrod access road. A rental car or a guided Golan day trip (GetYourGuide/Viator) are the two realistic options.'
  - question: Is the Israel National Parks Pass valid at Nimrod Fortress?
    answer: 'Yes — Nimrod Fortress National Park is an INPA (Israel Nature and Parks Authority) site and is covered by both the Green and Brown INPA National Parks Pass. If you are visiting multiple Golan or northern Israel sites — Banias, Tel Dan, Gamla, Qazrin Archaeological Park — the pass pays for itself quickly. See our [Israel National Parks Pass guide](/israel-national-parks-pass) for current prices and how to purchase. The adult entry fee without a pass is approximately ₪22; verify current pricing at the park gate or parks.org.il.'
  - question: How long does it take to visit Nimrod Fortress?
    answer: 'Allow 1.5 to 2.5 hours for a thorough visit: around 20 minutes to walk from the car park to the main gatehouse, then a 1.5–2 hour circuit taking in the outer walls, the residential tower, the great hall, the keep, the secret staircase passage, and the southern panoramic viewpoint. If you want to read the information panels thoroughly and explore every accessible tower, budget the full 2.5 hours. The site is not small — the outer defensive perimeter runs to 420 metres and you are walking on uneven ancient stonework throughout.'
  - question: What can I combine with Nimrod Fortress on a Golan day trip?
    answer: 'The most natural same-day combination is Banias Nature Reserve (5 km southwest), which covers ancient Pan grotto ruins and a spectacular waterfall walk — allow 2 hours and keep your INPA pass for entry. Tel Dan Nature Reserve (15 km west, in the Galilee panhandle) adds another 1.5–2 hours for the ancient Canaanite gate and the Dan spring. A practical Golan North circuit: Nimrod Fortress AM → Banias early afternoon → coffee at Majdal Shams Druze village → Mount Bental viewpoint before sunset. With a rental car, this is a full but manageable day from Tiberias.'
---
...
**Mount Bental viewpoint**: 30 km south of Nimrod, Mount Bental's observation platform above the Syrian buffer zone is the Golan's most dramatic viewpoint and makes a logical sunset stop on the return south. See the [Golan Heights guide](/golan-heights-guide) for full coverage.
...
**Rental car**: there is no practical public transport to the fortress. A [rental car](/car-rental-israel) picked up in Tiberias, Haifa, or Tel Aviv is the recommended approach. The road to the fortress is paved and navigable in any standard car.
