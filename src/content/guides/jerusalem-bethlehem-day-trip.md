...
ctaHeading: 'Book the Jerusalem & Bethlehem day trip'
affiliateCtas:
  - partner: getyourguide
    title: 'Bethlehem Half-Day from Jerusalem'
    description: 'Cross to Bethlehem for the Church of the Nativity and Manger Square with a guide who handles the crossing.'
    image: /images/west-bank/bethlehem/church-of-the-nativity.jpg
    query: Bethlehem half day tour from Jerusalem
    cta: See this tour
  - partner: viator
    title: 'Jerusalem, Bethlehem & Jericho Full Day'
    description: 'A fuller day combining the Old City, Bethlehem and the desert oasis of Jericho.'
    image: /images/west-bank/bethlehem/manger-square.jpg
    query: Jerusalem Bethlehem Jericho tour
    cta: See this tour
  - partner: abraham
    title: 'Bethlehem & West Bank (Dual Narrative)'
    description: 'A small-group trip that pairs the Nativity sites with the everyday life and politics of the West Bank.'
    image: /images/west-bank/bethlehem/old-city.jpg
    query: Bethlehem West Bank tour
    cta: See this trip
faqs:
  - question: How much does the Jerusalem and Bethlehem day trip cost?
    answer: 'Tours run roughly $106–150 per person. Bethlehem-only half-day trips sit at the lower end; full days that add Jericho or the Jordan River cost more. The Church of the Nativity itself is free to enter, but guides, transport and any add-ons are what you are paying for.'
  - question: Is it safe to visit Bethlehem from Jerusalem?
    answer: 'Bethlehem is a normal tourist destination visited by large numbers of pilgrims, and the established day tours run routinely. The main practical issue is that Israeli rental cars are generally not insured to enter Area A of the West Bank, so most visitors go with a guide or a licensed local taxi rather than self-driving. Always check current government travel advice before you go.'
  - question: Do I need my passport to go to Bethlehem?
    answer: 'Yes — carry your physical passport. Bethlehem is in the West Bank (Area A, under Palestinian Authority control), and you pass through an Israeli checkpoint at the separation barrier. There is usually no formal stamp for tourists, but you must have your passport on you.'
  - question: How do you get from Jerusalem to Bethlehem?
    answer: 'It is only about 10 km, roughly 30 minutes. The easiest options are a guided tour or a licensed taxi that is permitted to cross; Arab bus 231 from Jerusalem also runs to the checkpoint. Israeli rental cars typically cannot enter, so self-driving is not the practical choice here.'
  - question: What can you see in Bethlehem besides the Church of the Nativity?
    answer: 'Beyond the Nativity church and Manger Square, highlights include the Milk Grotto, the Shepherds Field, the Banksy-decorated Walled Off Hotel and sections of the separation wall, and the local olive-wood workshops. Adding Jericho brings the worlds oldest city and the Mount of Temptation.'
---
...
- **Israeli rental cars usually can't go.** Standard Israeli rental-car insurance does not cover Area A, so [self-driving](/car-rental-israel) is not the practical option. This is the single most common West Bank question on travel forums.
...
See our [border crossings guide](/border-crossings) for the wider picture on movement around the country.
...
This is one of the top picks in our [day trips from Jerusalem](/day-trips-from-jerusalem) guide. Pair it with the full [Jerusalem region guide](/jerusalem), the [3-day Jerusalem itinerary](/itineraries/3-days-in-jerusalem), or the desert classic, the [Masada & Dead Sea day trip](/masada-dead-sea-day-trip). Browse everything in [best tours in Israel](/best-tours-in-israel). For a detailed comparison of tour formats and operators — half-day vs full-day, Jericho extension, dual-narrative — see our [Bethlehem tours compared](/bethlehem-tours-compared) guide.
