...
ctaHeading: 'Book guided experiences and hotels in Tel Aviv'
affiliateCtas:
  - partner: getyourguide
    title: 'Tel Aviv Private City Tour'
...
**Getting to the city.** From [Ben Gurion Airport](/ben-gurion-airport-guide), the train to Tel Aviv HaShalom takes 20–25 minutes; to Tel Aviv Savidor (Central) about 30 minutes. A Rav-Kav card (₪5 from the station machine, then top up) covers trains, the light rail and buses. See the [transport guide](/transportation) for full details.

**Where to stay.** Rothschild Boulevard, Neve Tzedek and the Gordon/Frishman beach strip are the best-positioned areas for this itinerary. For specific hotel picks at each budget tier, see [best hotels in Tel Aviv](/best-hotels-tel-aviv).
...
Start on [Rothschild Boulevard](/tel-aviv-white-city) — the spine of Tel Aviv's UNESCO-listed International Style (Bauhaus-influenced) district. The boulevard runs northwest from Neve Tzedek to Habima Square; the most photographed stretch is the central 800 metres between Shadal Street and Allenby.
...
Head west to the seafront. [Gordon Beach](https://www.gordon-beach.co.il) is the most central public beach: sun-lounger rentals, cafés, lifeguards in season (April–October) and freshwater showers. In summer the water reaches 27–28°C; in autumn and spring it is still swimmable.
...
Take the Tayelet south to [Jaffa](/jaffa-travel-guide) for sunset. The view from the old port looking back at the Tel Aviv skyline — illuminated, with the Mediterranean in the foreground — is the city's signature image. The Clock Tower and the elevated promenade above the port offer the best vantage points.
...
Entry is approximately ₪60 for adults; check [tamuseum.org.il](https://www.tamuseum.org.il) for current hours and temporary exhibitions.
...
For a rooftop sunset cocktail before dinner, the **Norman Hotel** (23 Nachmani, Rothschild area) and several boutique hotels in the Hayarkon beach strip have rooftop terraces open to non-guests. Arrive 30–45 minutes before sunset for a good position. See [Israel rooftop bars guide](/israel-rooftop-bars) for the full list.
...
The train from HaShalom station (200m from Sarona Market) reaches the airport in about 20 minutes and avoids road traffic on busy Fridays. See the [Ben Gurion Airport guide](/ben-gurion-airport-guide) for full terminal logistics, lounge access and duty-free.

---

## Budget reference

| Travel style | Per person per day | 3 nights total (hotels only) |
|---|---|---|
| Budget | ₪250–400 | ₪750–1,200 |
| Mid-range | ₪550–900 | ₪1,650–2,700 |
| Boutique / luxury | ₪1,200–2,500+ | ₪3,600–7,500+ |

Museum entries (ANU + Tel Aviv Museum ≈ ₪120 combined), Jaffa guided walk and food add ₪200–400 per person over three days. See the [Israel cost and budget guide](/israel-cost-budget) for the full breakdown.

---

## Useful cross-links

- [1 day in Tel Aviv](/1-day-tel-aviv-itinerary) — condensed version if time is short
- [3 days in Jerusalem](/itineraries/3-days-in-jerusalem) — pair for a 6-day combined trip
- [Tel Aviv neighborhoods guide](/tel-aviv-neighborhoods-guide) — where to stay explained by area
- [Tel Aviv food guide](/tel-aviv-food-guide) — restaurant recommendations beyond the itinerary
- [Shabbat guide](/shabbat-guide) — full logistics for Friday and Saturday visits
- [Transportation guide](/transportation) — trains, light rail, Rav-Kav and sherut taxis
