...
ctaHeading: 'Book Latrun day tours & transfers'
affiliateCtas:
  - partner: getyourguide
    title: 'Latrun & Jerusalem Corridor Guided Day Tour'
    description: 'A guided day covering the tank museum at Yad La-Shiryon and the Trappist monastery winery, often combined with the Jerusalem Old City for a full Route 1 experience.'
    image: /images/regions/jerusalem/hero.jpg
    query: Latrun tank museum day tour Israel
    cta: Browse Latrun tours
  - partner: viator
    title: 'Private Route 1 Day Trip from Tel Aviv or Jerusalem'
    description: 'A private vehicle and licensed guide for Yad La-Shiryon, the monastery and Mini Israel at your own pace — full flexibility on timing and depth of coverage at each site.'
    image: /images/sub-destinations/jerusalem/old-city.jpg
    query: Latrun private day tour from Tel Aviv
    cta: See private tours
  - partner: discovercars
    title: 'Self-Drive Route 1 — Rent a Car'
    description: "Latrun's three sites sit within 3 km of each other along Route 1. A rental car is the most flexible option — drive out from Tel Aviv or back into Jerusalem as your itinerary requires."
    image: /images/regions/negev/hero.jpg
    destination: Israel
    cta: Compare car hire
faqs:
  - question: What is Yad La-Shiryon and is it worth visiting?
    answer: "Yad La-Shiryon — the Armored Corps Memorial Site and Museum — is Israel's premier military museum and one of the largest armored vehicle collections in the Middle East. The outdoor park displays over 200 tanks, half-tracks, armored personnel carriers and artillery pieces spanning from Israel's War of Independence through to modern vehicles. The indoor memorial museum covers Israeli armored warfare history and the 1948 Battle of Latrun, when the IDF repeatedly failed to retake the fortified police station that controlled the road to besieged Jerusalem. It is worth the visit for military history enthusiasts and provides unexpected depth for general visitors — the sheer scale of equipment on display and the dramatic 1948 story make it genuinely compelling."
  - question: How do you get to Latrun from Tel Aviv?
    answer: 'By car: take Route 1 (Highway 1) east from Tel Aviv toward Jerusalem. The Latrun junction is signed at the Route 3 intersection, about 40 minutes from Tel Aviv city centre. There is free parking at both Yad La-Shiryon and Mini Israel. By public transport: direct service to Latrun is limited — most visitors hire a car or join a guided day tour that includes driver transport. Some Egged bus routes pass the Latrun junction but the stop is not walkable to the attractions; a taxi or tour is needed for the final stretch.'
  - question: How do you get to Latrun from Jerusalem?
    answer: "Latrun is approximately 35 km west of Jerusalem on Route 1 — about 30–35 minutes by car. Turn off at the Latrun junction (Route 3) and follow signs to Yad La-Shiryon or Mini Israel. The return drive from Latrun to Jerusalem along Route 1 through the forested Sha'ar HaGai (Bab el-Wad) gorge is one of the most historically significant corridors in Israel — the rusted convoy vehicles on the roadside are 1948 war memorials, left in place as silent monuments."
  - question: What does the Latrun Trappist monastery sell?
    answer: 'The Latrun Trappist Monastery produces wine and extra-virgin olive oil, sold in the monastery shop. The wines are kosher-certified and made by the resident community of Cistercian monks from grapes grown on monastery grounds. Olive oil pressing follows the autumn harvest. The shop is typically open Monday through Saturday during daylight hours — hours are subject to religious observances, so arrive before mid-afternoon to be certain. Photography of the monastery buildings and grounds is welcome from the public areas.'
  - question: How long does a visit to all three Latrun sites take?
    answer: 'Yad La-Shiryon takes 1.5–2.5 hours depending on interest level — the outdoor tank park alone needs an hour to walk through properly. Mini Israel runs 1.5–2 hours for a thorough visit (allow more if travelling with children, who tend to linger at each model). The monastery is a 20–30 minute stop. Combined, a full Latrun day (all three sites) takes 4–6 hours. Most visitors combine it with either a morning in Jerusalem or a drive continuing west to Tel Aviv — the sites are only 3 km apart.'
  - question: Are Latrun and Mini Israel suitable for children?
    answer: 'Mini Israel is particularly well-suited to children — the 1:25 scale models are at ground level and include recognisable landmarks (the Dome of the Rock, Masada, the Caesarea amphitheatre, Ben Gurion Airport with aircraft) that children can spot and identify. Yad La-Shiryon is also child-friendly in practice: the accessible outdoor tank park lets children stand next to enormous vehicles, and the scale is viscerally impressive. There is minimal disturbing content for general audiences — the memorial museum treats the war material respectfully rather than graphically.'
  - question: Is there an INPA pass or combined ticket for Latrun?
    answer: "Yad La-Shiryon is not an Israeli National Parks (INPA) site — it is independently operated by the Israel Defense Forces memorial fund, so the INPA annual pass does not apply. Mini Israel operates its own ticketing. The Trappist monastery entrance is free; purchases are voluntary. Check current admission prices directly at the Yad La-Shiryon and Mini Israel official websites before visiting."
---
...
1. Start at **Yad La-Shiryon** when it opens (the outdoor park is most comfortable before midday heat in summer).
2. Drive to the **monastery** for the shop and grounds — this works well as a midday break, with purchases as a slow lunch substitute.
3. Finish at **Mini Israel** in the afternoon or evening.
...
- A **[guided day tour](/best-tours-in-israel)** that includes driver transport (see tour options above).
- A **[rental car](/car-rental-israel)** for the day, easily arranged from Tel Aviv or Jerusalem.
...
Latrun fits naturally into several wider itineraries: see [day trips from Tel Aviv](/day-trips-from-tel-aviv) for the full Tel Aviv excursion menu, [day trips from Jerusalem](/day-trips-from-jerusalem) for Jerusalem-based options, and the [car rental guide](/car-rental-israel) if you are planning a self-drive Route 1 journey. For more Israeli wine experiences, the [Israel wine and wineries guide](/israel-wine-wineries) covers the full national wine scene including the Carmel, Galilee and Judean Hills regions. See [transportation in Israel](/transportation) for getting around the country. Plan your wider trip with our [Israel itineraries](/itineraries) or explore all [guided tours and day trips](/best-tours-in-israel).
