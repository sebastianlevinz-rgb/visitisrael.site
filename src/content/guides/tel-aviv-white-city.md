---
title: 'Tel Aviv White City: Bauhaus Architecture Guide & Walking Tour (2026)'
...
ctaHeading: 'Explore the White City with a local guide'
affiliateCtas:
  - partner: getyourguide
    title: 'Tel Aviv White City Bauhaus Architecture Tour'
    description: 'Walk Rothschild Boulevard and Dizengoff Square with an architecture guide who brings the 1930s history to life — the German-Jewish architects who arrived with Bauhaus blueprints and transformed a sand-dune city into a modernist masterpiece.'
    image: /images/regions/tel-aviv/rothschild.jpg
    query: Tel Aviv White City Bauhaus architecture walking tour
    cta: Browse White City tours
  - partner: viator
    title: 'Tel Aviv City Walking Tour — From Old Jaffa to Bauhaus'
    description: 'The classic Tel Aviv discovery walk — Old Jaffa port, the Neve Tzedek lanes, and the Bauhaus boulevards of the White City. A half-day introduction to the layers of the city for first-time visitors.'
    image: /images/sub-destinations/tel-aviv/neve-tzedek.jpg
    query: Tel Aviv walking tour Jaffa White City architecture
    cta: See Tel Aviv walking tours
  - partner: civitatis
    title: 'Private Bauhaus Architecture Tour'
    description: 'A private guide through the White City at your own pace — focus on the buildings that interest you most, go deeper into the social history, and avoid the logistics of a group format.'
    image: /images/sub-destinations/tel-aviv/rothschild.jpg
    query: private guide Tel Aviv Bauhaus architecture tour
    cta: Book a private tour
faqs:
  - question: What is the Tel Aviv White City?
    answer: "The White City refers to a collection of over 4,000 buildings in central Tel Aviv designed in the International Style (strongly influenced by the Bauhaus movement) and built predominantly in the 1930s and 1940s. The neighbourhood was added to UNESCO's World Heritage List in 2003, recognised as the world's largest concentration of Bauhaus and International Style architecture. The 'white' in the name reflects both the pale plaster facades and the modernist utopian ideology of the movement."
  - question: Why was Bauhaus architecture built in Tel Aviv?
    answer: 'Hundreds of Jewish architects trained at the Bauhaus school in Germany emigrated to British Mandate Palestine in the 1930s, fleeing the rise of National Socialism. They brought with them the Bauhaus and International Style principles — flat roofs, ribbon windows, pilotis (open ground floors on columns), unornamented facades, and building forms adapted to function. In Tel Aviv, they adapted these principles for a hot Mediterranean climate: deep window shading, narrow east–west building orientations, and rooftop gardens that worked as sleeping terraces in summer. The result was a coherent architectural style built with exceptional speed across a growing city.'
  - question: Is the Bauhaus Center in Tel Aviv worth visiting?
    answer: "Yes, especially as a starting point. The Bauhaus Center at 77 Dizengoff Street runs a permanent gallery covering the history and principles of White City architecture, sells the best maps and self-guided tour booklets, and offers guided walking tours in English typically on Fridays and Sundays at 10am. Verify current tour times and prices directly at bauhaus-center.com before your visit, as schedules change seasonally. The centre is small — allow 30–45 minutes inside — but it reframes everything you see on the walking route that follows."
  - question: How long does a self-guided White City walking tour take?
    answer: "A focused self-guided walk covering Rothschild Boulevard, Bialik Square, and Dizengoff Square takes approximately 2–2.5 hours at a comfortable pace. If you extend to include a coffee stop and time inside the Bauhaus Center, budget 3–3.5 hours. The entire route is flat, shaded by the ficus tree canopy on Rothschild, and walkable year-round — though the midday heat in June–September makes a morning or late-afternoon start strongly advisable."
  - question: What is the best time of day to visit for photography?
    answer: 'Early morning (07:00–10:00) gives the best light on the white facades — the plaster catches the low-angled sun and the streets are quiet enough to photograph without crowds. The deep shadow bands under pilotis and balconies are most dramatic in morning or evening light. Avoid 11:00–15:00 in summer: the overhead sun bleaches the white facades and the heat haze reduces sharpness. The golden hour before sunset on Rothschild Boulevard, looking northwest, is one of the most photographable city-street compositions in Israel.'
  - question: Is the White City walkable from central Tel Aviv hotels?
    answer: 'Yes — the White City is central Tel Aviv. Rothschild Boulevard runs from the edge of the Neve Tzedek neighbourhood northward to the Habima National Theatre, a 1.3 km stretch that is among the most walkable in the city. Most Tel Aviv hotels in the city-centre area are within 10–20 minutes on foot. The Tel Aviv Red Line light rail serves Arlozorov and Carlebach stations at the northern end of the boulevard; from there the walk south is pleasant and direct.'
---
...
1. **Engel House, Rothschild 84** — first use of pilotis in Israel (1933, Ze'ev Rechter)
2. **Beit Bialik, 22 Bialik Street** — the national poet's preserved house; eclectic style preceding the White City wave; open as a museum
3. **Sheinkin House corner buildings** — the Sheinkin Street corridor shows several excellent corner-window examples, where the architects used the curved corner window to dissolve the building edge
4. **Bauhaus Center building itself, 77 Dizengoff** — the centre occupies a typical mid-period White City apartment building; the facade illustrates the movement's domestic vocabulary
5. **Dizengoff Square ring buildings** — the ensemble around the square is the best concentration of intact original facades; spend time walking the outer ring
6. **Levant Fair Pavilion site (off Ben Gurion Boulevard)** — the original 1930s Levant Fair grounds have been partly built over, but surviving fragments near Ganei Yehoshua Park show the fair's architectural ambition
...
- **By bike**: Tel-O-Fun bike-share stations are positioned on and near Rothschild Boulevard — a natural cycling route in either direction; see the [transportation guide](/transportation) for Rav-Kav and Tel-O-Fun details
...
- **Carmel Market (10 minutes south of Rothschild)** — the city's main market and the natural continuation of a White City morning; see the [Tel Aviv food guide](/tel-aviv-food-guide) for market logistics
