...
faqs:
  - question: Which app is best for public transport in Israel?
    answer: 'Moovit is the go-to app for Israeli public transport — it covers all bus routes, light rail and train connections with real-time arrivals, and is significantly more accurate than Google Maps for Israeli bus networks. Download it before you fly and search in English.'
  - question: Does Uber operate in Israel?
    answer: 'Uber operates only in Tel Aviv. For Jerusalem, Haifa and everywhere else, use Gett — the dominant Israeli ride-hailing app. Gett shows a fixed price before you confirm, and drivers can communicate in English. Standard metered taxis are also widely available.'
  - question: What navigation app do Israelis use?
    answer: 'Waze, which was founded in Israel and is still developed there. It has superior local traffic data, real-time alerts for speed cameras and police, and accurate Route 6 toll routing. For city driving and intercity journeys, Waze consistently outperforms Google Maps in Israel.'
  - question: How do I pay for parking in Israel?
    answer: 'Download Pango before you arrive. Metered street parking (blue-and-white kerb markings) is paid via the Pango app — enter the zone number shown on the parking meter or scan the QR code, set your duration, and pay. It saves you hunting for coins and avoids fines. Yellow kerb = no parking at any time.'
  - question: Do I need data to use these apps in Israel?
    answer: 'Yes — Moovit, Waze, Gett and most apps require a data connection for real-time features. Sort your mobile data before you fly: an eSIM from Airalo or a local SIM from Hot Mobile, Pelephone or Partner all give you affordable 4G coverage across Israel. Download offline maps for the areas you will visit as a backup.'
  - question: Is WhatsApp used in Israel?
    answer: 'Universally. Israeli businesses, hotels, tour guides and restaurants communicate almost exclusively via WhatsApp. Enable it on your international number before you arrive, or you will struggle to reach guesthouses, confirm bookings, or get tour confirmations. It is as important as any navigation app for day-to-day travel here.'
---

Staying connected and navigating Israel is straightforward once you have the right apps installed. Download these before you land at [Ben Gurion Airport](/ben-gurion-airport-guide) — you will want them the moment you step off the plane.
...
Use it to plan any journey by bus or train, check live platform information, and confirm exactly where to board. It pairs well with a [Rav-Kav transit card](/rav-kav-israel) — plan the route in Moovit, pay the fare with your Rav-Kav.

**Download**: before you fly, while you have home Wi-Fi.

### Waze — driving and navigation

**Waze** was founded in Israel and is still developed here, which shows: it has the most accurate local traffic data available, including real-time alerts for speed cameras, police patrols, and road incidents. For intercity driving it handles [Route 6 tolls](https://www.iroads.co.il) correctly (it will tell you whether a specific route uses the toll road and route around it if you prefer). For city driving in Jerusalem or Tel Aviv, Waze handles the maze of one-way streets and traffic pinch-points better than competitors.

See the [driving in Israel guide](/driving-in-israel) for parking rules, right-of-way conventions, and what to know before you get behind the wheel.
...
For airport arrivals: pre-arranged transfers and licensed taxis from the Ben Gurion arrivals hall are reliable; see [Ben Gurion airport transfers](/ben-gurion-airport-transfers) for the full breakdown of options.
...
| **WhatsApp** | Must be active on your number |
| **Google Translate** | Download Hebrew offline pack |
| **Wolt** | Optional — useful from night one |

Also sort your data connection: see the [Israel eSIM guide](/israel-esim) for the easiest way to get affordable 4G from the moment you land.
...
- [Getting around Israel — transport guide](/transportation)
- [Driving in Israel](/driving-in-israel)
- [Israel eSIM — getting data](/israel-esim)
- [Rav-Kav transit card guide](/rav-kav-israel)
- [Ben Gurion Airport arrivals](/ben-gurion-airport-guide)
