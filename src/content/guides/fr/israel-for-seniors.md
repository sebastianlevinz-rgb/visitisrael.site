...
ctaHeading: "Réserver des circuits adaptés aux seniors"
affiliateCtas:
  - partner: abraham
    title: "Circuits accompagnés et privés en Israël"
    description: "Abraham Tours propose des circuits en petit groupe accompagnés et des expériences privées guidées à un rythme confortable — guides expérimentés, planification flexible et hôtels sélectionnés pour l'accessibilité et la proximité des commodités. Convient aux premiers visiteurs comme aux habitués."
    image: /images/regions/jerusalem/old-city.jpg
    query: escorted Israel tour small group seniors
    cta: Découvrir Abraham Tours
  - partner: tourradar
    title: "Circuits en petit groupe pour les plus de 50 ans"
    description: "TourRadar regroupe les voyages organisés en Israël d'opérateurs spécialisés comme Bein Harim, Globus et Insight Vacations. Comparez les itinéraires, les dates de départ, les tailles de groupe et les niveaux de confort pour trouver le rythme qui vous convient."
    image: /images/regions/dead-sea/ein-bokek.jpg
    query: Israel senior small group tour comfortable
    cta: Comparer les circuits en petit groupe
  - partner: viator
    title: "Excursions guidées à travers Israël"
    description: "Des visites à pied de la vieille ville de Jérusalem aux excursions d'une journée en Galilée — Viator propose des centaines d'expériences guidées adaptées aux plus de 50 ans, avec des options accessibles lorsqu'elles sont disponibles."
    image: /images/regions/galilee/hero.jpg
    query: accessible guided tour Israel over 50
    cta: Voir les excursions guidées
faqs:
  - question: "Israël est-il une bonne destination pour les voyageurs seniors ?"
    answer: "Israël est une destination excellente pour les voyageurs de plus de 50 et 60 ans. Les infrastructures sont modernes, l'anglais est largement parlé et la plupart des grands sites archéologiques et culturels disposent de téléphériques, d'ascenseurs ou de chemins pavés. Les soins médicaux sont de classe mondiale — les hôpitaux de Jérusalem, Tel Aviv et Haïfa fonctionnent selon les standards européens. Le printemps et l'automne sont les saisons idéales : températures douces (18–26 °C), faible humidité et files d'attente moins longues qu'en plein été. Les principaux défis sont la chaleur en juillet–août et les pavés inégaux dans certaines parties de la vieille ville de Jérusalem."
  - question: "Quelle est la meilleure période de l'année pour les seniors pour visiter Israël ?"
...
[La vieille ville de Jérusalem](/jerusalem) est l'un des endroits les plus extraordinaires du monde, et la plupart des voyageurs seniors la trouvent gérable avec une préparation réaliste :
...
La région de [Galilée](/galilee) offre plusieurs expériences bien adaptées aux voyageurs seniors : une **excursion en bateau sur la mer de Galilée** (eau calme, 45–60 minutes, sans effort physique) est un point fort pour les pèlerins chrétiens et les visiteurs en général. Le point de vue du **Mont des Béatitudes** au-dessus du lac est accessible par un chemin pavé et offre l'une des plus belles vues de la région. [Nazareth](/nazareth) et la basilique de l'Annonciation (bâtiment moderne avec accès par ascenseur) sont à quelques minutes en voiture du lac.
