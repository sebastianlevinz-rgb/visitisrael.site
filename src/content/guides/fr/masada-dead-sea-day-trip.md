...
ctaHeading: 'Réservez votre excursion Masada & mer Morte'
affiliateCtas:
  - partner: getyourguide
    title: 'Lever de Soleil à Masada, Ein Gedi & mer Morte'
    description: "Le best-seller — une montée à l'aube sur Masada, l'oasis d'Ein Gedi et une baignade dans la mer Morte, avec prise en charge à l'hôtel."
    image: /images/sub-destinations/dead-sea/masada.jpg
    query: Masada sunrise Ein Gedi Dead Sea tour
    cta: Voir cette excursion
  - partner: viator
    title: 'Masada & mer Morte — Visite en Journée'
    description: 'La version détendue — un départ plus tardif avec le téléphérique pour monter à Masada, puis du temps libre pour flotter dans la mer Morte.'
    image: /images/regions/dead-sea/hero.jpg
    query: Masada Dead Sea day trip
    cta: Voir cette excursion
  - partner: abraham
    title: 'Lever de Soleil à Masada (Budget / Routard)'
    description: 'Une version petit budget en petit groupe pour le lever de soleil emblématique sur Masada et la baignade dans la mer Morte.'
    image: /images/regions/dead-sea/ein-gedi.jpg
    query: Masada sunrise Dead Sea
    cta: Voir cette excursion
faqs:
  - question: "Combien coûte l'excursion Masada et mer Morte ?"
    answer: "Les circuits en groupe coûtent généralement entre $89 et $120 par personne (transport et guide inclus). Le téléphérique de Masada (₪75/$20 aller-retour) et l'entrée au parc national sont souvent en supplément. Les visites privées sont nettement plus chères."
  - question: 'Le lever de soleil à Masada vaut-il le réveil aux aurores ?'
    answer: "Pour beaucoup, oui — regarder le soleil se lever sur la mer Morte et les montagnes de Jordanie depuis une forteresse vieille de 2 000 ans est l'un des moments forts d'un voyage en Israël. Si le réveil à 3h du matin ne vous tente pas, optez pour la version journée avec le téléphérique."
  - question: 'Peut-on faire Masada et la mer Morte depuis Tel Aviv ?'
    answer: 'Oui, des circuits partent de Jerusalem et de Tel Aviv. Depuis Tel Aviv, comptez environ une heure de trajet supplémentaire et un prix légèrement plus élevé.'
  - question: 'La randonnée de Masada est-elle difficile ?'
    answer: "Le sentier du Serpent est une montée soutenue en lacets d'environ 350 m de dénivelé positif, réalisable en 45–60 minutes. Il n'y a pas de difficultés techniques. Le téléphérique fonctionne à partir d'environ 8h pour ceux qui préfèrent ne pas marcher."
  - question: 'Flotte-t-on vraiment dans la mer Morte ?'
    answer: "Absolument — la teneur en sel est tellement élevée que vous restez naturellement à la surface. Quelques règles essentielles : chaussons de bain recommandés sur les rives rocailleuses, ne rasez rien la veille, évitez absolument de mettre l'eau dans les yeux et rincez-vous soigneusement après. Vingt minutes suffisent."
events:
  - name: 'Masada Sound and Light Show 2026'
    startDate: '2026-03-01'
    endDate: '2026-10-31'
    description: 'The Masada Sound and Light Show brings the siege of Masada to life...'
...
**Masada** — [/dead-sea/masada](/dead-sea/masada)
...
**Ein Gedi** — [/dead-sea/ein-gedi](/dead-sea/ein-gedi)
...
**La mer Morte** — [/dead-sea](/dead-sea)
