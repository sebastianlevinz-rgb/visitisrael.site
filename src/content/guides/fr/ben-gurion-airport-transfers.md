...
affiliateCtas:
  - partner: welcomepickups
    title: "Transfert privé depuis l'aéroport"
    description: "Un chauffeur vous attend à la sortie des arrivées et vous conduit directement à votre hôtel — vol suivi, prix fixe, disponible 24h/24 y compris le Shabbat."
  ...
  - partner: kiwitaxi
    title: "Taxi et navette pré-réservés"
    description: "Comparez voitures privées et navettes depuis TLV vers Tel Aviv, Jérusalem et au-delà, avec tarif affiché à l'avance sans mauvaise surprise."
...
Presque toutes les visites en Israël commencent à l'**aéroport Ben Gourion (TLV)**, à environ 15 km au sud-est de Tel Aviv. Voici vos options pour le trajet en ville, du train rapide et économique au transfert privé porte-à-porte.

## Comparatif rapide

| Option | Vers Tel Aviv | Vers Jérusalem | Shabbat ? |
| --- | --- | --- | --- |
| **Train** | ~20 min, ~5 $ | ~30 min, ~5 $ | Non |
...
Un **transfert privé pré-réservé** met à votre disposition un chauffeur qui vous attend à la sortie des arrivées avec votre nom, suit votre vol et vous conduit directement à votre hôtel pour un **prix global fixe** — sans négociation, ni supplément bagage ou tarif nocturne. C'est le choix le plus serein après un long vol, pour les familles, les arrivées tardives ou le **Shabbat**, quand trains et bus sont à l'arrêt. Réservez avant de partir avec les options ci-dessus.

## Le train (moins cher et plus rapide)
...
Pour tout le reste à l'aéroport — plan des terminaux, conseils pour l'entretien de sécurité, situation des salons en 2026 (le Priority Pass n'est plus accepté) et duty-free — consultez le [guide complet de l'aéroport Ben Gourion](/fr/ben-gurion-airport-guide). Préparez votre [eSIM](/fr/israel-esim) et votre [assurance voyage](/fr/israel-travel-insurance) avant d'atterrir, et si vous explorez au-delà des grandes villes, comparez la [location de voiture](/fr/car-rental-israel). Première fois en Israël ? Commencez par le [guide du premier voyage](/fr/first-time-in-israel).
