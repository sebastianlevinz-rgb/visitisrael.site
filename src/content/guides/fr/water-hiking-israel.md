...
ctaHeading: "Réservez des expériences de randonnée aquatique guidée"
affiliateCtas:
  - partner: getyourguide
    title: "Tours guidés Ein Guedi et mer Morte"
    description: "GetYourGuide propose des tours guidés dans la réserve naturelle d'Ein Guedi au départ de Jérusalem et de Tel-Aviv — combinant Nahal Arugot ou Wadi David avec une baignade en mer Morte. Idéal pour les premiers randonneurs aquatiques souhaitant un guide expert sur le terrain."
    image: /images/regions/dead-sea/ein-gedi.jpg
    query: Ein Gedi nature hike Dead Sea tour Israel
    cta: Parcourir les tours Ein Guedi
  - partner: abraham
    title: "Abraham Tours : randonnées guidées dans le désert de Judée"
    description: "Abraham Tours organise des randonnées guidées en petits groupes dans le désert de Judée et le couloir de la mer Morte, incluant des randonnées aquatiques dans la réserve d'Ein Guedi. Guides locaux expérimentés, connaissant la sécurité anti-crues et les conditions actuelles."
    image: /images/regions/galilee/hero.jpg
    query: guided hike Judean Desert water Israel
    cta: Parcourir les randonnées à la journée
faqs:
  - question: "Qu'est-ce qu'une randonnée aquatique nahal en Israël ?"
    answer: "Un nahal (נחל) est un corridor fluvial ou un lit de rivière à sec. Les randonnées aquatiques — parfois appelées « randonnées nahal » — sont des sentiers où l'on marche dans l'eau ou le long d'un courant : en pataugeant dans des chenaux peu profonds, en traversant des piscines naturelles et parfois en nageant de courtes sections. Ce sont les randonnées les plus fraîches et les plus atmosphériques d'Israël, notamment en été quand les piscines de canyon ombragées offrent un soulagement naturel. Les meilleures randonnées nahal se pratiquent généralement au printemps et en début d'automne, quand l'eau coule et que les températures sont agréables. Vérifiez toujours le niveau d'eau actuel avant de vous rendre sur place — de nombreux cours d'eau s'assèchent en été."
  - question: "Quelle est la meilleure période pour une randonnée aquatique en Israël ?"
...
Avant toute randonnée nahal, consultez les prévisions du [Service météorologique israélien](https://ims.gov.il) — pas seulement pour votre emplacement mais pour l'ensemble du bassin versant en amont. L'INPA émet des alertes crues soudaines aux entrées des parcs ; prenez-les au sérieux.

### Les saisons en un coup d'œil

| Saison | Conditions | Meilleurs sites |
|---|---|---|
| **Printemps (mars–mai)** | Canaux en crue, températures confortables, fleurs sauvages | Tous les sites — fenêtre idéale |
| **Été (juin–sep)** | La plupart des canaux secs ; chaleur intense | Wadi David uniquement (alimenté par source) |
| **Automne (oct–nov)** | Canaux se remplissant, fraîchissement | Tous les sites rouvrant |
| **Hiver (déc–fév)** | Forts débits mais froid et risque de crue | Randonneurs experts uniquement ; vérifiez les alertes |

### Liste de matériel

- **Chaussures aquatiques** : bout fermé, semelle antidérapante — indispensable sur les rochers glissants
- **Sac étanche** : protégez téléphone, documents et tenue de rechange
- **Eau** : au minimum 2 litres par personne — davantage dans le couloir de la mer Morte
- **Protection solaire** : chapeau, crème solaire, vêtements légers à manches longues
- **Cartes hors ligne** : la plupart des sites n'ont pas de réseau mobile
...
**Conseils pratiques :** Ce site nécessite une voiture ou un circuit organisé — pas de transport en commun direct depuis Tel-Aviv. Les week-ends et jours fériés sont très fréquentés ; les visites en semaine sont bien plus tranquilles. Le site est proche du parc archéologique historique de [Beit She'an](/galilee), qui s'associe bien pour une journée complète en [Galilée](/galilee).
...
**Localisation :** Césarée de Philippe, [Golan](/golan) méridional ; 2h30 de Tel-Aviv  
...
- **Journée mer Morte depuis Jérusalem ou Tel-Aviv :** [Ein Guedi](/dead-sea/ein-gedi) le matin (Wadi David) → baignade en mer Morte l'après-midi → retour via Massada si le temps le permet.
- **Multi-jours en Galilée :** Nahal Kziv le premier jour combiné à un après-midi à [Akko](/akko) ; Nahal HaKibbutzim le deuxième jour avec [Beit She'an](/galilee) ; Banias le troisième jour avec la forteresse de Nimrod et le Golan.
- **Excursion d'une journée depuis Jérusalem :** Wadi Qelt (Ein Prat) comme randonnée matinale de demi-journée suivie de la [vieille ville de Jérusalem](/jerusalem) l'après-midi.
...
- Consultez le site INPA du parc ou appelez l'entrée du site pour connaître les conditions actuelles.
- Recherchez des rapports récents sur les forums de randonnée israéliens (Hike Israel, applications trail) — les locaux sont la meilleure source en temps réel.
- Traitez toujours les guides de débit saisonnier comme des approximations ; ne supposez jamais.
