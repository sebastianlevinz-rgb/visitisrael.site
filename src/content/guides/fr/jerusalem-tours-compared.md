...
ctaHeading: "Circuits et billets Jérusalem les mieux notés"
affiliateCtas:
  - partner: getyourguide
    title: "Visites à pied de la Vieille Ville de Jérusalem"
    description: "Visites guidées à pied d'une demi-journée ou d'une journée complète dans les quatre quartiers — le Mur des Lamentations, le Saint-Sépulcre et la Via Dolorosa avec un guide local expert."
    image: /images/regions/jerusalem/old-city.jpg
    query: Jerusalem Old City walking tour
    cta: Voir les circuits
  - partner: viator
    title: "Circuits Jérusalem & Bethléem"
    description: "Les points forts de la Vieille Ville combinés avec une après-midi guidée à l'église de la Nativité à Bethléem, les passages aux checkpoints étant gérés pour vous."
    image: /images/regions/jerusalem/holy-sepulchre.jpg
    query: Jerusalem Bethlehem day tour
    cta: Voir les excursions
  - partner: civitatis
    title: "Circuit des tunnels du Mur des Lamentations"
    description: "Parcourez toute la longueur souterraine du Mur des Lamentations et la rue hérodienne lors d'une visite guidée à entrée programmée — réservez à l'avance, les créneaux partent vite."
    image: /images/regions/jerusalem/western-wall.jpg
    query: Western Wall Tunnels tour
    cta: Vérifier les disponibilités
faqs:
  - question: "Quel est le meilleur circuit à Jérusalem ?"
    answer: "Pour la plupart des primo-visiteurs, une visite guidée à pied de la Vieille Ville d'une demi-journée est le meilleur point de départ — elle déverrouille les quatre quartiers, le Mur des Lamentations et l'église du Saint-Sépulcre avec un guide qui donne du sens aux histoires concurrentes. Si vous avez une journée complète, le circuit Jérusalem ancienne et moderne ajoute le mont des Oliviers, le mont Sion et un musée ou la Cité de David. Les pèlerins et les familles préfèrent souvent un guide privé pour un rythme adapté et confessionnel."
  - question: "Ai-je besoin d'un guide pour la Vieille Ville de Jérusalem ?"
    answer: "Pas strictement — vous pouvez déambuler librement dans la Vieille Ville — mais un guide apporte une réelle valeur ajoutée au Saint-Sépulcre, sur la Via Dolorosa et au Mur des Lamentations, où l'histoire et les traditions concurrentes sont difficiles à saisir seul. Les ruelles de la Vieille Ville sont aussi un vrai labyrinthe, et une première visite guidée vous aide à vous repérer."
  - question: "Combien de temps faut-il pour un circuit à Jérusalem ?"
    answer: "Une demi-journée (3–4 heures) couvre les sites phares de la Vieille Ville. Une journée complète (7–8 heures) ajoute le mont des Oliviers, le mont Sion, et soit Yad Vashem, le Musée d'Israël, soit la Cité de David. Pour inclure Bethléem, prévoyez une journée complète. La plupart des visiteurs consacrent deux à trois jours à Jérusalem au total."
  - question: "Peut-on visiter Bethléem dans le cadre d'un circuit à Jérusalem ?"
    answer: "Oui — le circuit combiné Jérusalem & Bethléem est l'une des options les plus populaires. Bethléem se trouve à environ 10 km au sud, dans la Cisjordanie, et parce que les voitures de location standard ne sont pas assurées en Zone A, un circuit guidé ou un guide local agréé est le moyen le plus simple pour s'y rendre. Apportez votre passeport pour le checkpoint."
...
| Type de circuit | Durée | Idéal pour | Fourchette de prix (par personne) |
|---|---|---|---|
| **Visite à pied de la Vieille Ville** | 3–4 h | Primo-visiteurs, les sites saints emblématiques | ~30–50 $ |
| **Journée complète Jérusalem ancienne et moderne** | 7–8 h | Voir la ville entière en une seule journée | ~60–95 $ |
| **Combiné Jérusalem & Bethléem** | Journée complète | Ajouter la Nativité (Cisjordanie) | ~80–110 $ |
| **Circuit des tunnels du Mur des Lamentations** | ~1h30 | Passionnés d'histoire ; entrée programmée, réservez à l'avance | ~25–35 $ |
| **Guide et chauffeur privés** | Flexible | Familles, approche confessionnelle, rythme personnalisé | à partir de ~300 $ / jour |

Les tarifs sont indicatifs et varient selon la saison, la taille du groupe et l'opérateur ; ils augmentent autour de **Pâques, Pessah et les Hautes Fêtes juives**. Vérifiez le prix en temps réel au moment de la réservation.
...
Pour la **Vieille Ville, oui** — l'histoire et les traditions concurrentes sont denses, les ruelles sont déroutantes, et un bon guide transforme la visite. Pour la Jérusalem-Ouest moderne, vous pouvez vous guider plus facilement avec notre [guide de la région](/jerusalem) et le tramway. Le meilleur compromis pour la plupart des voyageurs est une **matinée guidée dans la Vieille Ville** suivie d'une exploration libre l'après-midi.
