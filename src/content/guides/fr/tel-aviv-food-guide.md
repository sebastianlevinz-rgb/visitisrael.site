...
ctaHeading: 'Partez à la découverte de la ville avec un guide local'
affiliateCtas:
  - partner: civitatis
    title: 'Circuit gastronomique Tel Aviv & Jaffa'
    description: 'Grignotez de stand en stand au Carmel Market, puis explorez les ruelles du Vieux Jaffa avec un guide local passionné — dégustations incluses tout au long du parcours.'
  ...
  - partner: getyourguide
    title: 'Dégustation guidée au Carmel Market'
    description: 'Une promenade gourmande à travers le marché emblématique de Tel Aviv — épices, pâtisseries, houmous et street food avec un guide qui connaît chaque stand par son prénom.'
    image: /images/sub-destinations/tel-aviv/florentin.jpg
    query: Carmel Market food tour Tel Aviv
    cta: Voir les dégustations
faqs:
  - question: 'Pour quelle cuisine Tel Aviv est-elle connue ?'
    answer: "Le houmous, le falafel, le sabich, la shakshuka, des boulangeries d'exception, une scène végane parmi les plus dynamiques au monde, des fruits de mer méditerranéens ultra-frais et une cuisine israélienne moderne qui mêle influences moyen-orientales, nord-africaines et européennes."
  - question: 'Où manger à Tel Aviv avec un petit budget ?'
    answer: "Misez sur les marchés et le street food : Carmel Market, Levinsky, Florentin et Jaffa. Un déjeuner dans une hummusiya reste l'une des meilleures affaires de la ville."
  - question: 'Tel Aviv est-elle adaptée aux végétariens et aux véganes ?'
    answer: 'Exceptionnellement bien — Tel Aviv figure parmi les villes les plus vegan-friendly de la planète. Les options sont partout, des marchés aux restaurants gastronomiques.'
---
...
**Carmel Market (Shuk HaCarmel)** — [/tel-aviv/carmel-market](/tel-aviv/carmel-market)
...
**Florentin** — [/tel-aviv/florentin](/tel-aviv/florentin)
