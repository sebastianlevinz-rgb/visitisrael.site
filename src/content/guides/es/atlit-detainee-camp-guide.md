...
ctaHeading: "Reserva tours y alojamiento en Haifa"
affiliateCtas:
  - partner: getyourguide
    title: "Tours de patrimonio judío desde Haifa"
    description: "Tours de medio o día completo desde Haifa sobre la historia de la Aliyah Bet, los sitios clandestinos prestatales y la región costera norte. Consulta la disponibilidad."
    image: /images/regions/haifa/hero.jpg
    query: Jewish heritage tour Haifa Israel
    cta: Ver tours desde Haifa
  - partner: viator
    title: "Tours históricos Haifa e Israel del Norte"
    description: "Tours guiados desde Haifa a sitios del Mandato y la prehistoria de la independencia —con comentario especializado sobre la organización clandestina de la Aliyah Bet."
    image: /images/regions/haifa/bahai-gardens.jpg
    query: Haifa historical tour Israel Aliyah Bet
    cta: Ver tours históricos desde Haifa
  - partner: booking
    title: "Hoteles en Haifa"
    description: "Alójate en Haifa y úsala como base para Atlit (20 min al sur), Acre (30 min al norte) y Rosh Hanikra. Precios en tiempo real, sin datos fabricados."
    image: /images/regions/haifa/german-colony.jpg
    destination: Haifa Israel
    cta: Ver hoteles en Haifa
faqs:
  - question: "¿Cómo llego al campo de detención de Atlit?"
    answer: "El campo está en la ciudad de Atlit, en la Ruta 2, a unos 20 km al sur de Haifa. En transporte público: bus 921 (Egged/Kavim) desde la estación central de buses de Haifa hasta Atlit, luego un corto paseo hasta el recinto —consulta los horarios actuales en el sitio web de la empresa. En coche: 20–25 minutos desde el centro de Haifa por la Ruta 2 (autopista costera sur); aparcamiento gratuito en el recinto. En tour organizado: los tours de día completo desde Haifa y Tel Aviv incluyen Atlit con traslado y guía —la opción más completa en contexto."
  - question: "¿Qué fue el raid del Palmaj?"
    answer: "En la noche del 10 de octubre de 1945, una unidad del Palmaj al mando de un joven oficial —que más tarde se convertiría en el quinto primer ministro de Israel: Yitzhak Rabin— atravesó la valla de alambre de espino del campo de detención de Atlit, redujo a los guardias británicos y condujo a 208 prisioneros judíos refugiados a la libertad. La operación, conocida en hebreo como *Mivtza Atlit*, es una de las más celebradas del movimiento clandestino preestatal y se conmemora en el recinto con una recreación completa de la brecha en la valla y la ruta de escape. Una visita guiada lleva a los visitantes exactamente a los lugares donde ocurrieron los hechos."
  - question: "¿Está el campo de Atlit abierto en sábado?"
    answer: "El campo está habitualmente cerrado los sábados (Shabbat). Horario habitual: martes–jueves 8:30–17:00; viernes 8:30–13:00. El recinto también cierra los lunes. Los horarios pueden variar en festivos judíos —consulta siempre los horarios actualizados en el sitio oficial del Palmaj (palmach.org.il/atlit) antes de visitar. Se recomienda encarecidamente reservar con antelación los tours en inglés."
  - question: "¿Cuánto tiempo lleva visitar Atlit?"
    answer: "Una visita autoguiada por el recinto principal dura aproximadamente 1,5 a 2 horas. Un tour guiado dura entre 2 y 3 horas e incluye las barracas, la valla electrificada perimetral, la torre de vigilancia británica, el barco de inmigrantes reconstruido y el avión C-46, con comentario histórico detallado. El centro educativo proyecta también un documental en versión inglesa sobre la historia del campo que añade 20–30 minutos. La mayoría de los visitantes combinan Atlit con una media jornada en Haifa para completar el día."
  - question: "¿Hay tours en español o inglés en Atlit?"
    answer: "Los tours en inglés están disponibles pero deben reservarse con antelación a través del sitio oficial del Palmaj o directamente en el recinto. Los tours en hebreo son más frecuentes. La señalización y las exposiciones del complejo principal incluyen paneles en inglés, por lo que una visita autoguiada es también informativa sin guía. Para visitantes hispanohablantes, consulta de antemano la disponibilidad de guías en español; los tours en inglés son la alternativa más fiable."
  - question: "¿Se puede combinar Atlit con Haifa en un mismo día?"
    answer: "Sí —y funciona muy bien como excursión combinada. Atlit está a 20 km al sur de Haifa (25 minutos en coche), lo que lo convierte en una parada matinal cómoda antes de pasar la tarde en Haifa (Jardines Bahá'í, Colonia Alemana o el Monte Carmelo). Alternativamente, continúa hacia el norte desde Atlit hasta Haifa y luego hasta Acre (ciudad cruzada, 30 minutos al norte de Haifa) para una jornada de historia costera a través de tres épocas históricas muy distintas."
---
...
Ruta norte completa: [Guía de Haifa](/es/haifa-travel-guide) y [3 días en Haifa](/es/3-days-in-haifa).
...
Para un contexto histórico más amplio: [Guía de Haifa](/es/haifa-travel-guide) · [Guía de Rosh Hanikra](/es/rosh-hanikra-guide) · [Guía de Cesarea](/es/caesarea-guide)
