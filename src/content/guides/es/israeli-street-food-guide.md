...
ctaHeading: "Prueba lo mejor de Israel con un guía local"
affiliateCtas:
  - partner: getyourguide
    title: "Paseo por comida callejera y mercados en Tel Aviv"
    description: "Degusta el Mercado Carmel y Florentin con un guía local — falafel, sabich, zumo de granada recién exprimido e historias sobre cada puesto. La forma más eficiente de comer por toda la ciudad sin adivinar dónde ir."
    image: /images/regions/tel-aviv/carmel-market.jpg
    query: "Tel Aviv street food tour market"
    cta: "Ver tours gastronómicos en Tel Aviv"
  - partner: viator
    title: "Tour de comida callejera y mercados en Jerusalén"
    description: "Recorre el corredor de hummus del Barrio Musulmán y el mercado Mahane Yehuda con un guía que sabe qué puestos vale la pena esperar — bourekas, parrilla mixta, kanafeh y el mejor hummus matutino de la Ciudad Vieja."
    image: /images/regions/jerusalem/mahane-yehuda.jpg
    query: "Jerusalem street food tour Mahane Yehuda market"
    cta: "Ver tours gastronómicos en Jerusalén"
  - partner: civitatis
    title: "Paseo gastronómico por Tel Aviv y Jaffa"
    description: "Un paseo de medio día desde el Viejo Jaffa hasta el Mercado Carmel — la experiencia del hummus Abu Hassan en Jaffa, la panadería Abouelafia las 24 horas y los callejones del mercado donde Tel Aviv hace sus compras y tentempié diarios."
    image: /images/sub-destinations/tel-aviv/old-jaffa.jpg
    query: "Tel Aviv Jaffa food walking tour"
    cta: "Reservar un paseo gastronómico por Jaffa"
faqs:
  - question: "¿Cuál es la comida callejera más icónica de Israel?"
    answer: "El falafel es el más icónico — bolitas fritas de garbanzos en pita con ensaladas, encurtidos y tahini, comido de pie en un puesto callejero. El sabich (berenjena frita, huevo duro, amba y tahini en pita) y el hummus servido caliente en una hummusiya dedicada son un segundo puesto compartido. Juntos estos tres definen la experiencia de comida callejera israelí."
  - question: "¿Cuánto cuesta la comida callejera en Israel?"
    answer: "La comida callejera es una de las partes genuinamente asequibles de un viaje a Israel. Una pita de falafel o sabich ronda típicamente los ₪20–35; un generoso plato de hummus en una hummusiya ₪30–55; una pita de shawarma ₪30–45; zumo de granada recién exprimido en el Mercado Carmel ₪15–20. Presupuesta ₪50–80 por persona para un buen recorrido por el mercado. El efectivo es muy preferido en la mayoría de los puestos, aunque algunos ya aceptan pago sin contacto."
  - question: "¿La comida callejera israelí es apta para vegetarianos o veganos?"
    answer: "En gran medida — el falafel, el sabich, el hummus y la mayoría de los básicos del mercado son naturalmente de origen vegetal. La shakshuka (huevos en salsa de tomate) es vegetariana. Las bourekas suelen estar rellenas de lácteos o patata. El shawarma y la parrilla mixta son las principales opciones no vegetarianas, y en los puestos kosher certificados se mantienen separadas. Israel es uno de los países más fáciles del mundo para comer vegano en la calle."
  - question: "¿Qué es el sabich y de dónde viene?"
    answer: "El sabich es un sándwich iraquí-judío: berenjena frita, huevo duro, ensalada picada, tahini y amba (encurtido de mango ácido) metidos en pita. Se originó entre los inmigrantes judíos iraquíes que lo comían frío los sábados por la mañana (cuando la cocina está restringida en Shabbat) y luego abrieron puestos sirviéndolo durante toda la semana. Tel Aviv, con su gran comunidad judía iraquí, sigue siendo el hogar espiritual del plato."
  - question: "¿Dónde puedo encontrar el mejor hummus de Israel?"
    answer: "Varios lugares son citados consistentemente entre los mejores: Abu Hassan en Jaffa es señalado por la mayoría de los israelíes como el referente — llega antes del mediodía, ya que se agotan. Abu Shukri en la calle Al-Wad del Barrio Musulmán de la Ciudad Vieja de Jerusalén es el equivalente de la Ciudad Vieja. Azura en la zona del mercado Mahane Yehuda de Jerusalén es muy apreciado por su estilo levantino cocinado a fuego lento. 'El mejor' es subjetivo y se debate con pasión — estos son los más consistentemente recomendados en múltiples fuentes."
  - question: "¿Los puestos de comida callejera en Israel aceptan tarjetas de crédito?"
    answer: "El efectivo sigue siendo muy preferido en la mayoría de los puestos de mercado y locales informales de comida callejera. Muchas hummusiyot y locales de falafel consolidados ahora aceptan tarjetas de débito/crédito, pero no cuentes con ello en puestos de mercado u operaciones muy pequeñas. Lleva ₪100–200 en billetes pequeños para una cómoda sesión de comida callejera. Los cajeros automáticos son abundantes cerca de los principales mercados."
---
...
Esta guía es la respuesta práctica. No es un panorama cultural de la cocina israelí (eso es la [guía de gastronomía israelí](/es/israeli-food-cuisine-guide)) ni un directorio de restaurantes (eso es la [guía gastronómica de Tel Aviv](/es/tel-aviv-food-guide)). Esto es inteligencia de puestos ciudad a ciudad: qué barrios buscar, qué secciones del mercado recorrer y a qué hora llegar antes de que los mejores puestos se agoten.
...
La [guía de gastronomía israelí](/es/israeli-food-cuisine-guide) cubre el panorama nacional completo — especialidades regionales, cultura gastronómica del Shabbat y los platos más allá de los éxitos de la comida callejera. La [guía de comida kosher](/es/kosher-food-guide) explica cómo la kashrut afecta a lo que puedes pedir y dónde. La [guía gastronómica de Tel Aviv](/es/tel-aviv-food-guide) profundiza en los restaurantes de mesa, barrio a barrio. La [guía gastronómica de Jerusalén](/es/jerusalem-food-guide) cubre la escena de restaurantes del Machane Yehuda, el hummus de la Ciudad Vieja y la gastronomía del Shabbat en la ciudad santa. Para la comida matutina específicamente — shakshuka, labneh, bourekas y el despliegue completo del aruchat boker — la [guía del desayuno israelí](/es/israeli-breakfast-guide) cubre dónde comer y qué esperar. Y la [guía de tours gastronómicos y clases de cocina en Israel](/es/israel-food-tours-cooking-classes) cubre la versión organizada — tours por mercados, talleres de cocina y experiencias de degustación para los viajeros que quieren un guía que haga la navegación.
