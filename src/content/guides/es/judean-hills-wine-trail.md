...
ctaHeading: "Reserva una experiencia vinícola en las Colinas de Judea"
affiliateCtas:
  - partner: getyourguide
    title: "Tours de vino en las Colinas de Judea desde Jerusalén"
    description: "Un guía con licencia te lleva a 3–4 bodegas de las Colinas de Judea, gestiona las reservas en productores de cita previa y ofrece comentario experto sobre viticultura israelí, terroir y maridajes. Opciones de medio día y día completo desde el centro de Jerusalén."
    image: /images/regions/jerusalem/hero.jpg
    query: Judean Hills wine tour from Jerusalem
    cta: Ver tours vinícolas
  - partner: discovercars
    title: "Alquila un auto — imprescindible para el circuito autónomo"
    description: "Un auto es el único medio de recorrer el circuito vinícola de las Colinas de Judea de forma autónoma: las bodegas están distribuidas en 30–60 km de laderas boscosas al oeste de Jerusalén, sin transporte público. Designa un conductor sobrio — los límites de alcoholemia en Israel son estrictos. Compara tarifas de todas las agencias de alquiler en Israel."
    image: /images/regions/jerusalem/hero.jpg
    destination: Jerusalem
    cta: Comparar tarifas de alquiler
  - partner: booking
    title: "Hoteles en Jerusalén — base ideal para la excursión vinícola"
    description: "Las Colinas de Judea empiezan a solo 30–40 minutos al oeste del centro de Jerusalén, lo que convierte una excursión vinícola de un día en algo muy práctico. Alójate en Jerusalén para la Ciudad Vieja y los sitios históricos; toma el auto para las colinas y el vino."
    image: /images/regions/jerusalem/hero.jpg
    destination: Jerusalem
    cta: Ver hoteles en Jerusalén
faqs:
  - question: "¿A qué distancia de Jerusalén están las bodegas de las Colinas de Judea?"
    answer: "Las bodegas más cercanas están a 25–35 minutos al oeste del centro de Jerusalén (zona de Shoresh, por la Ruta 1 en dirección a Tel Aviv). Las más alejadas en un circuito vinícola típico — alrededor de Beit Shemesh y Gush Etzion — están a 35–50 minutos. Todas son alcanzables en una excursión de medio día desde la ciudad. Un auto de alquiler es el único medio práctico de visitarlas; no hay transporte público que llegue a las bodegas artesanales."
  - question: "¿Hay que reservar con anticipación en las bodegas de las Colinas de Judea?"
    answer: "Sí — es el punto práctico más importante. La mayoría de las bodegas artesanales de las Colinas de Judea solo reciben con cita previa: Tzora, Flam, Nevo y Sphera no aceptan visitas espontáneas. Chateau Rozé y algunos productores más grandes tienen horarios más flexibles pero igualmente prefieren preaviso. Reserva al menos una o dos semanas antes en temporada alta (primavera mar–may, vendimia sep–oct). No reservar puede resultar en un viaje inútil ante un portón cerrado."
  - question: "¿El vino israelí es kosher?"
    answer: "La mayoría del vino israelí se produce bajo supervisión kosher — la gran mayoría de las bodegas opera en un marco kosher por razones comerciales y culturales. Esto varía según el productor: si el estatus kosher es importante para ti, verifica directamente con la bodega antes de visitar, ya que algunos pequeños productores artesanales no están certificados."
  - question: "¿Hay bodegas con restaurante en las Colinas de Judea?"
    answer: "Varias bodegas ofrecen maridajes de alimentos junto a las catas. Flam Winery ofrece tablas de quesos y embutidos bajo pedido. Tzora Vineyards acompaña a veces sus catas con productos de temporada. Para una comida completa en la zona, el pueblo de Ein Kerem (15 minutos al este, hacia Jerusalén) tiene excelentes restaurantes y cafés — combina una mañana de circuito vinícola con almuerzo en Ein Kerem antes de regresar a la ciudad."
  - question: "¿Qué variedades de uva producen las Colinas de Judea?"
    answer: "Las Colinas de Judea producen una gama de variedades internacionales bien adaptadas a los suelos arcillo-calcáreos de la región y a su altitud (400–900 metros). Cabernet Sauvignon y Merlot son las más plantadas en tinto; Chardonnay, Viognier y Sauvignon Blanc dominan los blancos. Varios productores experimentan con variedades del Ródano (Syrah, Grenache, Mourvèdre) e italianas (Sangiovese, Barbera), con resultados alentadores. La altitud y el clima mediterráneo producen naturalmente mayor acidez y una maduración más fresca que otras regiones vinícolas israelíes a menor altitud."
  - question: "¿Cuándo es la mejor época para visitar las bodegas de las Colinas de Judea?"
    answer: "La primavera (mar–may) es ideal: las viñas están verdes y florecidas, las temperaturas son suaves y muchas bodegas presentan sus nuevas cosechas en cata. La vendimia otoñal (sep–oct) es la época más pintoresca — algunas bodegas permiten a los visitantes observar o participar en la recolección — pero la disponibilidad puede ser limitada ya que los productores están concentrados en la cosecha. El verano (jul–ago) es cálido pero manejable en las colinas; el invierno (dic–feb) es temporada baja, con bodegas reduciendo horarios o pasando a solo-cita. Confirma siempre los horarios actuales antes de salir."
---
...
El circuito de las Colinas de Judea se complementa con el panorama general de la [viticultura israelí](/es/israel-wine-wineries) y la [ruta del vino de Galilea](/es/galilee-wine-trail). Para más ideas de escapadas de un día desde Jerusalén, consulta la [guía de excursiones desde Jerusalén](/es/day-trips-from-jerusalem) y la [guía gastronómica de Jerusalén](/es/jerusalem-food-guide). La [guía de alquiler de autos en Israel](/es/car-rental-israel) y la [guía de conducción en Israel](/es/driving-in-israel) cubren todo lo que necesitas saber para el circuito autónomo.
