---
title: 'Dead Sea Climatotherapy: Medical Tourism & Skin Treatment Guide'
description: 'How Dead Sea climatotherapy treats psoriasis, eczema and vitiligo — the UVB mechanism explained, 3-week medical stays, hotel clinics in Ein Bokek, EU insurance.'
heroImage: /images/regions/dead-sea/hero.jpg
category: Health & Wellness
updatedAt: 2026-07-05
ctaHeading: 'Book your Dead Sea medical stay'
affiliateCtas:
  - partner: booking
    title: 'Dead Sea Spa Hotels — Ein Bokek Medical Resort Strip'
    description: "Ein Bokek's resort hotels range from mid-range to five-star spa properties. Several have on-site dermatology clinics with specialist physicians. Medical-stay guests typically book 21–28 nights — check live availability and multi-week rates."
    image: /images/regions/dead-sea/ein-bokek.jpg
    destination: Ein Bokek Dead Sea
    cta: Browse Dead Sea hotels
  - partner: getyourguide
    title: 'Dead Sea Day Tours from Jerusalem & Tel Aviv'
    description: 'Day tours with hotel pickup, a supervised float session, mineral mud and transfer back. Ideal for leisure visitors or those combining a medical stay with sightseeing in Jerusalem.'
    image: /images/regions/dead-sea/hero.jpg
    query: Dead Sea day tour Jerusalem Tel Aviv float
    cta: Browse Dead Sea tours
faqs:
  - question: What is Dead Sea climatotherapy?
    answer: 'Climatotherapy is the use of a specific climate — in this case the unique atmospheric and environmental conditions at the Dead Sea — as a therapeutic treatment. At the Dead Sea, three factors combine: elevated UVB radiation (caused by the extra atmospheric distance light must travel to reach a point 430 metres below sea level, which filters more UVA than UVB); high atmospheric pressure; and dry air with naturally elevated bromine concentrations. For certain skin conditions, extended supervised exposure to this environment alongside bathing in the hypersaline water produces measurable clinical improvement. It is distinct from a leisure float or spa day — medical climatotherapy involves a structured programme of daily sun exposure under physician monitoring, typically over three to four weeks.'
  - question: Which conditions benefit from Dead Sea climatotherapy?
    answer: 'The strongest clinical evidence relates to psoriasis. Multiple peer-reviewed studies — including large trials published in the Journal of the American Academy of Dermatology and the British Journal of Dermatology — report clearance or significant improvement in 70–90% of patients following a three-to-four week stay. Eczema (atopic dermatitis) and vitiligo also show documented benefit in clinical literature. Psoriatic arthritis patients sometimes find that the low-humidity, low-pollen environment reduces joint flare-ups alongside skin improvement. Results vary substantially between individuals, and remission typically lasts 3–12 months after a successful stay — not permanent. Dead Sea treatment is not a cure; it is a medically recognised form of remission therapy.'
  - question: How long does a Dead Sea medical stay need to be?
    answer: 'Clinical protocols typically require a minimum of three weeks for meaningful remission in psoriasis patients; four weeks is the standard recommended duration. Some patients with mild cases show improvement after two weeks, but most dermatologists advise against stays shorter than 21 days if the goal is full clearance rather than partial improvement. The phototherapy protocol — graduated daily sun exposure starting at 15–20 minutes and building up — takes time to achieve its full effect. Stays shorter than two weeks are generally considered leisure visits rather than clinical treatment.'
  - question: Does European health insurance cover Dead Sea treatment?
    answer: 'Coverage varies considerably by country and insurer. German public health insurers (gesetzliche Krankenversicherung) have historically covered Dead Sea climatotherapy stays under climate-balneotherapy provisions — patients must obtain pre-authorisation (Genehmigung) from their Krankenkasse before travel and bring documentation from their dermatologist. Danish and Swiss public health schemes have covered stays in some cases. UK NHS does not cover Dead Sea treatment. Private health insurance policies in most EU countries vary widely — check your specific policy terms. Reimbursement when it applies typically covers accommodation at a rated medical hotel and the clinic fee; flights and non-medical expenses are usually excluded. The Paula Dead Sea Clinic and other registered medical facilities at Ein Bokek can provide the documentation packages that German and Dutch insurers require.'
  - question: What does a Dead Sea medical stay cost?
    answer: 'Hotel accommodation at Ein Bokek ranges from approximately ₪500–1,200 per night depending on the property and season. Specialist clinic fees typically run ₪300–600 per week (covering dermatologist consultations, daily monitoring and any UVB phototherapy top-up sessions for cloudy days). A four-week stay at a mid-range medical hotel including clinic fees works out to approximately ₪18,000–30,000 (roughly €4,500–7,500 or £3,800–6,300 at mid-2026 exchange rates), excluding flights. Long-stay rates negotiated directly with hotels are often lower than online rack rates — ask hotels about weekly or monthly packages when booking.'
  - question: How does the daily treatment programme work?
    answer: 'A standard climatotherapy programme begins with an initial consultation with the on-site dermatologist, who assesses skin severity and sets the starting sun-exposure duration (typically 15–20 minutes for fair-skinned patients). Exposure time is increased incrementally day by day — sometimes twice daily in morning and late-afternoon sessions. Patients typically bathe in the Dead Sea for 15–20 minutes during or after each exposure session. The mineral-rich water (rich in magnesium, potassium and bromide) has topical anti-inflammatory properties that complement the UVB exposure. Most patients are advised to rest during midday peak UV hours (11:00–15:00) and to apply bland emollients after bathing. Weather permitting, the full protocol runs seven days a week for the duration of the stay.'
  - question: Is the Dead Sea experience difficult or uncomfortable?
    answer: 'For most medical-stay patients the climate is pleasant: dry desert air, consistently low humidity, and warm sunny days even in winter. The main physical adjustment is the heat — summer temperatures at Ein Bokek regularly reach 38–42°C, making June–September stays challenging for some patients. Spring (March–May) and autumn (October–November) are the most comfortable seasons for medical tourists. The Dead Sea water requires care: limit floats to 15–20 minutes per session, keep water away from eyes, and rinse with fresh water after every float. People with extensive open psoriatic lesions should discuss salt-water tolerance with their dermatologist before planning a stay.'
---
...
1. **Consult your dermatologist at home** — obtain a referral letter confirming diagnosis, previous treatments and the recommendation for Dead Sea climatotherapy.
2. **Apply for insurance pre-authorisation** if applicable — submit before booking accommodation; the process can take 2–6 weeks.
3. **Contact the Paula Dead Sea Clinic** (or the medical department of your chosen hotel) directly — confirm the documentation format required, current clinic fees and programme structure.
4. **Book accommodation** — ask the hotel specifically about medical-stay rates for 21+ night stays; these are often not listed online and are negotiated directly.
5. **Plan arrival for a Monday or Tuesday** — this allows you to complete your initial clinical assessment before the weekend and begin the treatment programme without losing days.
...
Most medical-stay patients are in Ein Bokek for three to four weeks. Masada is 25 km south of Ein Bokek — a half-day excursion by cable car that most patients can manage on a rest day. [Ein Gedi Nature Reserve](/ein-gedi-guide) is 20 km north, with easy nature walks and waterfall pools. Jerusalem is 1.5 hours by car — a full-day excursion feasible on a free day during the stay.

For practical leisure planning at the Dead Sea, including beaches, floating tips and transport from Jerusalem, see the [Dead Sea visitor guide](/dead-sea-guide). For accommodation comparisons across the Ein Bokek resort strip, see the [Dead Sea hotels guide](/dead-sea-hotels-guide).
...
For general wellness experiences at the Dead Sea without the medical-stay context — day trips, floating, mud treatments and spa hotels — the [Israel wellness and spa guide](/israel-wellness-spa) and the [Dead Sea visitor guide](/dead-sea-guide) cover everything you need.
