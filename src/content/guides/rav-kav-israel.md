...
ctaHeading: 'Sort your Israel transport before you go'
affiliateCtas:
  - partner: welcomepickups
    title: 'Pre-Book Your Airport Transfer'
    description: 'A driver meets you at arrivals for a fixed all-in fare — no card-loading stress on day one. Available on Shabbat when trains and buses stop running. Ideal for late-night arrivals or if you are staying in Jerusalem from the first night.'
    image: /images/regions/tel-aviv/hero.jpg
    destination: Ben Gurion Airport
    cta: Book a transfer
  - partner: discovercars
    title: 'Car Rental for Beyond the Bus Network'
    description: 'The Rav-Kav covers the cities and coast — for the Galilee, Golan Heights and Negev, a rental car opens up everything the bus network cannot reach. Compare all major companies at Ben Gurion.'
    image: /images/regions/negev/hero.jpg
    destination: Israel
    cta: Compare cars
  - partner: getyourguide
    title: 'Day Tours That Handle Transport For You'
    description: 'Guided day trips to Masada, the Dead Sea, Galilee and beyond — the operator handles all the logistics while you enjoy the view. No timetable juggling, no card-tapping.'
    image: /images/regions/dead-sea/hero.jpg
    query: day tour Israel Jerusalem Tel Aviv
    cta: Browse day tours
faqs:
  - question: Is cash accepted on Israeli buses?
    answer: 'No. Israeli intercity and city buses do not accept cash fares. You must pay with a Rav-Kav card, a contactless bank card, or (on some city routes) a QR code generated through the Israel Railways app. If you arrive without a Rav-Kav, tap your contactless bank card on the reader as a fallback — most modern Visa and Mastercard contactless cards work. But buying a Rav-Kav at Ben Gurion Airport arrivals is still the simpler option for a multi-day trip.'
  - question: Where is the best place to buy a Rav-Kav at Ben Gurion Airport?
  ...
  - question: Do I need to tap off when leaving the bus?
...
*Fares as of 2026; verify current rates at [rail.co.il](https://www.rail.co.il) or [egged.co.il](https://www.egged.co.il) before travel — Israel Railways adjusts fares periodically.*
...
The train does not run on Shabbat (from approximately Friday afternoon to Saturday night, around an hour after sundown). On Shabbat, sherut shared taxis and pre-booked transfers are the alternatives — see the [airport transfers guide](/ben-gurion-airport-transfers) for the full logistics.
...
- [Getting Around Israel: full transport overview](/transportation) — trains, buses, sheruts and Shabbat explained
- [Ben Gurion Airport Guide](/ben-gurion-airport-guide) — arrivals process, lounges, transfers and the airport train connection
- [Driving in Israel](/driving-in-israel) — road rules, tolls and parking for when the Rav-Kav cannot take you
- [Car Rental in Israel](/car-rental-israel) — comparing companies, pickup logistics and booking tips
- [Ben Gurion Airport Transfers](/ben-gurion-airport-transfers) — transfer options including Shabbat alternatives
