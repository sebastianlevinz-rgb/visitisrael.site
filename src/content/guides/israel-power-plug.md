---
title: 'Israel Power Plug Guide: Type H Socket & Which Adapter to Pack'
description: 'Israel uses the unique Type H plug (3 round pins, V-shape). Here is what adapter US, UK and European travellers need — and what voltage to watch out for.'
heroImage: /images/regions/tel-aviv/hero.jpg
category: Planning
updatedAt: 2026-07-23
ctaHeading: 'Sort your Israel trip essentials'
affiliateCtas:
  - partner: airalo
    title: 'Israel eSIM — Stay Connected Instantly'
  ...
  - partner: booking
    ...
    description: 'Israeli hotels throughout the country have Type H sockets and USB-A/C ports in newer rooms. Browse options from Tel Aviv beachfront to Jerusalem boutiques.'
    image: /images/regions/jerusalem/hero.jpg
    destination: Israel
    cta: Search Israel hotels
faqs:
  - question: What plug type does Israel use?
    answer: 'Israel uses Type H — a unique three-pin socket with three round flat pins arranged in a V-shape (or Y-shape, like an upside-down Y). This design is used almost exclusively in Israel and the Palestinian Territories and is found nowhere else in the world. If your plug is not Type H, you need an adapter before you can use Israeli sockets.'
  - question: What voltage does Israel use?
    answer: 'Israel runs on 230V / 50Hz. This is the same voltage used across Europe. US appliances designed for 120V will not work without a voltage converter, but almost all modern electronics — phone chargers, laptops, camera chargers, USB-C chargers — are dual-voltage (marked 100–240V) and work with just a plug adapter, no converter needed. Always check the label on each appliance before packing.'
  - question: Do European plugs work in Israel?
    answer: 'European Type C plugs (the standard two-round-pin plugs used across continental Europe) physically fit into Israeli Type H sockets because the H socket accepts a C plug inserted into its two lower pin holes. In practice this works in most modern Israeli sockets. That said, the fit can feel loose in older sockets — a dedicated Type H adapter is more reliable. UK plugs (Type G, three rectangular pins) do not fit and require an adapter.'
  - question: What adapter do US travellers need for Israel?
    answer: 'US plugs are Type A (two flat parallel pins) or Type B (two flat pins plus a round grounding pin). Neither fits Israeli Type H sockets, so you need a US-to-Israel (Type A/B to Type H) adapter. Buy one before you leave — adapters at Ben Gurion Airport arrivals cost more than ordering online in advance. A universal travel adapter that includes Type H coverage is the most versatile option.'
  - question: Can I buy a plug adapter in Israel?
    answer: 'Yes. Type H plug adapters are sold at Ben Gurion Airport arrivals duty-free shops, at supermarkets (Super-Pharm, Rami Levy, Shufersal), at electronics stores (KSP, Ivory), and in the shopping streets of Tel Aviv and Jerusalem. Prices are typically ₪20–40 for a basic adapter. If you need one urgently on arrival, the Ben Gurion duty-free shop stocks them, though prices are higher than in-city shops.'
  - question: Do Israeli hotels have USB ports in the rooms?
    answer: 'Newer Israeli hotels — particularly branded chains and recently opened properties — typically include USB-A and USB-C charging ports built into the desk or bedside unit, so you may not need an adapter at all for phone charging. Older properties generally have only Type H sockets. If in doubt, pack an adapter: it is small and cheap insurance.'
  - question: Is a voltage converter needed for Israel?
    answer: 'For most travellers: no. Modern phones, laptops, tablets, camera chargers and USB-C devices are universally dual-voltage (100–240V) and only need a plug adapter. Appliances where you should check the label: US-purchased electric hair dryers, electric shavers or hair straighteners — older models may be marked "120V only" and will not work on Israeli power without a voltage converter. The simplest solution is to use the hotel hairdryer (most Israeli hotels provide one) or buy a dual-voltage travel version before you go.'
---
...
1. One universal adapter (with USB-A and USB-C ports) runs all their devices with no country-specific fuss.
2. Or one plug adapter (Type H) for whichever socket type their charger uses.
...
- [Israel eSIM](/israel-esim) — data before you land, no SIM swap or kiosk needed.
- [Ben Gurion Airport guide](/ben-gurion-airport-guide) — arrivals, terminal layout, duty-free and transport.
- [Israel cost and budget guide](/israel-cost-budget) — full trip price guide.
- [First-time visitor guide](/first-time-in-israel) — everything else you need for a first trip.
