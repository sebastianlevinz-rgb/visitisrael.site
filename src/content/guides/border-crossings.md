---
title: 'Israel Border Crossings to Jordan & Egypt: A Practical Guide'
description: 'The three Jordan crossings and the Egypt (Taba) crossing explained — which to use for Petra, Amman and Sinai, plus fees, visas and tips.'
heroImage: /images/regions/eilat/hero.jpg
category: Planning
updatedAt: 2026-05-20
faqs:
  - question: Which border crossing should I use for Petra?
    answer: The Yitzhak Rabin / Wadi Araba crossing at Eilat is the closest to Petra and is used by most Eilat day-trip and overnight tours to Petra. A Jordanian visa can often be arranged on arrival here, and organised tours handle the paperwork.
  - question: Can I cross from Israel to Egypt?
    answer: Yes, at the Taba crossing just south of Eilat, which leads into the Sinai Peninsula (Taba, Nuweiba, Dahab, Sharm el-Sheikh). Entry rules and any Sinai-only permits versus full Egyptian visas depend on your plans and nationality — check current requirements and travel advice first.
  - question: Are the borders open on Shabbat and holidays?
    answer: Crossings have set operating hours that change on Fridays, Saturdays, Jewish holidays and some Islamic holidays. Always check the current hours before you travel, and arrive with plenty of time.
---
...
**Yitzhak Rabin / Wadi Araba (South, by [Eilat](/eilat)).** The gateway to **Petra** and Aqaba. Closest crossing to Petra, used by the popular [Petra day trips and overnight tours from Eilat](/eilat); a Jordanian visa is often available on arrival here, and tour operators arrange it.

**Jordan River / Sheikh Hussein (North, near Beit She'an).** Best for travelling between the [Galilee](/galilee) and northern Jordan or onward to Amman and Jerash.

**Allenby / King Hussein (Central, near Jericho).** The closest crossing to [Jerusalem](/jerusalem) and Amman, and the one used by many West Bank–based travellers. Note that visa-on-arrival rules differ here — confirm in advance.
