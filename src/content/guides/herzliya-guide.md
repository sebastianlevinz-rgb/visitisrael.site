---
title: "Herzliya Guide: Apollonia Ruins, Marina & Acadia Beach (2026)"
description: "Herzliya travel guide: Apollonia National Park cliff ruins, the upscale Marina waterfront, Acadia Beach, and how to reach it from Tel Aviv in 20 minutes."
...
affiliateCtas:
  - partner: getyourguide
    title: "Herzliya & Northern Coast Day Tour from Tel Aviv"
    description: "Combine the clifftop Apollonia ruins with the Herzliya Marina waterfront in one guided day from Tel Aviv — an easy northern Mediterranean coast excursion that most Tel Aviv visitors miss entirely."
...
- **Entry fee:** approximately ₪35–45 per adult; the [Israel National Parks Pass](/israel-national-parks-pass) is valid here and worth buying if you plan to visit several INPA sites on the same trip.
...
For a longer northern coast day, continue from Herzliya north to [Caesarea](/caesarea-guide) for the Roman ruins and harbour (25km, 25–30 min drive), and optionally on to [Netanya](/netanya-guide) for the cliff-top promenade and diamond factory. A [rental car](/car-rental-israel) makes this circuit considerably more flexible than the train.
...
- [Day trips from Tel Aviv](/day-trips-from-tel-aviv) — for how Herzliya fits among other Tel Aviv day-trip options
- [Israel National Parks Pass](/israel-national-parks-pass) — the INPA pass covers Apollonia entry and pays for itself over 2–3 sites
- [Caesarea guide](/caesarea-guide) — the natural next stop north on the coastal route
- [Netanya guide](/netanya-guide) — the larger coastal city 15km further north, with cliff-top promenade and diamond factory
- [Car rental in Israel](/car-rental-israel) — a car makes the northern coast circuit significantly easier
- [Transportation in Israel](/transportation) — for light rail and bus information
