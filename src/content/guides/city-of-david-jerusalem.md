...
affiliateCtas:
  - partner: getyourguide
    title: "City of David & Hezekiah's Tunnel Tour (English)"
    description: "A licensed guide leads you through the City of David archaeological park, into Hezekiah's Tunnel for the wet-route wade, and down to the Pool of Siloam — the full underground Jerusalem experience with historical context. Small English groups; advance booking secures your timed entry."
    image: /images/sub-destinations/jerusalem/city-of-david.jpg
    query: City of David Hezekiah Tunnel guided tour Jerusalem
    cta: Reserve your spot
  - partner: booking
    title: "Hotels near Jerusalem Old City & Dung Gate"
    description: "Staying in the Jewish Quarter or near Jaffa Gate puts the City of David a 10-minute walk away and the rest of the Old City at your door. Booking.com has the widest selection of Jerusalem hotels across all budgets."
    image: /images/regions/jerusalem/hero.jpg
    destination: Jerusalem, Israel
    cta: Browse Jerusalem hotels
faqs:
  - question: Is the City of David the same as Silwan?
    answer: "They overlap geographically. The City of David archaeological park — administered by the Israel Nature and Parks Authority (INPA) and the Elad Foundation — sits on the ridge south of the Temple Mount, within the Palestinian east Jerusalem neighborhood of Silwan. The 'City of David' refers specifically to the ancient Iron Age and Bronze Age site and its archaeology. 'Silwan' refers to the contemporary residential community of around 50,000 Palestinian residents surrounding the park. Both names are accurate for their respective referents. The dual-naming context is worth understanding before you visit."
  - question: Do I need advance tickets for the City of David?
    answer: "Yes, particularly for Hezekiah's Tunnel. Timed-entry slots for the wet tunnel route fill up from May through September and on Jewish and Christian public holidays. Book through cityofdavid.org.il or via a licensed tour operator on GetYourGuide or Viator. The archaeological park surface area (without the tunnel) generally does not require advance booking, but the tunnel entry almost always does in high season."
  - question: What is the difference between the wet and dry tunnel routes?
    answer: "Hezekiah's Tunnel (the wet route) is a 533-metre underground channel that still carries spring water — visitors wade ankle-to-knee-deep in cold water in near-darkness for about 45 minutes. It requires water shoes, a head-torch, and a dry change of socks. The Canaanite Tunnel (the dry route) is a shorter Bronze Age passage with partial electric lighting that reaches the Pool of Siloam without water. The dry route is accessible to visitors who are claustrophobic, have mobility limitations, or do not want to get wet. Both routes reach the Pool of Siloam at the southern end."
  - question: Is the City of David covered by the Israel National Parks Pass?
    answer: "No — the City of David is NOT an INPA-managed site in the standard sense and the Israel National Parks Pass (orange or green) is not valid here. The site is managed jointly by INPA and the Elad Foundation under a separate ticketing system. Do not assume your parks pass covers entry; purchase tickets directly at cityofdavid.org.il."
  - question: Is the City of David suitable for children?
    answer: "Yes, with caveats. Children typically love Hezekiah's Tunnel — the wading experience is genuinely memorable. The minimum height for the wet tunnel is approximately 100–110 cm (children must be tall enough that their heads clear the water). Non-swimming children must wear a life jacket, available at the site. The dry tunnel is fully suitable for younger children. The surface archaeological park is engaging for older children with a guide; younger children may find the signage-only experience less compelling."
  - question: How do I get to the City of David from the Western Wall?
    answer: "The City of David entrance is a 5-minute walk south from Dung Gate — the same gate used to enter the Western Wall plaza. From the Western Wall plaza itself, exit via Dung Gate, turn left on Maalot Ir David Street, and follow the signs downhill into Silwan; the visitor entrance is clearly marked. Combining the Western Wall and City of David in a single morning is practical and complementary — the Herodian Drainage Channel inside the park exits back up near the Old City walls, making a natural loop."
---
...
| | |
|---|---|
| **Entry** | Ticketed — ~₪45 standard; ~₪65 with Pool of Siloam + Herodian Drainage Channel (verify at cityofdavid.org.il) |
...
See our [Western Wall Tunnels guide](/western-wall-tunnels-guide) for booking the companion experience.
...
For dress code requirements at the adjacent Western Wall and other holy sites, see our [holy sites dress code guide](/holy-sites-dress-code-etiquette).

For the full context of Jerusalem's Jewish archaeological heritage, see [Jewish heritage sites in Israel](/jewish-heritage-israel). For Christian pilgrimage context — including the Pool of Siloam healing narrative and its place on pilgrimage itineraries — see our [Christian pilgrimage guide](/christian-pilgrimage-holy-land).
...
For a full overview of Jerusalem archaeology, underground sites, and walking tour options, see our [Jerusalem Old City walking tour guide](/jerusalem-old-city-walking-tour).
