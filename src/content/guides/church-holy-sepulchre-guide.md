...
verdictName: 'a guided Via Dolorosa and Holy Sepulchre tour'
verdictQuery: 'Via Dolorosa Church Holy Sepulchre guided tour Jerusalem'
ctaHeading: 'Book a guided Via Dolorosa & Holy Sepulchre tour'
affiliateCtas:
  - partner: getyourguide
    title: 'Via Dolorosa & Church of the Holy Sepulchre Walking Tour'
  ...
  - partner: abraham
    ...
    description: 'Small-group Old City walk with Abraham Tours covering the Jewish Quarter, Western Wall, Via Dolorosa, and Church of the Holy Sepulchre — one of Israel''s most trusted operators in a half-day format.'
    image: /images/regions/jerusalem/hero.jpg
    query: Jerusalem Old City walking tour Abraham Tours Holy Sepulchre
    cta: Book with Abraham
faqs:
  - question: Is the Church of the Holy Sepulchre free to visit?
    answer: 'Yes. The church does not charge admission; entry is free every day of the year. The only costs associated with visiting are optional — a tip to the doorkeepers, the Franciscan Friday procession collection, or a guided tour. The Edicule (Tomb) queue is free; you do not need a ticket or reservation to enter the main basilica.'
  - question: What time should I visit to avoid the Edicule queue?
    answer: 'Arrive at the 04:00 dawn opening for a near-empty church and virtually no queue. By 09:00 the Edicule line is 30–45 minutes; from 10:00 to 14:00 the wait typically reaches 60–90 minutes. After 17:00 the crowds thin considerably. If you cannot visit at dawn, the late afternoon (17:00–19:00) is the next-best window. Friday afternoons bring the Franciscan procession crowd (around 15:00), which temporarily fills the nave.'
  - question: What is the Status Quo of 1852?
    answer: 'The Status Quo is an Ottoman imperial decree of 1852, confirmed by later British and Israeli authorities, that fixes which Christian denomination controls which part of the Holy Sepulchre. Six denominations share access: Greek Orthodox (the largest custodian), Roman Catholic (Franciscan Order), Armenian Apostolic, Coptic Orthodox, Syriac Orthodox, and Ethiopian Tewahedo. The agreement specifies who can clean which flagstone, hang which lamp, and even who unlocks the main door — a task still performed each morning by the Muslim Joudeh and Nuseibeh families, continuing a tradition from the time of Saladin.'
  - question: Can I photograph inside the Church of the Holy Sepulchre?
    answer: 'Photography is permitted in the main basilica, Calvary Chapels, and the Edicule interior. Flash is prohibited inside the Edicule tomb chamber. Do not photograph during active liturgical services — if a denomination''s clergy is conducting a service, lower your camera until it concludes. Tripods and commercial video shoots require advance permission from the relevant denomination''s administration.'
  - question: What should I wear to the Holy Sepulchre?
    answer: 'Covered shoulders and knees are strictly required — doorkeepers actively enforce the dress code. Hats must be removed once inside the basilica (no headwear for men). Loose scarves or a wrap carried in your daypack solve the problem easily; inexpensive cotton shawls are also sold from street vendors near Jaffa Gate. Flat, closed shoes with grip are strongly recommended — the ancient stone floors are uneven and sometimes slippery.'
  - question: How long does a visit take?
    answer: 'A focused visit covering the Stone of Unction, Calvary Chapels, and the main rotunda (without the Edicule queue) takes about 45 minutes. Add 45–90 minutes for the Edicule queue at peak time, or 10–15 minutes if you arrive at dawn. The Chapel of Saint Helena and the Ethiopian Monastery rooftop each add another 15–20 minutes. Plan 1.5 to 2 hours total for a thorough visit; add more time if you are attending a liturgical service.'
  - question: How do I get to the Church of the Holy Sepulchre?
    answer: 'The church is inside the Christian Quarter of the Old City, about a 10-minute walk from Jaffa Gate. Enter through Jaffa Gate (light rail Line 1, or taxi from West Jerusalem), walk down David Street and follow signs through the Christian Quarter. From the Western Wall plaza, the walk through the Muslim Quarter or Jewish Quarter takes about 10–15 minutes. There is no car access; all routes are on foot through the Old City.'
---
...
See the [Jerusalem Old City self-guided walking tour](/jerusalem-old-city-walking-tour) for the complete route integrating the Via Dolorosa with all four quarters.
...
**Cross-links:** [Jerusalem](/jerusalem) · [Jerusalem Old City Self-Guided Walking Tour](/jerusalem-old-city-walking-tour) · [Temple Mount / Haram al-Sharif Visitor Guide](/temple-mount-visitor-guide) · [1-Day Jerusalem Itinerary](/1-day-jerusalem-itinerary) · [Jerusalem Tours Compared](/jerusalem-tours-compared) · [Holy Sites Dress Code Guide](/holy-sites-dress-code-etiquette) · [Western Wall](/jerusalem/western-wall) · [Mount of Olives](/jerusalem/mount-of-olives) · [Where to Stay in Jerusalem](/where-to-stay/jerusalem) · [Day Trips from Jerusalem](/day-trips-from-jerusalem)
