...
affiliateCtas:
  - partner: booking
    title: 'New Luxury Hotels in Tel Aviv 2026'
    description: 'Six Senses Tel Aviv, Nobu Hotel Tel Aviv and the year''s boutique openings — live availability and current rates. Confirm status before booking: 2026 new openings can have phased launches.'
    image: /images/regions/tel-aviv/hero.jpg
    destination: Tel Aviv
    cta: Search new hotels in Tel Aviv
  - partner: booking
    title: 'New Hotels Across Israel 2026'
    description: 'Herzliya Marina, Dead Sea eco-resort, Safed boutique and Beersheba heritage hotel — search Israel''s 2026 openings across every region. Filter by date on Booking.com for the most current listings.'
    image: /images/regions/dead-sea/hero.jpg
    query: new hotel Israel 2026
    cta: Browse new hotels across Israel
  - partner: getyourguide
    title: 'Tel Aviv Luxury Experiences'
    description: 'Private Carmel Market chef sessions, White City architectural walks, rooftop cocktail evenings — curated experiences that complement a new luxury hotel stay in Tel Aviv.'
...
Israel's hotel market entered its most active expansion phase in two decades in 2026. Seventeen new properties opened in a single year — bringing the country's first [Six Senses](https://www.sixsenses.com/en/hotels/tel-aviv), the debut of the Nobu Hotel brand in the region, a full marina resort at Herzliya, and a wave of character-led boutique openings from Safed to Beersheba. This guide covers what has opened, what makes each property distinctive, and what honest caveats apply before you book.
...
| Property | Location | Style |
|---|---|---|
| Six Senses Tel Aviv | Rothschild Blvd, Tel Aviv | Ultra-luxury wellness |
| Nobu Hotel Tel Aviv | Jaffa, Tel Aviv | Lifestyle luxury |
