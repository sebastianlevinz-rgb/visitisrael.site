...
ctaHeading: 'Find a licensed guide for your trip'
affiliateCtas:
  - partner: getyourguide
    title: 'Private Licensed Guide — All of Israel'
    description: 'Browse private, Ministry of Tourism-licensed guides for Jerusalem, the Galilee, the Dead Sea and multi-day tours across Israel. Your own guide, vehicle and pace — filter by language, specialism and group size.'
    image: /images/regions/jerusalem/hero.jpg
    query: Israel private licensed guide
    cta: Browse private guides
  - partner: viator
    title: 'Private Licensed Guide — Jerusalem & the West Bank'
    description: 'Private licensed guides for the Jerusalem Old City, the Western Wall Tunnels, Yad Vashem and Bethlehem day trips. Expert-led, Ministry-certified — the deepest way to see the holy city.'
    image: /images/regions/jerusalem/old-city.jpg
    query: Jerusalem private guide licensed
    cta: See Jerusalem guides
  - partner: getyourguide
    title: 'Private Licensed Guide — Tel Aviv & Tel Aviv–Jaffa'
    description: 'Private licensed guides for Tel Aviv''s White City Bauhaus architecture, Old Jaffa, the Carmel Market and the port neighbourhood — half-day or full-day, your pace.'
    image: /images/regions/tel-aviv/hero.jpg
    query: Tel Aviv private licensed guide
    cta: Browse Tel Aviv guides
faqs:
  - question: Is a licensed tour guide in Israel required by law?
    answer: 'A Ministry of Tourism licence is legally required to guide at specific national heritage sites, the Western Wall Tunnels, Masada''s archaeological zone, some Old City sites and certain national parks. At open-air public spaces — a city walk, a market tour, a beach — any competent local can lead a tour without a licence. If access to protected archaeological or religious sites is part of your itinerary, verify the guide holds a current Ministry licence.'
  - question: How do I verify that a tour guide is licensed?
    answer: 'Request the guide''s Ministry of Tourism licence number before booking and cross-check it on the official Ministry of Tourism licensed-guides registry (find it at tourism.gov.il). Licensed guides carry a physical photo-ID badge — blue badge for fully certified, orange for trainee status. If a guide declines to provide their licence number or a badge is not forthcoming on the day, that is a red flag.'
  - question: How much does a private licensed tour guide cost in Israel?
...
5. **Are site entry fees included in your quote?** — Masada, Beit Guvrin, the Western Wall Tunnels, Yad Vashem and other sites have separate entry fees (some waived with the [Israel National Parks Pass](/israel-national-parks-pass)). Confirm whether the guide's rate covers these or whether you pay at the gate.
...
For the full picture on private guided experiences across Israel, see the [private and luxury tours guide](/private-tours-israel). For ranked tour operators running group packages, see [best tours in Israel](/best-tours-in-israel). To understand the comparative cost of guided vs self-driven travel, see [car rental in Israel](/car-rental-israel) and the [Israel trip cost calculator](/israel-trip-cost-calculator).
