...
affiliateCtas:
  - partner: getyourguide
    ...
    description: 'Guided day tours to the Dead Sea from Jerusalem or Tel Aviv — hotel pickup, guided float session and time at the mineral mud stations. Many include Masada or Ein Gedi.'
    image: /images/regions/dead-sea/ein-bokek.jpg
    query: Dead Sea day tour Jerusalem Tel Aviv
    cta: Browse Dead Sea tours
  - partner: viator
    title: 'Dead Sea + Masada Sunrise Tours'
    description: 'Combine the Dead Sea float with Masada — either the dawn Snake Path hike or the cable-car daytime version. Round-trip from Jerusalem or Tel Aviv with guide and hotel pickup.'
    image: /images/regions/dead-sea/masada.jpg
    query: Dead Sea Masada tour Israel
    cta: See Masada + Dead Sea tours
  - partner: booking
    title: 'Dead Sea Hotels — Ein Bokek Resort Strip'
    description: "Stay a night at the Dead Sea and catch the sunrise over the water — Ein Bokek's resort strip has options from budget to spa luxury, all steps from the shore."
    image: /images/regions/dead-sea/ein-bokek.jpg
    query: Ein Bokek Dead Sea hotel
    cta: Browse Dead Sea hotels
verdictName: a Dead Sea day trip
verdictQuery: Dead Sea day tour Israel
faqs:
  - question: How long should you float in the Dead Sea?
    answer: 'Most dermatologists recommend limiting your first float to 15–20 minutes. The extreme salt concentration (roughly 34% dissolved minerals — about ten times the Mediterranean) draws moisture from your skin rapidly. Rinse off with fresh water immediately after you exit. Repeat dips are fine, but give your skin 20 minutes to recover between sessions. Never stay in more than 30 minutes in a single session.'
  ...
  - question: Can you combine the Dead Sea with Masada on the same day?
    answer: 'Yes — this is the classic Dead Sea day-trip combination. Masada is 20 minutes south of Ein Bokek on Route 90. The conventional order is Masada first (sunrise hike or cable car, done by 11:00) and the Dead Sea float afterward, when the heat of the day makes the water more appealing. Allow at least 5–6 hours total for the combination. Guided day tours from Jerusalem and Tel Aviv handle the logistics — see our Masada & Dead Sea day trip guide for the full breakdown.'
---
...
The most straightforward route is Route 1 east from Jerusalem, then Route 90 south toward Ein Bokek. The drive to Kalia Beach is around 80 km and takes approximately 50–60 minutes outside rush hour. To Ein Bokek it is approximately 90 km, 70–75 minutes. A rental car gives you the most flexibility — see our [car rental guide](/car-rental-israel).
...
Ein Bokek has options across a range of budgets: mid-range resort hotels with pool access, and higher-end spa hotels with full treatment programmes. Book earlier than usual for school holiday periods (especially Passover and Sukkot) when the resort strip fills weeks in advance. For specific hotel picks at each price tier, seasonal pricing and booking tips, see the [Dead Sea hotels guide](/dead-sea-hotels-guide). For a broader overview of the Dead Sea wellness experience alongside Tiberias hot springs and hammam traditions elsewhere in Israel, see the [Israel wellness and spa guide](/israel-wellness-spa). If you have psoriasis, eczema or vitiligo, our [Dead Sea medical tourism guide](/dead-sea-medical-tourism) covers the full climatotherapy programme — the UVB mechanism, 3-week medical stays, hotel clinics and EU insurance reimbursement.

---

## Combining the Dead Sea with Masada

The natural pairing. [Masada](/dead-sea/masada) is 20 km south of Ein Bokek on Route 90, making a combined day straightforward. The conventional sequence:

1. **Sunrise at Masada** — hike the Snake Path in darkness, arriving at the summit for first light (approximately 45–60 minutes up). Or take the cable car from 08:00 for the daytime version.
2. **Morning in Masada** — explore the plateau (2–3 hours), descend by cable car or on foot.
