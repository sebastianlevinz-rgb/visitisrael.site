...
verdictName: 'the Red Canyon hike near Eilat'
verdictQuery: 'Red Canyon Eilat hike slot canyon Israel'
ctaHeading: 'Explore the Eilat Mountains by jeep or car'
affiliateCtas:
  - partner: discovercars
    title: 'Rent a Car for the Red Canyon & Eilat Mountains'
    description: 'Red Canyon is 20 km from central Eilat on Highway 12 — a straightforward drive in any rental car. A car also opens up a same-day combination with Timna Park (45 km north) or Hai Bar Yotvata wildlife reserve. Compare rates from Eilat city and Ramon Airport.'
    image: /images/sub-destinations/eilat/red-canyon.jpg
    query: car rental Eilat Israel Eilat Mountains
    cta: Compare Eilat car hire
  - partner: getyourguide
    title: 'Eilat Mountains Jeep Safari — Red Canyon & Timna'
    description: 'Guided 4x4 jeep safaris from Eilat city combine the Red Canyon slot canyon hike with Timna Park rock formations and panoramic desert views. Guides know the flash-flood forecast and the best photography positions inside the narrows.'
    image: /images/regions/eilat/hero.jpg
    query: Eilat Mountains jeep safari Red Canyon Timna Park
    cta: Browse Eilat jeep tours
faqs:
  - question: Is Red Canyon suitable for children?
    answer: 'Age 8 and up with reasonable agility is the practical threshold for most families. The canyon has 3–4 sections with metal rungs and short ladders (1–2 metres each) where you descend into the narrows — a nervous or very young child will struggle at those points. Confident older children and teenagers handle it easily. Note that there is no way to skip the ladder sections on the main circuit; if your child has a significant fear of heights, opt for the short approach trail to the canyon rim instead, which gives excellent views without the descent. Never bring young children if there is any possibility of rain upstream — flash floods are the serious risk.'
  - question: Can I reach Red Canyon without a car?
...
**The no-go rule:** If the [Israel Meteorological Service](https://ims.gov.il) forecast for the Eilat Mountains or southern Negev shows any rain probability for your day of visit, **do not enter the canyon narrows**. The canyon rim walk gives excellent views without entering. This is not an overcautious rule — it is the correct interpretation of the risk.
