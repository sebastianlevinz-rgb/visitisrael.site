...
ctaHeading: "Book beachfront accommodation & Tel Aviv activities"
affiliateCtas:
  - partner: booking
    title: "Beachfront Hotels in Tel Aviv"
    description: "The best hotels on the Tel Aviv Tayelet put you directly on the sand — from boutique Bauhaus properties on Dizengoff to full-service beach resorts. Live rates, no fabricated prices."
    image: /images/regions/tel-aviv/beaches.jpg
    destination: Tel Aviv
    cta: Browse beachfront hotels
  - partner: getyourguide
    title: "Tel Aviv Beach Experiences & Bike Rentals"
    description: "Sunrise kayaking, sunset sailing from Jaffa Port, guided beach-to-market walks, and Tel-O-Fun bike hire to ride the full 14 km promenade. Book ahead for summer mornings."
    image: /images/regions/tel-aviv/beaches.jpg
    query: Tel Aviv beach kayak cycling bike tour sunset
    cta: Browse beach activities
faqs:
  - question: Are Tel Aviv's beaches free?
    answer: "Yes. All of Tel Aviv's public beaches are free to access — no entry fee, no reservation. The 14 km beachfront from the Yarkon river mouth to Old Jaffa is continuously open public space. Sun loungers and umbrellas can be rented from vendors on the main city beaches for roughly ₪30–50 per day. Only private hotel beaches (restricted to guests) are an exception to the free rule."
  - question: Which is the best beach in Tel Aviv for first-time visitors?
    answer: "Gordon Beach or Frishman Beach. They sit side by side in the heart of the tourist-hotel zone, are consistently well-maintained, and have everything you need within walking distance — showers, changing rooms, summer lifeguards, volleyball courts, and a promenade lined with cafes. For a quieter alternative on the same trip, Alma Beach near Jaffa is a short walk south and noticeably less crowded."
  - question: What is Hilton Beach Tel Aviv known for?
    answer: "Hilton Beach has been Tel Aviv's recognised LGBTQ+ community beach since the 1980s — consistently welcoming, inclusive and lively, with an especially strong atmosphere on weekend afternoons. The northern end of Hilton Beach is also one of the few Tel Aviv beaches where dogs are permitted. It sits slightly north of the main hotel strip, which keeps it a little less crowded than Gordon or Frishman on peak summer weekends."
  - question: When is jellyfish season in Tel Aviv?
    answer: "Jellyfish blooms typically occur along the Israeli Mediterranean coast from July through October, peaking in August and September. The blooms are irregular — some weeks are clear, others are not. The best check is to ask the lifeguards on duty when you arrive; they will know current sea conditions. Tel Aviv municipality also posts daily beach status updates. Jellyfish stings are unpleasant but rarely dangerous; urinating on a sting is a myth — rinse with seawater, not fresh water, and ask the lifeguard station for first-aid cream."
  - question: Can I surf at Tel Aviv beaches?
    answer: "Yes. Jerusalem Beach (also called Geula Beach or Bograshov) has the most consistent wave break of the Tel Aviv city beaches and several surf schools operate from it — TLV Surf Club and a few independent operators offer lessons and board hire for approximately ₪80 per hour. The Mediterranean swell is mild compared to Atlantic surf destinations, but there is enough break to learn on. Summer months have lighter surf; autumn and winter swells are stronger. Gordon Beach also has a paddleboarding scene from its northern end."
  - question: What is the Nordau Beach gender separation schedule?
    answer: "Nordau Beach operates a religiously observant separated bathing schedule, with men and women in designated sections on a rotating daily timetable. The specific days and hours change seasonally and are published by the Tel Aviv municipality — always check the current schedule at tel-aviv.gov.il before visiting, as visiting on the wrong day for your section means you will need to go to a different beach. Nordau is otherwise a clean, well-maintained beach and entirely welcoming to observant Jewish, Muslim and other visitors who prefer separated bathing."
---
...
From Banana Beach, the [Jaffa port](/jaffa-travel-guide) and the [Jaffa flea market](/jaffa-travel-guide) are a short walk south. This makes Banana an efficient choice if you want to combine a beach morning with an afternoon exploring Old Jaffa.
...
From Alma Beach, [Old Jaffa](/jaffa-travel-guide) and the clock tower are visible to the south, and [Kerem HaTeimanim](/kerem-hateimanim-tel-aviv) is a short walk inland. This is the natural endpoint of a long Tayelet walk from the hotel zone or a good starting point for a Jaffa afternoon.
...
- **By bike** from anywhere in central Tel Aviv: the Tayelet has a dedicated cycling lane running the full length. [Tel-O-Fun bike-share](/cycling-in-israel) stations are dotted throughout the beachfront.
...
Shabbat does affect **getting to** the beach from outside Tel Aviv: intercity buses and trains stop from Friday afternoon until Saturday night. If you are day-tripping from Jerusalem or elsewhere, check your return transport options before you go — see the [Shabbat guide](/shabbat-guide) and [transport routes](/transportation) for specifics.
...
- Combine a beach morning with a [Jaffa](/jaffa-travel-guide) afternoon: 20 minutes south along the Tayelet.
- The [Carmel Market](/tel-aviv-carmel-market) is 15 minutes' walk inland from the central beach zone — a good pre-beach stop for fruit, snacks and cheap beach groceries on weekday mornings.
- For the full picture of Tel Aviv neighbourhoods beyond the beach strip, see the [Tel Aviv neighborhoods guide](/tel-aviv-neighborhoods-guide).
- For beaches outside Tel Aviv — Eilat Red Sea, Herzliya, Sea of Galilee — see the [Israel beaches guide](/best-beaches-israel).
