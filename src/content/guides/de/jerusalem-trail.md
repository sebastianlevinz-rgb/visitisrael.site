...
ctaHeading: 'Jerusalem Wanderweg: Touren & Ausrüstung buchen'
affiliateCtas:
  - partner: getyourguide
    title: 'Geführte Wanderungen in den Hügeln Jerusalems'
    description: "Geführte Tageswanderungen durch die Hügel rund um Jerusalem — Ein Kerem, Ramat Rachel, den Ölbergkamm und den Rand der Judäischen Wüste. Einheimische Guides vermitteln Streckengeschichte, Wildblumenbestimmung und historischen Kontext, den keine Karte bieten kann."
    image: /images/regions/jerusalem/hero.jpg
    query: Jerusalem hiking tour nature trail
    cta: Jerusalem-Wanderungen entdecken
  - partner: booking
    title: 'Hotels in Jerusalem'
    description: 'Übernachten Sie zentral in Jerusalem — die Hotels der Innenstadt liegen 3–5 km von jedem der vier Abschnitte entfernt. Filtern nach Stadtviertel (City Center, Deutsches Viertel, Ostjerusalem) und Gästebewertung für die ideale Ausgangsbasis.'
    image: /images/regions/jerusalem/hero.jpg
    destination: Jerusalem
    cta: Hotels in Jerusalem suchen
  - partner: discovercars
    title: 'Mietwagen für die Abschnitt-Startpunkte'
    description: "Ein Mietwagen macht die Abschnittswanderung sehr komfortabel: Fahren Sie zum Startpunkt, wandern Sie, kehren Sie von einem anderen Endpunkt zurück. Besonders praktisch für die südlichen Abschnitte mit geringerem Busangebot."
    image: /images/regions/jerusalem/hero.jpg
    query: Jerusalem Israel car hire
    cta: Mietwagenpreise vergleichen
faqs:
  - question: "Was ist der Jerusalem Wanderweg?"
    answer: "Der Jerusalem Wanderweg (Shvil Yerushalayim auf Hebräisch) ist ein markierter Rundwanderweg von etwa 42 km, der Jerusalem vollständig umrundet. Er wurde von der Stadtgemeinde Jerusalem und der Gesellschaft zum Schutz der Natur in Israel (SPNI) entwickelt und ist in vier Tagesetappen unterteilt: die Westhügel, der südliche Kamm über Bethlehem, der östliche Ölbergkamm und der nördliche Bogen durch die Stadtquartiere."
  - question: "Wie lange dauert der Jerusalem Wanderweg?"
    answer: "Die vollständige Runde wird in der Regel in 2–3 Tagen bei Durchgehendwanderung absolviert. Die meisten Wanderer gehen vier separate Tagesetappen à 4–7 Stunden einschließlich Pausen. Das Gesamthöhenprofil über alle vier Abschnitte beträgt rund 1.200 m Aufstieg."
  - question: "Ist der Jerusalem Wanderweg gut markiert?"
    answer: "Ja. Der Weg nutzt das israelische Standard-Markierungssystem — abwechselnd grün, weiß und blau gestrichene Streifen auf Felsen, Mauern, Bordsteinen und Pfosten in Abständen von etwa 100 m. In urbanen Abschnitten (besonders Segment 4) erfordert die Navigation etwas mehr Aufmerksamkeit. hike-israel.com pflegt aktuelle Streckenbedingungen und Umleitungen."
  - question: "Braucht man eine Genehmigung für den Jerusalem Wanderweg?"
    answer: "Nein. Der Weg ist ganzjährig kostenlos geöffnet. Die Abschnitte entlang der Sperranlage im Süden erfordern Einhaltung der markierten Grenzen — der Weg verläuft vollständig in Israel oder Ostjerusalem und quert nicht die Westbank."
  - question: "Wann ist die beste Zeit für den Jerusalem Wanderweg?"
    answer: "März bis Mai ist ideal: kühle Temperaturen, lange Lichtstunden und Wildblumen (Anemonen, Zyklamen und Lupinen) auf den offenen Hängen. Oktober bis November ist das zweitbeste Fenster. Juli und August: extreme Mittagshitze (30–35°C in den Hügeln) — frühzeitiger Start vor 7 Uhr empfohlen. Im Winter (Dezember–Februar) sind Regen und gelegentlicher Schnee möglich."
  - question: "Sind die Startpunkte mit dem ÖPNV erreichbar?"
    answer: "Ja, für die meisten Abschnitte. Abschnitt 1 (Yad Vashem) und Abschnitt 4 (Ammunition Hill) sind direkt mit der Stadtbahn erreichbar. Die Abschnitte 2 und 3 haben ländlichere Startpunkte mit weniger Busverkehr — Taxi oder Mietwagen vereinfacht den Zugang."
  - question: "Wie unterscheidet sich der Jerusalem Wanderweg vom Israelischen Nationaltrail?"
    answer: "Der Israelische Nationaltrail (Shvil Yisrael) ist eine 1.000-km-Durchquerung von Eilat bis Dan, die Jerusalem passiert. Der Jerusalem Wanderweg ist eine eigenständige 42-km-Schleife um die Stadt. Viele DAV-erfahrene Fernwanderer gehen den Jerusalem Wanderweg als Ausflug vor oder nach dem Nationaltrail."
---
...
**Weitere Informationen:** [Wandern in Israel](/de/hiking-in-israel) · [1 Tag Jerusalem](/de/1-day-jerusalem-itinerary) · [Tagesausflüge von Jerusalem](/de/day-trips-from-jerusalem) · [Beste Touren in Israel](/de/best-tours-in-israel)
