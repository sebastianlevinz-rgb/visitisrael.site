---
title: "Selbstgeführte Stadtführung durch die Altstadt von Jerusalem (2026)"
description: "Erkunden Sie alle vier Viertel der Altstadt von Jerusalem: Schritt-für-Schritt-Route vom Jaffa-Tor durch das Armenische, Jüdische und Christliche Viertel, die Klagemauer und die Via Dolorosa."
heroImage: /images/regions/jerusalem/old-city.jpg
category: Touren
updatedAt: 2026-06-30
verdictName: "eine geführte Jerusalem-Altstadttour"
verdictQuery: Jerusalem Old City four quarters walking tour
ctaHeading: "Buchen Sie eine geführte Altstadttour"
affiliateCtas:
  - partner: getyourguide
    title: "Jerusalem-Altstadttour durch alle vier Viertel"
  ...
  - partner: abraham
    ...
    description: "Kleingruppenspaziergang durch die Altstadtmauern mit Abraham Tours — einem der vertrauenswürdigsten Anbieter Israels. Umfasst das Jüdische Viertel, die Klagemauer, das Muslimische Viertel und die Grabeskirche im Halbtagsformat."
    image: /images/regions/jerusalem/hero.jpg
    query: Jerusalem Old City walking tour Abraham Tours
    cta: Mit Abraham buchen
faqs:
  - question: "Wie lange dauert die Jerusalem-Altstadtführung?"
    answer: "Die selbstgeführte Hauptroute — vom Jaffa-Tor durch das Armenische, Jüdische und Christliche Viertel, den Klagemauer-Platz, das Muslimische Viertel und die Grabeskirche — dauert 4 bis 5 Stunden in einem gemäßigten Tempo, das Zeit in den wichtigsten Stätten einschließt. Fügen Sie jeweils 30 Minuten für die Cardo-Ausgrabungen, den Turm Davids oder den Stadtmauerweg hinzu, wenn die Bedingungen es erlauben. Planen Sie einen ganzen Vormittag oder Nachmittag ein, keine kurze Stippvisite."
  - question: "Brauche ich einen Guide für die Altstadt von Jerusalem?"
    answer: "Ein Guide bietet in der Altstadt erhebliche Tiefe, wo die historischen, religiösen und architektonischen Schichten dicht sind. Die selbstgeführte Route unten ist jedoch mit einer Papierkarte oder einer Offline-Karten-App navigierbar: Die Straßen sind auf Englisch, Hebräisch und Arabisch ausgeschildert, und die wichtigsten Sehenswürdigkeiten sind gut markiert. Wenn Sie zum ersten Mal hier sind und nur einen Tag haben, ist eine Führung den Preis wert — Ihr Guide besitzt Kontext, den keine Beschilderung vermitteln kann."
  - question: "Kann ich die Altstadttour am Schabbat machen?"
    answer: "Ja. Die Altstadt ist jeden Tag einschließlich Schabbat geöffnet. Das Jüdische Viertel ist samstags ruhiger — viele Geschäfte und das Cardo-Museum sind geschlossen — aber der Klagemauer-Platz ist zugänglich und oft mit Betern belebt. Die Grabeskirche, der Souk des Muslimischen Viertels und das Armenische Viertel sind alle geöffnet. Der Samstagnachmittag ist in der Regel weniger überfüllt als die Wochentags-Stoßzeiten."
  - question: "Ist der Tempelberg in der Altstadttour enthalten?"
    answer: "Der Tempelberg (Haram al-Sharif) liegt angrenzend an die Route, ist aber NICHT in einer selbstgeführten Standardtour für Nicht-Muslime enthalten. Nicht-muslimische Besucher können nur durch das Mugrabi-Tor eintreten, zu begrenzten Wochentagszeiten (ungefähr Dienstag und Mittwoch, 7:30–11:00 Uhr und 13:30–14:30 Uhr). Der Einlass ist selbst während dieser Zeitfenster nicht garantiert und die Zeiten ändern sich ohne Vorankündigung. Planen Sie Ihren Reiseplan nicht um den Tempelbergzugang herum — behandeln Sie ihn als möglichen Bonus, nicht als geplante Station."
  - question: "Was sollte ich bei der Jerusalem-Altstadtführung tragen?"
    answer: "Bedeckte Schultern und Knie sind für den Zugang zum Klagemauer-Platz und zur Grabeskirche erforderlich. Abdeckungen (Schals, Schulterumhänge) sind kostenlos am Klagemauer-Eingang für Besucher erhältlich, die sie benötigen. Bequeme Wanderschuhe mit gutem Halt sind wichtig: die Altstadtstraßen sind vollständig gepflastert und uneben. Im Sommer Hut und Wasser mitbringen — Schatten ist im Souk minimal und der Stadtmauerweg ist vollständig ungeschützt."
---
...
Für eine ausführlichere Behandlung der Ädiküla-Warteschlange, des Sechs-Konfessionen-Status-quo und Zeitratschläge lesen Sie den [vollständigen Besucherführer der Grabeskirche](/de/church-holy-sepulchre-guide).
...
- **[Yad Vashem Holocaust-Gedenkstätte](/yad-vashem-visitor-guide)**: Vorab buchen, westlich der Stadt gelegen, am besten an einem separaten Tag oder kombiniert mit einer Morgenführung per Taxi (von der Altstadt nicht zu Fuß erreichbar)
...
- **Ölberg-Aussichtspunkt**: 15 Minuten mit dem Taxi von der Altstadt; das Panorama über dem Felsendom bei Sonnenuntergang ist Jerusalems beste Einzelsicht — im [Jerusalem-1-Tages-Itinerar](/de/1-day-jerusalem-itinerary) finden Sie Zeitempfehlungen
...
Den [Jerusalem-Touren-Vergleich](/de/jerusalem-tours-compared) für einen Überblick über geführte Touroptionen in allen Altstadtformaten. Für die Erwartungen an den heiligen Stätten — Dresscode, Sicherheit und Etikette — den [Dresscode-Ratgeber für heilige Stätten](/de/holy-sites-dress-code-etiquette) lesen.

**Querverweise:** [Jerusalem](/jerusalem) · [Klagemauer](/jerusalem/western-wall) · [Grabeskirche](/jerusalem/holy-sepulchre) · [Ölberg](/jerusalem/mount-of-olives) · [Jerusalem 1-Tages-Itinerar](/de/1-day-jerusalem-itinerary) · [Jerusalem-Touren im Vergleich](/de/jerusalem-tours-compared) · [Jerusalem Gastronomieführer](/de/jerusalem-food-guide) · [Unterkunft in Jerusalem](/where-to-stay/jerusalem) · [Tagesausflüge von Tel Aviv](/de/day-trips-from-tel-aviv)
