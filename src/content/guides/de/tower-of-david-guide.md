---
title: "Davidsturm Jerusalem: Museum und Night Spectacular (2026–2027)"
...
affiliateCtas:
  - partner: getyourguide
    title: "Davidsturm Museum + Geführte Altstadt-Tour"
    description: "Kombinieren Sie das Davidsturm-Museum mit einer geführten Wanderung durch die Altstadt — ein lizenzierter Guide verbindet die chronologischen Exponate mit dem lebendigen Stadtbild darunter zu einem einzigen stimmigen Erlebnis. Englischsprachige Guides, kleine Gruppen."
    image: /images/sub-destinations/jerusalem/tower-of-david.jpg
    query: Davidsturm Jerusalem geführte Tour Altstadt
    cta: Platz reservieren
  - partner: viator
    title: "Night Spectacular Eintrittskarten"
    description: "Das Davidsturm Night Spectacular — eine 45-minütige Licht-und-Ton-Show, die auf die antiken Zitadellenmauern projiziert wird — läuft die meisten Abende das ganze Jahr über. In der Hochsaison Wochen im Voraus ausverkauft — rechtzeitig buchen."
    image: /images/sub-destinations/jerusalem/old-city.jpg
    query: Davidsturm Night Spectacular Jerusalem Eintrittskarten
    cta: Night Spectacular buchen
faqs:
  ...
  - question: "Wann findet das Night Spectacular statt?"
    answer: "Das Night Spectacular findet die meisten Abende das ganze Jahr über statt, mit angepassten Zeiten im Winter. In der Hochsaison (Juni–September) und an jüdischen Feiertagen läuft es in der Regel Sonntag bis Donnerstag und Samstags. Freitagszeiten sind wegen Schabbat verkürzt. Die Veranstaltung dauert ca. 45 Minuten. Aktuelle Termine auf tod.org.il prüfen — der Spielplan ändert sich saisonal."
  - question: "Gilt der INPA-Jahrespass für den Davidsturm?"
    answer: "Nein. Das Davidsturm-Museum wird unabhängig verwaltet und gehört nicht zum Netz der Israelischen Natur- und Parkbehörde (INPA). Der INPA Annual Pass gilt hier nicht. Tickets müssen direkt über tod.org.il oder einen lizenzierten Reiseveranstalter erworben werden. Mehr zu den Parks, die der Pass abdeckt, im [INPA-Pass-Leitfaden](/de/israel-national-parks-pass)."
  - question: "Muss ich Davidsturm-Tickets im Voraus buchen?"
    answer: "Für das Night Spectacular in der Hochsaison (Juni–September) und um jüdische Feiertage herum ist Vorausbuchung dringend empfohlen — die Show ist Wochen im Voraus ausverkauft. Für das Tagesmuseum sind Walk-in-Tickets außerhalb der Hochsaison meist verfügbar, aber Online-Buchung spart Wartezeit und bietet gelegentlich einen Rabatt."
  - question: "Was ist die Ausstellung 'Eyes on the Wall', die 2027 eröffnet?"
    answer: "Das Davidsturm-Museum eröffnet im April 2027 eine Großausstellung mit dem Titel 'Eyes on the Wall' anlässlich des 60. Jahrestages der Vereinigung Jerusalems im Juni 1967. Kuratiert von Kunsthistoriker Shimon Lev, wird es die erste große Museumsausstellung sein, die vollständig der Geschichte der Westlichen Mauer gewidmet ist — rund 2.000 Jahre durch Fotos, Archivdokumente, Filme und persönliche Artefakte. Sie wird im Davidsturm-Gelände neben den bestehenden Zitadellenexpositionen laufen. Bestätigte Öffnungsdaten und Ticketdetails auf tod.org.il sobald verfügbar."
---
...
Für einen [Tag in Jerusalem](/de/1-day-jerusalem-itinerary) ist der Davidsturm am frühen Morgen die beste Zeit: geringe Besucherzahlen, Licht noch weich für Fotos auf der Dachterrasse. Die Kombination Tagesmuseum + Night Spectacular erfordert einen zweiten Besuch am gleichen Abend — praktisch, wenn Sie in der Altstadt oder im [Hotelviertel nahe der Altstadt](/de/best-hotels-jerusalem) übernachten.

Für [Tagesausflüge von Jerusalem](/de/day-trips-from-jerusalem) aus bietet der Davidsturm einen starken Auftakt — Vormittag Museum, Nachmittag Rundgang durch die Altstadt, Abend Night Spectacular als Abschluss.
...
Dresscode: Keine besonderen Anforderungen für das Museum; die Altstadt drumherum erfordert bedeckte Schultern und Knie an religiösen Stätten. Details im [Dresscode-Leitfaden für heilige Stätten](/de/holy-sites-dress-code-etiquette).
