...
ctaHeading: 'Jemenitisches Viertel mit einer lokalen Führung entdecken'
affiliateCtas:
  - partner: getyourguide
    title: 'Kulinarische Führung durch das Jemenitische Viertel Tel Aviv'
    description: "Durchstreifen Sie Kerem HaTeimanim mit einem einheimischen Guide — Jachnun, Malawach, Lachuch und die Geschichte hinter der israelisch-jemenitischen Küche. Die meisten Touren kombinieren das Jemenitische Viertel mit dem benachbarten Karmel-Markt für einen vollständigen Sinnenmorgen."
    image: /images/sub-destinations/tel-aviv/carmel-market.jpg
    query: Yemenite Quarter food tour Tel Aviv
    cta: Kulinarische Touren entdecken
  - partner: booking
    title: "Hotels in Tel Aviv nahe dem Karmel-Markt"
    description: "Übernachten Sie im Zentrum Tel Avivs in der Nähe von Kerem HaTeimanim, dem Karmel-Markt, Nahalat Binjamin und Jaffa. Hotels im Florentin-Viertel und an der Allenby-Straße liegen fußläufig zu den besten Tischen des Viertels."
    image: /images/regions/tel-aviv/hero.jpg
    destination: Tel Aviv
    cta: Verfügbarkeit prüfen
faqs:
  - question: "Was ist Kerem HaTeimanim?"
    answer: "Kerem HaTeimanim — hebräisch für 'Weinberg der Jemeniten' — ist eines der ältesten Stadtteile Tel Avivs, 1904 von jemenitisch-jüdischen Einwanderern gegründet. Es liegt unmittelbar südwestlich des Karmel-Markts, begrenzt von der Allenby-Straße im Norden und dem Har-Tziyon-Boulevard im Süden. Das Viertel ist bekannt für niedrige weiß getünchte Gebäude, dekorative Schmiedeisenbalkone, enge Gassen und eine israelisch-jemenitische Esskultur, die nirgendwo sonst in der Stadt ihresgleichen hat. Heute ist es ein lebendiges Wohnviertel, das Künstler, junge Kreative und Bars neben seiner ursprünglichen Gemeinschaft beherbergt."
  - question: "Was soll man in Kerem HaTeimanim essen?"
    answer: "Die jemenitischen Traditionsgerichte: Jachnun (laminiertes Blätterteiggebäck, langsam gebacken, samstags morgens mit geriebener Tomate, hartgekochtem Ei und der scharfen Z'hug-Sauce serviert), Malawach (gebratenes Schichtbrot, außen knusprig und innen zart), Lachuch (schwammiges jemenitisches Fladenbrot, mit Honig oder Z'hug gegessen), Kubbaneh (dichtes, leicht süßes Nachbackbrot, Shabbat-Morgen-Institution). Hilbe (Bockshornkleesoße) und Merak (jemenitische Lammsuppe) sind die unverzichtbaren Hauptgerichte. Restaurantöffnungszeiten sind oft unregelmäßig und hauptsächlich wochenendbezogen — bei Restaurantauswahl zuerst aktuelle Empfehlung vor Ort erfragen."
  - question: "Wo liegt Kerem HaTeimanim und wie kommt man hin?"
    answer: "Kerem HaTeimanim liegt im Zentrum Tel Avivs, unmittelbar südwestlich des Karmel-Markt-Eingangs an der HaKovshim-Straße. Vom südlichen Karmel-Markt-Eingang (Allenby) zwei bis drei Minuten südwärts gehen — der Charakter der Gassen wechselt rasch von Marktständen zu weiß getünchten Wohngebäuden. Die Rote Stadtbahn-Linie Tel Avivs hält an Karmel Market / Allenby, wenige Gehminuten entfernt. Kein eigenes Parkhaus — das Viertel erkundet man am besten zu Fuß."
  - question: "Wann ist die beste Zeit für einen Besuch in Kerem HaTeimanim?"
    answer: "Samstagmorgen ist die traditionelle Zeit für das jemenitische Frühstück — Jachnun und Malawach werden spezifisch am Samstagmorgen in den meisten Viertels-Restaurants serviert, gemäß der Shabbat-Übernacht-Back-Tradition. Zwischen 9 und 11 Uhr für das beste Erlebnis; die meisten jemenitischen Frühstückslokale schließen am frühen Nachmittag. Für die Bar- und Café-Szene sind Donnerstag- und Freitagabend die lebendigsten Zeiten. Dienstags und freitags tagsüber läuft nebenan der Nahalat-Binjamin-Kunsthandwerkermarkt, sodass sich ein kombinierter Vormittag leicht planen lässt."
  - question: "Wie unterscheidet sich israelisch-jemenitische Küche von der jemenitischen?"
    answer: "Die israelisch-jemenitische Küche hat sich seit mehr als einem Jahrhundert eigenständig entwickelt, seit die ersten jüdischen Einwanderer aus dem Jemen Ende des 19. und Anfang des 20. Jahrhunderts ankamen. Die Gerichte — Jachnun, Malawach, Lachuch, Kubbaneh — sind spezifisch für die jemenitisch-jüdische Gemeinschaft in Israel und teilen Techniken mit der jemenitischen Küche, haben sich aber im israelischen Kontext eigenständig weiterentwickelt. Zutaten und Gewürzmischungen, insbesondere Z'hug (frische Koriander-Chili-Sauce) und Hilbe (Bockshornklee), sind authentisch zur Ursprungstradition."
---
...
**Weitere Informationen:** [1 Tag Tel Aviv](/de/1-day-tel-aviv-itinerary) · [Tel-Aviv-Gastronomieführer](/de/tel-aviv-food-guide) · [Jaffa-Gastronomie](/de/jaffa-food-guide) · [Karmel-Markt Tel Aviv](/de/tel-aviv-carmel-market) · [Tel-Aviv-Kaffeeführer](/de/tel-aviv-coffee-guide) · [Aktivitäten in Tel Aviv](/de/tel-aviv-things-to-do)
