...
verdictName: "ein historischer Tagesausflug nach Tel Afek und Antipatris"
verdictQuery: "Tel Afek Antipatris Israel day trip historic site"
ctaHeading: "Tel-Afek-Tagesausflug oder Mietwagen buchen"
affiliateCtas:
  - partner: getyourguide
    title: "Historische Tagestouren: Sharon-Ebene und Caesarea"
    description: "Gefuehrte Tagesausfluge aus Tel Aviv entlang des Kuestenkorridor-Erbes — Caesarea, Caesarea-Nationalpark und die Kulturstaetten der Sharon-Ebene. Tel Afek am Vormittag auf eigene Faust, dann eine gefuehrte Caesarea-Tour am Nachmittag — oder ein Privatguide fuer die volle archaeologische Route von Aphek ueber Antipatris bis zum roemischen Caesarea."
    image: /images/regions/caesarea/hero.jpg
    query: historic day trip north Tel Aviv Caesarea Israel
    cta: Sharon- und Caesarea-Touren entdecken
  - partner: discovercars
    title: "Mietwagen — Tel Afek und die Sharon-Ebene"
    description: "Tel Afek hat keine Bus-Anbindung. Der Park liegt 40 km von Tel Aviv entfernt — problemlos ueber die Route 40 erreichbar — und laesst sich gut mit einem Stopp in Caesarea weiter noerdlich kombinieren. Preise ab Tel Aviv und Flughafen Ben Gurion vergleichen und fuer einen oder zwei Tage mieten, um den gesamten Kuestenkorridor eigenstaendig zu erkunden."
    image: /images/regions/caesarea/aqueduct.jpg
    query: car rental Israel Tel Aviv day trip
    cta: Mietwagenpreise vergleichen
faqs:
  - question: "Wie komme ich zum Nationalpark Tel Afek?"
    answer: "Tel Afek hat keine Bus-Anbindung. Mit dem Auto: Route 40 noerdlich von Tel Aviv Richtung Rosh HaAyin; der Parkeingang ist ab Route 40 ausgeschildert, ca. 4 km oestlich des Yarkon-Knotenpunkts. Rechnen Sie ca. 45 Minuten ab Zentrum Tel Aviv. Waze und Google Maps leiten korrekt zum INPA-Parkplatz. Eine gefuehrte Tour mit Antipatris oder dem Sharon-Ebene-Korridor ist die Alternative, wenn Sie nicht selbst fahren moechten."
  - question: "Gilt der Israel National Parks Pass in Tel Afek?"
    answer: "Ja — Tel-Afek-Nationalpark ist ein vollwertiger INPA-Standort (Israel Nature and Parks Authority), und der Standard National Parks Pass deckt den Eintritt ab. Wenn Sie waehrend Ihrer Reise mehr als zwei oder drei INPA-Parks besuchen planen, rentiert sich der Pass schnell. Aktuelle Preise und Kaufmoeglichkeiten finden Sie im [Leitfaden zum Israel National Parks Pass](/de/israel-national-parks-pass)."
  - question: "Was ist die Geschichte von Paulus dem Apostel in Antipatris?"
    answer: "In Apostelgeschichte 23:23-33 ordnete der roemische Tribun in Jerusalem den Transfer des Apostels Paulus unter die Bewachung von Gouverneur Felix in Caesarea Maritima an, nachdem ein Mordkomplott aufgedeckt worden war. Eine Eskorte von 200 Soldaten, 70 Reitern und 200 Speertragern marschierte Paulus in dieser Nacht nach Antipatris — eine Strecke von ca. 60 km aus Jerusalem. In Antipatris kehrten die Infanteriesoldaten nach Jerusalem zurueck, waehrend die Reiterei mit Paulus die verbleibenden 40 km nach Caesarea fortsetzte. Tel Afek/Antipatris ist damit die Nacht-Etappe dieser neutestamentlichen Route."
  - question: "Kann man im Yarkon-Quellbecken in Tel Afek schwimmen?"
    answer: "Nein. Die Yarkon-Quellen bei Tel Afek speisen ein kommunales Trinkwasser-Reservoir. Das Schwimmen ist verboten, und Beschilderungen im Park machen dies deutlich. Das Quellbecken und die ueppige Ufervegetation rundherum koennen ueber das Wegenetz des Parks erwandert werden, aber das Wasser selbst ist fuer die Erholungsnutzung gesperrt."
  - question: "Was ist der Unterschied zwischen Aphek, Antipatris und Tel Afek?"
    answer: "Alle drei Namen bezeichnen denselben Ort zu verschiedenen Epochen. Aphek ist der biblische kanaanaeische und israelitische Name (in Josua, Samuel und Koenigen erwaehnt). Antipatris ist der herodiaeische Name, den Herodes der Grosse um 9 v. Chr. zu Ehren seines Vaters Antipater dem Idumaeer gab. Tel Afek ist der moderne hebraeische Name fuer den archaeologischen Huegel; die INPA verwendet Tel Afek fuer den Nationalpark. Alle Namen bezeichnen dieselbe Staette."
---
...
|---|---|---|
| Parkplatz bis Osmanische Festung | Zugangsweg durch Gestruepp | Flach; abschnittsweise beschattet |
...
| | |
|---|---|
| **Lage** | Bei Rosh HaAyin, ab Route 40 — INPA-Schildern nach Tel Afek folgen |
...
Ein [Mietwagen](/de/car-rental-israel) ist der praktische Weg fuer einen unabhaengigen Besuch. Die Fahrt ab Tel Aviv ist unkompliziert auf Route 40, und Tel Afek laesst sich gut mit [Caesarea](/de/caesarea-guide) weiter noerdlich fuer einen vollen Sharon-Ebene-Tag kombinieren.

Der [Israel National Parks Pass](/de/israel-national-parks-pass) deckt den Eintritt ab und lohnt sich, wenn Sie waehrend Ihrer Reise mehr als zwei INPA-Standorte besuchen.
...
- **Tel Afek + Caesarea**: die naheliegende Kombination. Tel Afek (2 Stunden, archaeologie-fokussiert) am Morgen; [Caesarea Nationalpark](/de/caesarea-guide) (roemisches Theater, herodiaeischer Hafen, Kreuzfahrerwaelle) am Nachmittag. Beide sind INPA-Standorte; der National Parks Pass deckt beide ab.
...
Weitere Tagesausfluge ab Tel Aviv finden Sie im [Leitfaden fuer Tagesausfluge ab Tel Aviv](/de/day-trips-from-tel-aviv). Vogelbeobachter sollten auch den [Israel-Vogelbeobachtungsratgeber](/de/birdwatching-in-israel) zurate ziehen, der weitere Herbst- und Fruehjahrsmigrations-Standorte listet.
