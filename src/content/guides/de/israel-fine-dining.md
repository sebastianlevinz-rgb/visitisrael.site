...
affiliateCtas:
  - partner: getyourguide
    title: "Food-Touren & Kochkurse in Israel"
    description: "Geführte kulinarische Touren durch Tel Avivs Märkte und Jerusalem — Marktführungen, Street-Food-Walks und private Kochkurse mit lokalen Chefköchen. Online buchbar."
    image: /images/regions/tel-aviv/carmel-market.jpg
    query: Israel food tour cooking class fine dining
    cta: Food-Touren Israel ansehen
  - partner: booking
    title: "Hotels in Tel Aviv & Jerusalem"
    description: "Boutique-Hotels und Luxusunterkünfte in Tel Aviv (Rothschild Boulevard, Neve Tzedek) und Jerusalem (Mamilla, Altstadt-Rand) — nah an den wichtigsten Fine-Dining-Adressen."
    image: /images/regions/tel-aviv/hero.jpg
    destination: Israel
    cta: Hotels in Israel suchen
  - partner: getyourguide
    title: "Jerusalem Kulinarik & Marktführungen"
    description: "Geführte Touren durch den Mahane-Yehuda-Markt mit Verkostungen und Hintergrundwissen zur israelischen Küche — die beste Einführung vor einem Fine-Dining-Abend."
    image: /images/regions/jerusalem/mahane-yehuda.jpg
    query: Jerusalem food tour Mahane Yehuda market
    cta: Jerusalem Food-Touren ansehen
faqs:
  - question: "Hat Israel Michelin-Sterne-Restaurants?"
    answer: "Ja — seit 2025/2026. Israel erhielt seinen ersten Michelin Guide (Tel Aviv & Jerusalem) im Jahr 2025. Shmoné in Jerusalem gewann als erstes israelisches Restaurant einen Michelin-Stern. Weitere Auszeichnungen: Bib Gourmand (exzellentes Preis-Leistungs-Verhältnis) für mehrere Tel-Aviv-Restaurants. Der Michelin Guide Israel ist jährlich aktuell; die aktuelle Ausgabe auf dem Michelin-Online-Portal prüfen."
  - question: "Was ist die israelische Küche auf Fine-Dining-Niveau?"
    answer: "Auf Fine-Dining-Niveau bedeutet israelische Küche oft: Mittelmeerküche mit Levante-Einflüssen (Libanon, Türkei, Nordafrika), ergänzt durch moderne Techniken. Typische Zutaten auf Speiseniveau: Za'atar, Labaneh, Sumach, Granatapfelmelasse, frische Kräuter, lokaler Fisch vom Mittelmeer. Viele Top-Restaurants in Israel kombinieren vegetarische und fleischhaltige Gerichte und bieten umfangreiche Gemüse-Tasting-Menüs — ein israelischer Exporttrend in die internationale Gastronomie."
  - question: "Welches ist das beste Fine-Dining-Restaurant in Israel?"
    answer: "Die La Liste 2026 (globales Restaurantranking) nennt OCD in Tel Aviv (8-Gang-Omakase, 8 Plätze) und Pastel in Sarona als internationale Referenzpunkte. Shmoné in Jerusalem ist aktuell das einzige Michelin-Stern-Restaurant Israels. Die Wahl hängt von der Präferenz ab: für experimentelle Küche OCD; für Ambiente und Eleganz Pastel; für kulinarische Israel-Geschichte Machneyuda in Jerusalem. Alle drei erfordern Vorausbuchung von 3–6 Wochen."
  - question: "Wie bucht man Spitzenrestaurants in Israel?"
    answer: "Israelische Fine-Dining-Restaurants buchen hauptsächlich über die Restaurant-Website (oft mit eigenem Reservierungssystem) oder über Wolt Reservations (israelische Plattform, ähnlich OpenTable). Einige Restaurants nehmen nur per Telefon oder E-Mail an. OCD hat ein Online-Buchungssystem über die eigene Website. Shmoné bucht über die Website. Empfehlung: 3–6 Wochen im Voraus buchen, besonders für Freitag- und Samstagabende. Stornierungsbedingungen sind oft streng (24–48 Stunden) — auf Kreditkartenpflicht bei der Buchung vorbereitet sein."
  - question: "Welche Fine-Dining-Restaurants sind kosher-zertifiziert?"
    answer: "Machneyuda in Jerusalem ist ein bekanntes kosher-meaty Restaurant (Rabbinats-Zertifikat; kein Milch-Fleisch-Mix). Shmoné hat ebenfalls kosher-Status. Die meisten Tel-Aviv-Fine-Dining-Restaurants (OCD, Pastel, Messa) sind nicht kosher — was für nicht-orthodoxe Gäste kein Thema ist, aber für orthodox-observierende Gäste relevant sein kann. Kosher-Status auf der Restaurant-Website prüfen oder direkt anfragen."
  - question: "Was kostet ein Fine-Dining-Abend in Israel?"
    answer: "Orientierungsrahmen: OCD Omakase 8 Gänge: ₪500–700 pro Person (ohne Getränke). Pastel Tasting-Menü: ₪400–550 pro Person. Shmoné Michelin-Menü: ₪450–600 pro Person. Machneyuda À-la-carte: ₪200–350 pro Person (lebhafter, weniger formal). Wein und Getränke verdoppeln oft den Gesamtpreis. Israel hat ein breites Qualitätsspektrum — hervorragende Mahlzeiten im mittleren Segment (₪150–250 pro Person) sind in beiden Städten leicht zu finden."
  - question: "Gibt es gute Fine-Dining-Optionen für Vegetarier und Veganer?"
    answer: "Israel ist einer der vegetarierfreundlichsten Fine-Dining-Standorte weltweit. Das liegt an der Kosher-Trennung (viele Restaurants bieten milchig-vegetarische Menüs an), der Levante-Kochkultur (naturgemäß gemüsereich) und einer aktiven veganen Bewegung (Tel Aviv war lange als 'veganfreundlichste Stadt weltweit' vermarktet). OCD bietet auf Anfrage vegetarische Omakase-Varianten. Pastel hat ein dediziertes vegetarisches Tasting-Menü. In Jerusalem: Machneyuda's Gemüseabteilung des Menüs ist eigenständig und keine Nachgedanke."
---
