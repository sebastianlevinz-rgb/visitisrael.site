...
- **Neot Kedumim**: limited bus service (verify on official website)
- **Ein Yael**: Jerusalem city bus
- **Kfar Kedem**: guided day tours from Nazareth / Tiberias available through GetYourGuide and local operators

For everyone else: pick up a car at Ben Gurion Airport (the most flexible option) and combine farm visits with a wider north Israel or Negev itinerary. The [car rental guide](/car-rental-israel) has current comparison prices and Shabbat pickup timing notes that matter for agricultural-region weekends.
