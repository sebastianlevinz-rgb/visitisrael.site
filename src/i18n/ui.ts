...
const ui = {
  en: {
    ...
    'nav.esim': 'eSIM & mobile data',
    'nav.holidays': 'Shabbat & holidays',
  ...
  fr: {
    ...
    'nav.esim': 'eSIM et données mobiles',
    'nav.holidays': 'Shabbat et fêtes',
  ...
  de: {
    ...
    'nav.esim': 'eSIM & mobiles Internet',
    'nav.holidays': 'Schabbat & Feiertage',
    'nav.hotelsJerusalem': 'Hotels in Jerusalem',
    'nav.hotelsTelAviv': 'Hotels in Tel Aviv',
  ...
  es: {
    ...
    'nav.esim': 'eSIM y datos móviles',
    'nav.holidays': 'Shabat y fiestas',
  ...
  he: {
    ...
    'nav.esim': 'eSIM ואינטרנט סלולרי',
    'nav.holidays': 'שבת וחגים',
...
export const PAGE_GROUPS = {
  practical: [
    ...
    { slug: 'esim-israel', key: 'nav.esim' },
    { slug: 'shabbat-and-holidays-israel', key: 'nav.holidays' },
  ],
  stay: [
