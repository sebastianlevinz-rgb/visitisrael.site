...
*Source: MEGA-PROMPT-NEW-COUNTRY.md + .planning/research/SUMMARY.md §8 + REQUIREMENTS.md (53 v1 requirements mapped) + conflict resolutions §3 (Conflict A locales, Conflict C Jerusalem pilot, Conflict D affiliates)*
*Granularity: coarse (6 integer phases — fits coarse 3-5 target via mega-prompt prescription with M4 added per SUMMARY §8)*
*Coverage: 53/53 v1 requirements mapped (see REQUIREMENTS.md Traceability)*
