...
- [x] **FND-07**: NER / mention-detection dictionary (`data/entity-dict.json` with tour/hotel/restaurant/museum/transport classes) + regex-based detector that surfaces unmonetized mentions in MDX to the audit dashboard — fixes Argentina lesson #6
