...
**Actualización 2026-09-22**: se agregó Israel Together (agencia argentina de viajes grupales a Israel) en §1.5 y §2.14. Consultado el 2026-09-22: el dominio `israeltogether.org` está caído (error "ConnectYourDomain" de Wix); se leyó la copia de Wayback del 2025-09-07 y sus redes.
...
| israeltogether.org (Israel Together, Argentina; consultado 2026-09-22) | Agencia: programa de viajes grupales educativos de 10 días a Israel para adultos y familias judías de Latinoamérica ("con el apoyo del Ministerio de Turismo de Israel y donantes internacionales"), operado por Cheap to Trip – Bongiorno Travel Solutions (legajo 12705 EVT), Villa Crespo, Buenos Aires. Sitio Wix solo en español. **Al 2026-09-22 el dominio devuelve la página de error "ConnectYourDomain" de Wix**; `israeltogether.com` es un dominio estacionado y `.com.ar` no existe. Última copia en Wayback: 2025-09-07 | HypeStat ~1,5K/mes (sin fecha, fiabilidad baja); SimilarWeb bloqueó la consulta (202 sin datos) | **0 afiliados**: vende paquetes propios (hotel 4★, media pensión, guía de habla hispana, madrij, entradas, traslados; aéreo aparte según sus respuestas en Facebook). Precio no publicado en el sitio ("el programa tiene costo… planes de financiación"); en Facebook, 2017: US$3.790 con aéreo; en prensa, 2016: US$2.790 con beca de US$1.000. CTA: WhatsApp +54 9 11 2456 4810, formulario y "entrevista personal" | Sin base (operador) |
...
### 2.14 Israel Together — israeltogether.org (español, Argentina; agregado 2026-09-22)

- **Estado**: el dominio está caído al 2026-09-22 (Wix "ConnectYourDomain", HTTP 404). Lo que sigue se leyó en la copia de Wayback del 2025-09-07 (home) y del 2025-08-08 (página del programa "Israel Together 2"), más Facebook (facebook.com/israeltogether) e Instagram (@israeltogetherargentina). El canal que sigue vivo es WhatsApp y las redes, no el sitio.
- **Hero**: sin H1 (Wix). Texto de apertura "Disfrutá Israel" sobre foto; sin CTA en el hero. Debajo, "NUESTROS PROGRAMAS — Propuestas especialmente pensadas para vos".
- **Navegación**: Home | Nuestros programas (Israel Together 1, Israel Together 2, Programa de Familias, Bar y Bat Mitzvá en Israel) | Comunidad IT | Sobre Nosotros | Contacto. Sin buscador, sin breadcrumb, un solo idioma.
- **Tarjetas**: 4 tarjetas de programa con foto + título (Israel Together 1, Israel Together 2, Familias, Bar/Bat Mitzva). **Sin precio, sin fecha de salida, sin duración** en la tarjeta.
- **Página de programa (IT2)**: subtítulo "VIVIENDO EL PAÍS Y SU CULTURA"; formulario "Quiero recibir más información" arriba; chips de atributos: Duración 10 días · Grupo de adultos · Media pensión · Entradas y excursiones · Traslados · Guía acompañante; botón "DESCARGÁ EL ITINERARIO"; FAQ de 6 preguntas (¿qué incluye?; ¿puedo ver el itinerario? → "se confirma y entrega en las reuniones pre-viaje"; ¿próximas salidas? → "Contactanos… Whatsapp"; ¿ya conozco Israel?; ¿tiene costo? → "sí… sumamente accesible… planes de financiación"; ¿reuniones pre-viaje? → sí); CTA "SOLICITÁ UNA ENTREVISTA PERSONAL"; bloque "Testimonios de ex-participantes".
- **Afiliados**: 0. Venta propia, cerrada por entrevista: ni precio ni fechas en el sitio.
- **Autor / confianza**: sin bylines ni fechas. "En los últimos años miles de adultos y familias judías visitaron Israel junto a nosotros"; apoyo del Ministerio de Turismo de Israel y donantes; comunidad post-viaje ("Cenas de Shabat | Clases y cursos | Eventos especiales"); legajo EVT y operador en el footer. Público explícito: adultos (30–69 en 2016; "mayores de 45" en 2017) y familias judías de Latinoamérica; oficina en Argentina y mail para México.
- **Móvil**: no verificado (Wix, menú "More").
- **Velocidad**: 785 KB de HTML en la home y 656 KB en la página de programa (Wix inyecta todo inline).
- **Tráfico**: HypeStat ~1,5K visitas/mes (sin fecha, fiabilidad baja). SimilarWeb no devolvió datos.
- **Lección**: no compite por tráfico ni por afiliados; es **el modelo "viaje grupal en español desde Argentina"**: hotel 4★, guía en español, madrij, cuotas y grupo. El lector argentino que busca "viaje grupal a Israel" no quiere Booking, quiere eso. Lo copiable: chips de atributos + FAQ + un solo CTA (WhatsApp/entrevista) en la página de producto; la comunidad post-viaje como retención. Lo no copiable: el subsidio. La advertencia: una agencia con 10 años de trayectoria tiene el dominio caído hace meses y no lo nota, porque vende por WhatsApp y redes. Es el tipo de partner local para la propuesta de tours con Mariluz, no un competidor de SEO.
...
**Español / francés / alemán / hebreo**: viajeroscallejeros.com/consejos-para-viajar-israel/; viajes.chavetas.es/guia/israel-palestina/; losviajesdedomi.com/que-ver-en-israel/; monoviajero.com/guia-israel/; israeltogether.org (2026-09-22: 404 de Wix; israeltogether.com estacionado; web.archive.org/web/20250907090927/www.israeltogether.org/ y /web/20250808144450/www.israeltogether.org/israeltogether2; facebook.com/israeltogether, post del 2017-07-02 con precio; delacole.com, nota de agosto 2016; hypestat.com/info/israeltogether.org); guide-israel.info/blog/; sommertage.com/reiseblog/israel/; kommwirmachendaseinfach.de/land/israel/; viel-unterwegs.de/reiseziele/israel/; tiuli.com; masa.co.il; israelhiking.osm.org.il.
...
- **Israel Together** (2026-09-22): precio y fechas actuales (el sitio nunca los publicó y hoy está caído); seguidores de Instagram y Facebook (no se pudieron leer sin sesión); tráfico real (SimilarWeb sin datos; HypeStat ~1,5K/mes sin fecha); si el programa sigue operando en 2026 (el último post visto con fechas es de 2017; la copia del sitio es de septiembre 2025).
